...
import { AFRICA_RIVERS_PATHS } from '@/components/games/data/africa-physical-paths';
...
export default function RiosAfricaClient() {
    ...
    return (
        <PhysicalGameLayout
            ...
            colorTheme="blue"
            activityId="rios-africa"
        >
            <PhysicalMapGame
                title={t.gamesPage.gameTitles.africaRivers}
                description={t.gamesPage.gameTitles.africaRiversDesc}
                items={AFRICA_RIVERS_PATHS}
                itemType="line"
