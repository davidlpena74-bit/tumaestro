...
export default function FemaleReproductivePage() {
            ...
            <main className="flex-1 p-4 pt-24 pb-12 relative overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto">
                    <div className="px-4 md:px-8">
                        ...
                        <h1 className="text-4xl md:text-5xl font-black text-slate-800 mb-4 text-balance">
                            {t.gamesPage.gameTitles.femaleReproductive} 🧬
                        </h1>
                        <p className="text-slate-700 font-medium text-lg mb-8 leading-relaxed max-w-3xl">
                            {t.gamesPage.gameTitles.femaleReproductiveDesc}. Arrastra cada etiqueta para conectarla con su ubicación correspondiente en el diagrama frontal.
                        </p>
                    </div>

                    <FemaleReproductiveGame taskId={taskId} />
                </div>
            </main>
        </div>
    );
