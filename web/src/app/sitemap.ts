...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const activities = [
        ...
        'montanas-espana', 'montanas-europa', 'montanas-norteamerica', 'montanas-oceania', 'multiplicaciones', 'musculos',
        'paises-ue', 'rankings', 'rios-africa', 'rios-europa', 'sistema-reproductor-femenino',
        'sistema-reproductor-masculino', 'test-miller', 'valoraciones', 'verbos-irregulares', 'verbos-irregulares-basico',
