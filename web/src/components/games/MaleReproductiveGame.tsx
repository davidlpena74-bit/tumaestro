...
export default function MaleReproductiveGame({ taskId = null, activityId }: { taskId?: string | null, activityId?: string }) {
    ...
    const effectiveActivityId = activityId || "sistema-reproductor-masculino";
                ...
                >
                    {gameState === 'start' && (
                        <div className="absolute inset-0 z-30 bg-black/60 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center rounded-[2rem]">
                            ...
                            <h2 className="text-2xl md:text-4xl font-black text-white mb-4 tracking-tight uppercase">{t.gamesPage.gameTitles.maleReproductive}</h2>
