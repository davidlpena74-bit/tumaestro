...
export default function IrregularVerbsMasterGame({ taskId = null, type = 'writing', activityId }: { taskId?: string | null, type?: 'writing' | 'pronunciation', activityId?: string }) {
    ...
    const {
        ...
        handleFinish
    } = useGameLogic({ initialTime: 300, penaltyTime: 0, gameMode, taskId, activityId });
            ...
            <div className={cn(
                ...
                {gameState === 'start' && (
                    <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <h2 className="text-2xl md:text-3xl font-black text-white mb-2 tracking-tight uppercase">{t.gamesPage.verbsLevels.master.title}</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                            ...
                            >
                                <span className="relative z-10 flex flex-col items-center leading-none">
                                    ...
                                    <span className="text-xs opacity-50 font-bold tracking-widest mt-1">{t.gamesPage.verbsGame.verbsCount.replace('{count}', '20')}</span>
                                </span>
                            </button>
                        </div>
                    </div>
