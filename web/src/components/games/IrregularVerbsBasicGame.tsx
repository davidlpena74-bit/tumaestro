...
export default function IrregularVerbsBasicGame({ taskId = null, type = 'writing', activityId }: { taskId?: string | null, type?: 'writing' | 'pronunciation', activityId?: string }) {
    ...
    const {
        ...
        handleFinish
    } = useGameLogic({ initialTime: 60, penaltyTime: 0, gameMode, taskId, activityId });
            ...
            <div className={cn(
                ...
                {gameState === 'start' && (
                    <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center">
                        ...
                        <h2 className="text-2xl md:text-3xl font-black text-white mb-2 tracking-tight uppercase">{t.gamesPage.verbsLevels.basic.title}</h2>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-4 w-full">
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    showResult === 'correct' ? "w-full bg-sky-600 hover:bg-sky-700 shadow-sky-500/20" : "flex-1 bg-sky-600/80 hover:bg-sky-600 shadow-sky-500/20"
                                                )}
                                            >
