                            ...
                            {type === 'writing' ? (
                                <div className="bg-slate-900/40 p-8 rounded-[2rem] border border-white/10 space-y-6 shadow-xl backdrop-blur-sm">
                                    <div className="space-y-2">
                                        <label className="block text-[10px] font-black text-sky-500/60 uppercase tracking-[0.3em] ml-2">Past Simple</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="block text-[10px] font-black text-sky-500/60 uppercase tracking-[0.3em] ml-2">Past Participle</label>
                                        <input
                                            type="text"
                                        ...
                                        <div className="min-h-[2.5rem] text-center">
                                            {!isListening && !showResult && (
                                                <motion.p
                                                    ...
                                                    className="text-sky-400 font-black uppercase tracking-[0.2em] animate-pulse text-[16px]"
                                                >
