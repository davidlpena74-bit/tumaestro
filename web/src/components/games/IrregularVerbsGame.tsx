...
export default function IrregularVerbsGame({ taskId = null, type = 'writing', activityId }: { taskId?: string | null, type?: 'writing' | 'pronunciation', activityId?: string }) {
            ...
            recognition.onresult = (event: any) => {
                ...
                for (let i = event.resultIndex; i < event.results.length; ++i) {
                    ...
                    if (event.results[i].isFinal) {
                        ...
                        // Check interim results too for better responsiveness
                        checkVoiceAnswer(result);
                    }
                }
            };
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                            ...
                            >
                                <span className="relative z-10 flex items-center justify-center gap-2 whitespace-nowrap">
                                    {t.gamesPage.verbsGame.challengeMode.toUpperCase()} <TrophyIconGame className="w-5 h-5 opacity-50" />
                                </span>
                            </button>
                            ...
                            >
                                <span className="relative z-10 flex items-center justify-center gap-2 whitespace-nowrap">
                                    {t.gamesPage.verbsGame.practiceMode.toUpperCase()} <RefreshCwIconGame className="w-5 h-5 opacity-50" />
                                </span>
                            </button>
                        </div>
                    </div>
