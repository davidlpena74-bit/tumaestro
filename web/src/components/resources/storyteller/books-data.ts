...
export const BOOKS: Book[] = [
    ...
    },
    {
        ...
        title: 'Aladino y la Lámpara Maravillosa',
        author: 'Anónimo',
        description: 'Un joven encuentra una lámpara mágica que alberga un genio capaz de conceder deseos.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/aladino-cover.png',
        chipImage: '/images/storyteller/character-aladino.png',
        ...
        rating: 4.7,
        content: [
            { text: "En una lejana ciudad de Oriente vivía un joven llamado Aladino. Era un chico despreocupado que pasaba los días jugando en las calles. Un día, un misterioso hechicero se le acercó asegurando ser su tío lejano. Con engaños, convenció a Aladino para que lo acompañara al desierto en busca de un tesoro secreto." },
            { text: "El hechicero llevó a Aladino hasta una cueva oculta y le pidió que entrara para recuperar una vieja lámpara de aceite. 'No toques nada más', le advirtió, entregándole un anillo mágico para su protección. Aladino bajó con valentía y encontró la lámpara en un jardín subterráneo lleno de joyas deslumbrantes." },
            { text: "Cuando Aladino intentó salir, el hechicero le exigió la lámpara antes de ayudarlo a subir. Al sospechar de sus intenciones, Aladino se negó. Furioso, el brujo selló la entrada de la cueva, dejando al joven atrapado en la oscuridad. Desesperado, Aladino frotó sin querer el anillo y, para su asombro, apareció un genio menor que lo llevó de vuelta a casa." },
            { text: "Ya en casa, su madre intentó limpiar la vieja lámpara para venderla. Al frotarla, surgió un Genio gigantesco y poderoso que dijo: 'Soy el esclavo de la lámpara. Pide lo que quieras'. Aladino, maravillado, pidió un banquete digno de reyes, y al instante aparecieron platos de oro con los manjares más exquisitos." },
            { text: "Pasaron los años y Aladino se enamoró de la princesa Halima, la hija del Sultán. Con la ayuda del Genio, se presentó en el palacio con riquezas inigualables y construyó un castillo maravilloso frente al del Sultán. Impresionado, el gobernante concedió la mano de su hija al joven, y ambos vivieron felices." },
            { text: "Pero el malvado hechicero regresó disfrazado de vendedor ambulante gritando: '¡Cambio lámparas viejas por nuevas!'. La princesa, desconociendo el poder de la vieja lámpara, la cambió. El brujo, al tenerla en su poder, ordenó al Genio que trasladara el palacio y a la princesa a un lugar lejano en África." },
            { text: "Aladino, desolado, recordó el anillo mágico que aún conservaba. El genio del anillo no podía deshacer la magia de la lámpara, pero sí podía llevar a Aladino hasta donde estaba su esposa. Juntos, idearon un plan para recuperar la lámpara mientras el hechicero dormía." },
            { text: "Recuperada la lámpara, Aladino ordenó al Genio devolver el palacio a su lugar y enviar al hechicero tan lejos que jamás pudiera volver. El Sultán, feliz de recuperar a su hija, nombró a Aladino su heredero. Y así, Aladino y Halima reinaron con sabiduría y bondad por muchos años." }
        ]
    },
    {
        id: 'bella-durmiente',
        title: 'La Bella Durmiente',
        author: 'Charles Perrault',
        description: 'La historia de una princesa condenada a dormir cien años hasta ser despertada por un beso de amor verdadero.',
        level: 'Fácil',
        age: '4+',
        coverImage: '/images/storyteller/bella-durmiente-cover.png',
        chipImage: '/images/storyteller/character-bella-durmiente.png',
        ...
        rating: 4.6,
        content: [
            { text: "Había una vez un Rey y una Reina que estaban muy tristes por no tener hijos. Cuando por fin nació una niña, organizaron una gran fiesta para el bautizo. Invitaron a siete hadas del reino para que fueran sus madrinas y le otorgaran dones especiales como belleza, bondad y talento musical." },
            { text: "Sin embargo, olvidaron invitar a una hada anciana que vivía en una torre lejana. Furiosa, irrumpió en la fiesta y lanzó una maldición: 'La princesa crecerá llena de gracia, pero al cumplir los dieciséis años se pinchará el dedo con un huso de hilar y morirá'. Todos quedaron horrorizados ante tal sentencia." },
            { text: "Por suerte, una de las hadas jóvenes aún no había dado su regalo. Aunque no podía deshacer la maldición por completo, la suavizó: 'La princesa no morirá. En su lugar, caerá en un profundo sueño que durará cien años, hasta que un príncipe valiente la despierte con un beso de amor verdadero'." },
            { text: "El Rey, asustado, ordenó destruir todos los husos y ruecas del reino. La princesa creció feliz y segura. Pero el día de su decimosexto cumpleaños, mientras exploraba una torre olvidada del castillo, encontró a una anciana hilando, quien no conocía la prohibición del Rey." },
            { text: "Curiosa, la princesa pidió probar a hilar. Apenas tocó el huso, se pinchó el dedo y cayó en un sueño profundo al instante. El hada buena regresó y, para que la princesa no despertara sola, hizo dormir a todo el castillo: reyes, guardias, caballos e incluso el fuego de la chimenea." },
            { text: "Alrededor del castillo creció un bosque de zarzas tan espeso que nadie podía atravesarlo. Pasaron cien años y la leyenda de la Bella Durmiente se extendió por la comarca. Un día, un príncipe escuchó la historia y, armado de valor, decidió intentar llegar hasta el castillo." },
            { text: "Para su sorpresa, las zarzas se abrieron a su paso, dejándole entrar. El castillo estaba en un silencio absoluto. El príncipe recorrió las salas llenas de gente dormida hasta llegar a la torre donde yacía la hermosa princesa. Conmovido por su belleza, se arrodilló y le dio un suave beso." },
            { text: "Al instante, el hechizo se rompió. La princesa abrió los ojos y sonrió al ver al príncipe. Todo el castillo despertó: los músicos siguieron tocando, los cocineros terminaron sus platos y los reyes abrazaron a su hija. El príncipe y la princesa se casaron y vivieron muy felices." }
        ]
    },
    {
        id: 'cenicienta',
        title: 'Cenicienta',
        author: 'Charles Perrault',
        description: 'Una joven bondadosa maltratada por su madrastra recibe la ayuda mágica para asistir al baile real.',
        level: 'Fácil',
        age: '4+',
        coverImage: '/images/storyteller/cenicienta-cover.png',
        chipImage: '/images/storyteller/character-cenicienta.png',
        genre: 'Cuento de hadas',
        themeColor: 'from-blue-300 to-sky-400',
        rating: 4.9,
        content: [
            { text: "Érase una vez un hidalgo que se casó por segunda vez con una mujer altiva y cruel. Ella tenía dos hijas que eran igual de vanidosas. El hombre tenía una hija joven, de una dulzura y bondad sin igual. Pero apenas se celebró la boda, la madrastra mostró su verdadera cara y obligó a la joven a hacer los trabajos más duros de la casa." },
            { text: "La pobre muchacha tenía que fregar, barrer y dormir en un jergón de paja, mientras sus hermanastras dormían en camas de plumas. Como solía descansar cerca de las cenizas de la chimenea para calentarse, comenzaron a llamarla 'Cenicienta'. A pesar de sus harapos, seguía siendo mucho más bella que sus hermanastras." },
            { text: "Un día, el hijo del Rey anunció un gran baile e invitó a todas las personas importantes del reino. Las hermanastras estaban emocionadas y se pasaron días probándose vestidos y peinándose. Cenicienta las ayudó con paciencia, aunque por dentro estaba triste porque ella no podía ir." },
            { text: "Cuando se fueron al baile, Cenicienta rompió a llorar. De repente, apareció su Hada Madrina. '¿Por qué lloras, mi niña?', preguntó. 'Me gustaría tanto ir al baile...', sollozó Cenicienta. 'Pues irás', dijo el Hada. Con su varita mágica, transformó una calabaza en una carroza dorada y a unos ratones en briosos caballos." },
            { text: "Luego tocó el vestido sucio de Cenicienta y lo convirtió en un traje de tela de oro y plata, con unas zapatillas de cristal. 'Pero recuerda', advirtió el Hada, 'la magia terminará a medianoche. Debes regresar antes de que el reloj dé la última campanada'." },
            { text: "Cenicienta llegó al palacio y causó sensación. El príncipe no bailó con nadie más. Estaba tan feliz que olvidó el tiempo. De repente, el reloj comenzó a dar las doce. Cenicienta salió corriendo, perdiendo una de sus zapatillas de cristal en la escalera. El príncipe la recogió, desconsolado por la huida de la misteriosa joven." },
            { text: "Al día siguiente, el príncipe anunció que se casaría con la dueña de la zapatilla. Los emisarios reales probaron el zapato a todas las damas del reino, pero a nadie le servía. Finalmente llegaron a casa de Cenicienta. Las hermanastras intentaron meter sus pies en vano." },
            { text: "A pesar de las burlas, Cenicienta pidió probarse el zapato. Para asombro de todos, su pie entró perfectamente. Sacó la otra zapatilla de su bolsillo y se la puso. En ese momento apareció el Hada y le devolvió su hermoso vestido. El príncipe la reconoció, se casaron y, como Cenicienta era tan buena, perdonó a sus hermanastras y las llevó a vivir a la corte." }
        ]
    },
    {
        id: 'flautista-hamelin',
        title: 'El Flautista de Hamelín',
        author: 'Hermanos Grimm',
        description: 'Un misterioso músico libera a una ciudad de una plaga de ratas, pero la ingratitud de sus habitantes tiene un precio.',
        level: 'Medio',
        age: '5+',
        coverImage: '/images/storyteller/flautista-hamelin-cover.png',
        chipImage: '/images/storyteller/character-flautista.png',
        ...
        rating: 4.4,
        content: [
            { text: "Hace mucho tiempo, la próspera ciudad de Hamelín sufrió una terrible desgracia. Una plaga de ratas invadió las calles, las casas y los graneros. Había tantas que la vida se volvió insoportable: se comían el queso, mordían las ropas y hacían un ruido infernal que no dejaba dormir a nadie." },
            { text: "El alcalde y los concejales no sabían qué hacer. Un día, apareció un hombre extraño vestido con ropas de colores brillantes. 'Soy capaz de librarlos de estas ratas', dijo al concejo, 'pero pido mil monedas de oro a cambio'. Desesperados, los gobernantes aceptaron el trato sin dudarlo." },
            { text: "El extraño sacó una flauta de madera y comenzó a tocar una melodía extraña y cautivadora. Al oírla, las ratas salieron de sus escondrijos. Miles de ellas siguieron al flautista, quien caminó hacia el río Weser. Allí, el flautista se metió en el agua y las ratas, hipnotizadas por la música, lo siguieron y fueron arrastradas por la corriente." },
            { text: "Cuando el flautista regresó a reclamar su recompensa, el alcalde, viendo que el peligro había pasado, se rió de él. '¿Mil monedas de oro por tocar una canción? ¡Es ridículo! Te daremos cincuenta y date por satisfecho'. El flautista, furioso por la traición y la avaricia, advirtió: 'Se arrepentirán de no cumplir su promesa'." },
            { text: "Días después, cuando los adultos estaban en la iglesia, el flautista regresó. Esta vez tocó una melodía diferente, dulce y alegre. Pero ahora no eran ratas las que salían, sino los niños de Hamelín. Cogidos de la mano y riendo, siguieron al músico fuera de la ciudad." },
            { text: "El flautista los llevó hacia una gran montaña, donde se abrió una cueva mágica. Todos los niños entraron, y la cueva se cerró tras ellos. Solo un niño, que cojeaba y no pudo seguir el ritmo, se quedó fuera y regresó para contar lo sucedido." },
            { text: "Los padres, horrorizados, buscaron por todas partes, pero el flautista y los niños habían desaparecido. La ciudad de Hamelín quedó sumida en la tristeza, aprendiendo de la manera más dura que las promesas deben cumplirse y que la honestidad vale más que todo el oro del mundo." }
        ]
    },
    {
        id: 'gigante-egoista',
        title: 'El Gigante Egoísta',
        author: 'Oscar Wilde',
        description: 'Un gigante aprende que la generosidad trae la primavera eterna a su jardín y a su corazón.',
        level: 'Difícil',
        age: '6+',
        coverImage: '/images/storyteller/gigante-egoista-cover.png',
        chipImage: '/images/storyteller/character-gigante-egoista.png',
        ...
        rating: 4.8,
        content: [
            { text: "Todas las tardes, a la salida de la escuela, los niños iban a jugar al jardín del Gigante. Era un jardín amplio y hermoso, con suave césped verde y doce melocotoneros que en primavera se cubrían de flores rosadas. Los pájaros se posaban en los árboles y cantaban con tanta dulzura que los niños dejaban de jugar para escucharlos. '¡Qué felices somos aquí!', se gritaban unos a otros." },
            { text: "Pero un día el Gigante regresó. Había ido a visitar a su amigo el ogro de Cornualles y se había quedado allí siete años. Al llegar, vio a los niños jugando en su jardín. '¿Qué hacéis aquí?', gritó con voz muy áspera. Los niños salieron corriendo asustados. 'Mi jardín es para mí solo', dijo el Gigante, y construyó un muro alto alrededor, poniendo un cartel: PROHIBIDA LA ENTRADA." },
            { text: "Llegó la primavera, y en toda la comarca había flores y pajaritos. Solo en el jardín del Gigante Egoísta seguía siendo invierno. Los pájaros no querían cantar porque no había niños, y los árboles se olvidaron de florecer. La Nieve y la Escarcha decidieron quedarse allí para siempre. 'La primavera se ha olvidado de este jardín', decían." },
            { text: "Una mañana, el Gigante oyó una música deliciosa. Era un pequeño jilguero cantando. Miró por la ventana y vio algo maravilloso: los niños habían entrado por un agujero en el muro y estaban subidos a las ramas de los árboles. Y en cada árbol donde había un niño, había florecido la primavera. Solo en un rincón seguía siendo invierno; allí, un niño muy pequeño no podía subir al árbol y lloraba." },
            { text: "El corazón del Gigante se derritió. '¡Qué egoísta he sido!', se dijo. Salió al jardín y ayudó al niño pequeño a subir al árbol, que floreció al instante. El Gigante derribó el muro con su hacha. 'Desde ahora, este jardín será siempre vuestro', dijo a los niños." },
            { text: "Pasaron los años y el Gigante envejeció viendo jugar a los niños. Pero echaba de menos a aquel primer pequeño que había ayudado. Una mañana de invierno, vio maravillado que en el rincón más alejado, el árbol estaba cubierto de flores blancas y frutos de oro. Debajo estaba el niño." },
            { text: "El Gigante corrió hacia él. El niño sonrió y le dijo: 'Una vez tú me dejaste jugar en tu jardín; hoy vendrás conmigo a mi jardín, que es el Paraíso'. Cuando los otros niños llegaron aquella tarde, encontraron al Gigante dormido para siempre bajo el árbol, cubierto de flores blancas, con una sonrisa de paz en su rostro." }
        ]
    },
    {
        id: 'hansel-y-gretel',
        title: 'Hansel y Gretel',
        author: 'Hermanos Grimm',
        description: 'Dos hermanos abandonados en el bosque encuentran una casa hecha de dulces, pero su dueña no es tan dulce como parece.',
        level: 'Medio',
        age: '5+',
        ...
        rating: 4.5,
        content: [
            { text: "Cerca de un gran bosque vivía un pobre leñador con su esposa y sus dos hijos, Hansel y Gretel. Eran tiempos de mucha hambre y apenas tenían para comer. Una noche, la madrastra convenció al padre de que debían abandonar a los niños en el bosque, porque no podían alimentarlos a todos." },
            { text: "Hansel, que había escuchado todo, salió sigilosamente y llenó sus bolsillos de guijarros blancos. Al día siguiente, mientras caminaban hacia el bosque, Hansel fue dejando caer las piedrecitas una a una. Cuando los padres los dejaron solos, los niños esperaron a que saliera la luna. Gracias al brillo de los guijarros, pudieron encontrar el camino de vuelta a casa." },
            { text: "Tiempo después, la hambruna volvió a golpear. Esta vez, la madrastra cerró la puerta para que Hansel no pudiera recoger piedras. El niño tuvo que usar migas de su único pedazo de pan para marcar el camino. Pero cuando quedaron solos en el bosque y buscaron el rastro, vieron que los pájaros se habían comido las migas. Estaban perdidos." },
            { text: "Caminaron durante tres días hasta que vieron un pájaro blanco que los guió a un claro. Allí había una casita maravillosa: ¡estaba hecha de pan de jengibre, con ventanas de azúcar y techo de pastel! Hambrientos, los niños corrieron a comer trozos de la casa. De pronto, una anciana salió y los invitó a entrar con dulces palabras." },
            { text: "Pero la anciana era en realidad una bruja malvada que comía niños. Encerró a Hansel en una jaula para engordarlo y obligó a Gretel a trabajar como criada. Cada día, la bruja, que veía muy poco, pedía a Hansel que sacara un dedo para ver si estaba gordo. Hansel, astuto, sacaba un hueso de pollo, y la bruja se enfadaba porque seguía flaco." },
            { text: "Harta de esperar, la bruja decidió comerse a Hansel de todos modos. Ordenó a Gretel encender el horno. 'Métete dentro y mira si está caliente', dijo la bruja. Gretel, adivinando sus intenciones, dijo: 'No sé cómo hacerlo'. '¡Niña tonta!', gritó la bruja, '¡Mira, así!'. Y metió la cabeza en el horno." },
            { text: "Gretel aprovechó el momento, empujó a la bruja dentro y cerró la puerta de hierro. ¡La bruja se quemó! Gretel liberó a Hansel y, antes de huir, encontraron un cofre lleno de joyas y perlas en la casa. Llenaron sus bolsillos y corrieron hasta encontrar el camino a casa." },
            { text: "Al llegar, su padre lloró de alegría al verlos, pues había estado muy arrepentido. La madrastra había muerto. Con las joyas de la bruja, vivieron sin preocupaciones y felices para siempre." }
        ]
    },
    {
        id: 'jack-y-las-habichuelas',
        title: 'Jack y las Habichuelas',
        author: 'Cuento Popular Inglés',
        description: 'Unas semillas mágicas llevan a Jack a un castillo en el cielo, donde le esperan gigantes y tesoros.',
        level: 'Medio',
        age: '5+',
        coverImage: '/images/storyteller/jack-y-las-habichuelas-cover.png',
        chipImage: '/images/storyteller/character-jack.png',
        ...
        rating: 4.3,
        content: [
            { text: "Jack vivía con su madre viuda en una pequeña cabaña. Eran muy pobres y su única posesión era una vaca lechera. Un día, la vaca dejó de dar leche y la madre le dijo a Jack que la llevara al mercado para venderla y comprar comida." },
            { text: "En el camino, Jack se encontró con un anciano extraño que le ofreció un trato: 'Te cambio la vaca por estas cinco habichuelas mágicas'. Jack, fascinado, aceptó. Al volver a casa, su madre se enfadó muchísimo. '¡Nos has arruinado por unos frijoles!', gritó, y los arrojó por la ventana antes de mandar a Jack a la cama sin cenar." },
            { text: "A la mañana siguiente, Jack vio una sombra extraña en su habitación. Al mirar por la ventana, se quedó boquiabierto: ¡las habichuelas habían crecido hasta formar una planta gigantesca que llegaba hasta el cielo! Lleno de curiosidad, Jack empezó a trepar por el tallo." },
            { text: "Subió y subió hasta llegar a un país sobre las nubes. Allí vio un enorme castillo y decidió entrar. Una giganta le dio algo de comer, pero pronto llegó el Gigante dueño del castillo, gritando: '¡Fi, fa, fo, fum! ¡Huelo la sangre de un niño inglés!'. La giganta escondió a Jack en el horno." },
            { text: "El Gigante se sentó a contar sus monedas de oro y se quedó dormido. Jack salió del escondite, cogió una bolsa de oro y huyó bajando por la planta. Su madre se alegró mucho con el oro y vivieron bien un tiempo, pero el dinero se acabó. Jack decidió subir de nuevo." },
            { text: "Esta vez, Jack vio al Gigante con una gallina que ponía huevos de oro. Cuando el Gigante se durmió, Jack robó la gallina. Pero la tercera vez que subió, vio un arpa dorada que tocaba sola. Al intentar llevársela, el arpa gritó: '¡Amo, despierta!'. El Gigante se despertó y persiguió a Jack." },
            { text: "Jack bajó por la planta a toda velocidad, con el Gigante pisándole los talones. Al llegar al suelo, gritó: '¡Madre, trae el hacha!'. De un golpe certero, Jack cortó el tallo de la habichuela. La planta se desplomó y el Gigante cayó con ella, desapareciendo en un enorme agujero en la tierra." },
            { text: "Con la gallina de los huevos de oro y el arpa mágica, Jack y su madre nunca más pasaron hambre y vivieron felices y tranquilos el resto de sus días." }
        ]
    },
    {
        id: 'musicos-bremen',
        title: 'Los Músicos de Bremen',
        author: 'Hermanos Grimm',
        description: 'Cuatro animales ancianos huyen de sus dueños para formar una banda de música y encuentran un nuevo hogar.',
        level: 'Fácil',
        age: '4+',
        coverImage: '/images/storyteller/musicos-bremen-cover.png',
        chipImage: '/images/storyteller/character-musicos-bremen.png',
        ...
        rating: 4.4,
        content: [
            { text: "Un burro, que había trabajado duro toda su vida, escuchó que su dueño quería deshacerse de él por ser viejo. Decidió huir a la ciudad de Bremen para hacerse músico municipal. En el camino, encontró a un perro de caza jadeando tristemente. 'Mi amo quiere matarme porque ya soy viejo', dijo el perro. 'Vente conmigo', dijo el burro. 'Yo tocaré el laúd y tú los timbales'." },
            { text: "Más adelante encontraron a un gato con cara de tres días de lluvia. También huía porque su ama quería ahogarlo al no poder cazar ratones. '¡Únete a nosotros!', le dijeron. 'Entiendes mucho de música nocturna'. Poco después, vieron a un gallo gritando con todas sus fuerzas sobre una puerta. 'Mañana me harán caldo', se lamentaba. 'Tienes buena voz, vente con nosotros a Bremen', le propusieron." },
            { text: "La noche les sorprendió en medio de un bosque. Vieron una luz a lo lejos y se acercaron. Era una casa de ladrones, llena de comida y bebida. Los cuatro amigos, hambrientos, idearon un plan para espantarlos. El burro puso sus patas en la ventana, el perro subió al burro, el gato al perro y el gallo voló sobre la cabeza del gato." },
            { text: "A una señal, todos empezaron su 'música': el burro rebuznaba, el perro ladraba, el gato maullaba y el gallo cantaba. Rompieron la ventana y entraron con estruendo. Los ladrones, creyendo que eran fantasmas, huyeron aterrorizados al bosque. Los animales comieron hasta hartarse y se echaron a dormir." },
            { text: "Más tarde, el jefe de los ladrones envió a uno a inspeccionar. La casa estaba a oscuras. El ladrón confundió los ojos brillantes del gato con brasas e intentó encender una cerilla. El gato le arañó la cara, el perro le mordió la pierna y el burro le dio una coz. El gallo gritó: '¡Kikirikí!'." },
            { text: "El ladrón corrió de vuelta y dijo: '¡Hay una bruja horrible que me arañó, un hombre con un cuchillo me cortó la pierna, un monstruo me golpeó con un mazo y un juez gritaba Traédmelo aquí!'. Los ladrones no se atrevieron a volver nunca más. Y a los cuatro músicos de Bremen les gustó tanto la casa que se quedaron a vivir allí felices para siempre." }
        ]
    },
    {
        id: 'pinocho',
        title: 'Pinocho',
        author: 'Carlo Collodi',
        description: 'La entrañable historia de una marioneta de madera que sueña con convertirse en un niño de verdad.',
        level: 'Largo',
        age: '5+',
        coverImage: '/images/storyteller/pinocho-cover.png',
        chipImage: '/images/storyteller/character-pinocho.png',
        ...
        rating: 4.8,
        content: [
            { text: "El viejo carpintero Geppetto talló una marioneta de un trozo de madera mágica. 'Te llamarás Pinocho', dijo. Para su sorpresa, la marioneta empezó a moverse y a hablar como un niño. Geppetto estaba feliz de tener un hijo, vendió su abrigo para comprarle una cartilla y lo mandó a la escuela. Pero Pinocho era muy travieso." },
            { text: "En lugar de ir a la escuela, vendió la cartilla para entrar a un teatro de marionetas. Luego se encontró con el Zorro y el Gato, dos pillos que lo engañaron para robarle, prometiéndole plantar sus monedas para que creciera un árbol de dinero. El Hada Azul lo salvó y le preguntó por qué no estaba en la escuela. Pinocho mintió, y con cada mentira, ¡su nariz crecía y crecía!" },
            { text: "Pinocho prometió ser bueno, pero pronto se dejó convencer por su amigo 'Mecha' para ir al País de los Juguetes, un lugar donde no había escuela y se jugaba todo el día. Se divirtieron mucho, pero una mañana, Pinocho despertó con orejas de burro. ¡Todos los niños viciosos se convertían en burros allí!" },
            { text: "Convertido en borrico, fue vendido a un circo, se lastimó y fue arrojado al mar. Al tocar el agua, los peces comieron su disfraz de burro y volvió a ser una marioneta. Pero una ballena gigante se lo tragó de un bocado. En el oscuro vientre de la ballena, vio una luz. ¡Era Geppetto! Había salido a buscarlo en un bote y también fue tragado." },
            { text: "'¡Papá, tenemos que salir!', dijo Pinocho. Aprovechando que la ballena dormía con la boca abierta, salieron con cuidado y nadaron hasta la orilla. Geppetto estaba muy débil, y Pinocho trabajó duro para cuidarlo, demostrando que había aprendido a ser responsable y a amar a su padre." },
            { text: "Una noche, el Hada Azul apareció en sus sueños. 'Has demostrado tener un buen corazón, Pinocho', le dijo. Al despertar, Pinocho se miró al espejo: ya no era de madera. ¡Se había convertido en un niño de verdad! Geppetto y él lloraron de felicidad y vivieron juntos para siempre." }
        ]
    },
    {
        id: 'rumpelstiltskin',
        title: 'Rumpelstiltskin',
        author: 'Hermanos Grimm',
        description: 'Una joven reina debe adivinar el nombre de un duende mágico para salvar a su hijo.',
        level: 'Difícil',
        age: '6+',
        coverImage: '/images/storyteller/rumpelstiltskin-cover.png',
        chipImage: '/images/storyteller/character-rumpelstiltskin.png',
        genre: 'Cuento de hadas',
        themeColor: 'from-gray-700 to-slate-800',
        rating: 4.1,
        content: [
            { text: "Un molinero pobre, queriendo dárselas de importante ante el Rey, mintió diciendo: 'Mi hija es tan hábil que puede hilar paja y convertirla en oro'. El Rey, que amaba el oro, ordenó traer a la muchacha, la encerró en una habitación llena de paja y le dijo: 'Si para mañana no has convertido todo esto en oro, morirás'. La pobre chica se echó a llorar, pues no sabía hacerlo." },
            { text: "De repente, apareció un duendecillo extraño. '¿Qué me das si lo hago por ti?', preguntó. 'Mi collar', dijo ella. El duende se sentó a la rueca y rrruuun, rrruuun, toda la paja se convirtió en oro. Al día siguiente, el Rey, asombrado pero codicioso, la encerró en una sala más grande. El duende volvió y pidió el anillo de la chica a cambio de su ayuda." },
            { text: "La tercera noche, el Rey la llevó a una sala inmensa y prometió: 'Si logras esto, me casaré contigo'. El duende apareció de nuevo, pero la chica ya no tenía nada. 'Prométeme tu primer hijo cuando seas reina', le exigió. Desesperada, ella aceptó. El duende cumplió, y el Rey se casó con la molinera." },
            { text: "Un año después, la Reina tuvo un hermoso niño, olvidando al duende. Pero este apareció de repente: 'Dame lo prometido'. La Reina lloró tanto que el duende sintió lástima. 'Te doy tres días', dijo. 'Si adivinas mi nombre, podrás quedarte con el niño'." },
            { text: "La Reina envió mensajeros por todo el país buscando nombres. Probó con Melchor, Gaspar, Baltasar... pero el duende siempre decía: 'No me llamo así'. Al tercer día, un mensajero volvió contando: 'En el bosque vi a un hombrecillo saltando alrededor de un fuego y cantando: Hoy tomo vino, mañana cerveza, ¡el hijo de la Reina me traeré! ¡Nadie sabe, qué maravilla, que Rumpelstiltskin me llamo yo!'." },
            { text: "Cuando llegó el duende y preguntó su nombre, la Reina se burló un poco: '¿Te llamas Kunz? ¿Te llamas Heinz?'. 'No'. '¿Será acaso... Rumpelstiltskin?'. '¡Te lo ha dicho el diablo!', gritó el duende furioso, y pataleó con tanta fuerza que hundió el pie en la tierra y se partió en dos, desapareciendo para siempre. La Reina y su hijo vivieron tranquilos y felices." }
        ]
    },
    {
        id: 'sastrecillo-valiente',
        title: 'El Sastrecillo Valiente',
        author: 'Hermanos Grimm',
        description: 'Un pequeño sastre usa su ingenio para vencer gigantes y ganar un reino, armado solo con su astucia.',
        level: 'Medio',
        age: '5+',
        coverImage: '/images/storyteller/sastrecillo-valiente-cover.png',
        chipImage: '/images/storyteller/character-sastrecillo-valiente.png',
        ...
        rating: 4.5,
        content: [
            { text: "Un día de verano, un sastrecillo estaba cosiendo alegremente cuando unas moscas empezaron a molestarle queriendo posarse en su mermelada. Harto, cogió un trapo y ¡zas!, mató a siete moscas de un solo golpe. Admirado de su propia hazaña, se bordó un cinturón que decía en letras grandes: 'SIETE DE UN GOLPE'. 'El mundo debe saber esto', pensó, y salió a correr aventuras." },
            { text: "Encontró a un Gigante y le mostró el cinturón. El Gigante pensó que había matado a siete hombres y le tuvo respeto, pero quiso probar su fuerza. El Gigante exprimió una piedra hasta sacar agua. El sastre, astuto, sacó un queso y lo apretó hasta que chorreó suero. El Gigante lanzó una piedra al cielo; el sastre soltó un pájaro que tenía en el bolsillo y que voló tan alto que no volvió a caer." },
            { text: "El Gigante lo invitó a su cueva. Por la noche, intentó aplastar la cama donde dormía el sastre con una barra de hierro, pero el sastre, que era muy listo, se había escondido en un rincón. Al verlo vivo por la mañana, los gigantes huyeron aterrorizados." },
