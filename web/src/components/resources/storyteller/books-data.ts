...
export const BOOKS: Book[] = [
    ...
    },
    {
        ...
        rating: 4.6,
        content: [
            { text: "Había una vez un joven príncipe que vivía en un reino lejano y espléndoso. Como todos los príncipes de los cuentos, su mayor deseo era casarse, pero no con cualquiera." },
            { text: "Su madre, la vieja Reina, siempre le decía: 'Hijo mío, debes casarte con una princesa de verdad. No una duquesa, ni una condesa, sino una princesa de sangre real, tan delicada como una flor'." },
            { text: "El príncipe, decidido a encontrar a su amada, emprendió un largo viaje por todo el mundo conocido. Visitó reinos del norte, del sur, del este y del oeste." },
            { text: "En cada lugar encontraba princesas hermosas, inteligentes y encantadoras. Pero el príncipe era muy exigente y observador, y siempre encontraba algún detalle que le hacía dudar." },
            { text: "Una reía demasiado fuerte, otra comía con modales extraños, y otra no parecía saber comportarse en la corte. '¿Serán princesas de verdad?', se preguntaba siempre con tristeza." },
            { text: "Después de un año entero de búsqueda infructuosa, regresó a su castillo cabizbajo. 'Princesas hay muchas', le dijo a su padre el Rey, 'pero ninguna parece ser una verdadera princesa'." },
            { text: "Una noche, mientras la familia real cenaba, se desató una tormenta espantosa. Los truenos rugían como leones furiosos y los relámpagos iluminaban el cielo oscuro." },
            { text: "La lluvia caía a cántaros, golpeando las ventanas del castillo sin piedad. Era una noche para estar a resguardo junto al fuego, y nadie en su sano juicio saldría fuera." },
            { text: "De repente, se escucharon unos golpes débiles en el gran portón del castillo. El viejo Rey, extrañado, se levantó de su trono, cogió un candelabro y fue a abrir él mismo." },
            { text: "Allí, bajo la lluvia torrencial, había una joven muchacha. ¡Pero santo cielo, qué aspecto tenía la pobre! Estaba completamente empapada y temblaba de frío." },
            { text: "El agua le chorreaba por el pelo revuelto y por su vestido de seda arruinado. Le entraba por la punta de los zapatos rotos y le salía por los talones. Parecía una vagabunda." },
            { text: "'Soy una princesa', dijo la joven con voz firme a pesar de castañetear los dientes. 'Una verdadera princesa que se ha perdido en la tormenta, por favor, dadme cobijo'." },
            { text: "'Ya lo veremos', pensó la vieja Reina, que había llegado detrás del Rey. No dijo nada en voz alta, pero sonrió con astucia y ordenó a los criados preparar una habitación." },
            { text: "La Reina fue al dormitorio de invitados, quitó toda la ropa de la cama y colocó un pequeño guisante verde y duro justo en el centro del somier de madera." },
            { text: "Luego, ordenó traer veinte colchones de lana gruesa y los apiló uno sobre otro, encima del guisante. Y sobre los colchones, puso veinte edredones de plumas de eider, suaves y esponjosos." },
            { text: "Aquella era una cama altísima, casi llegaba al techo. 'Aquí dormirá nuestra invitada esta noche', dijo la Reina. La joven princesa tuvo que usar una escalera para subir hasta lo más alto." },
            { text: "A la mañana siguiente, durante el desayuno, la familia real le preguntó cortésmente cómo había pasado la noche. La joven tenía ojeras y parecía muy cansada." },
            { text: "'¡Oh, terriblemente mal!', exclamó la princesa con sinceridad. 'Apenas he podido cerrar los ojos en toda la noche. ¡Dios sabe lo que había en esa cama!'." },
            { text: "'He estado acostada sobre algo tan duro y molesto que tengo todo el cuerpo lleno de moratones. ¡Es la cama más incómoda en la que he dormido jamás!', se quejó." },
            { text: "El Rey, la Reina y el Príncipe se miraron asombrados. ¡Solo una verdadera princesa podía tener una piel tan delicada y sensible como para sentir un guisante a través de veinte colchones y veinte edredones!" },
            { text: "El Príncipe supo entonces que había encontrado lo que buscaba. Se casaron con una gran fiesta y vivieron felices. Y el guisante fue llevado al Museo Real, donde todavía puede verse, a no ser que alguien se lo haya llevado." }
        ],
        contentEn: [
