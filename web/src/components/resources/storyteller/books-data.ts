...
export const BOOKS: Book[] = [
    {
        ...
        titleFr: 'Le Vilain Petit Canard',
        titleDe: 'Das hässliche Entlein',
        ...
        descriptionEn: 'The touching story of a little duckling who suffers rejection for being different, until time reveals his true and majestic nature.',
        descriptionFr: 'L\'histoire touchante d\'un petit caneton qui souffre du rejet parce qu\'il est différent, jusqu\'à ce que le temps révèle sa vraie et majestueuse nature.',
        descriptionDe: 'Die rührende Geschichte eines kleinen Entleins, das Ablehnung erfährt, weil es anders ist, bis die Zeit seine wahre und majestätische Natur enthüllt.',
        level: 'Fácil',
        age: '4+',
    ...
    },
    {
        ...
        descriptionEn: 'The classic warning about the dangers of talking to cunning wolves, on a journey to grandma\'s house.',
        descriptionFr: 'L\'avertissement classique sur les dangers de parler aux loups rusés, lors d\'un voyage chez grand-mère.',
        descriptionDe: 'Die klassische Warnung vor den Gefahren, mit listigen Wölfen zu sprechen, auf einer Reise zu Großmutters Haus.',
        level: 'Fácil',
        age: '3+',
    ...
    },
    {
        ...
        titleFr: 'Le Chat Botté',
        titleDe: 'Der gestiefelte Kater',
        ...
        descriptionEn: 'The classic Grimm Brothers version about the cleverest cat in history, capable of turning a humble miller into a king.',
        descriptionFr: 'La version classique des frères Grimm sur le chat le plus rusé de l\'histoire, capable de transformer un humble meunier en roi.',
        descriptionDe: 'Die klassische Version der Gebrüder Grimm über den schlausten Kater der Geschichte, der fähig ist, einen bescheidenen Müller in einen König zu verwandeln.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        descriptionEn: 'The brave story of little Tom Thumb, who with his wit and magic boots saves his seven brothers from a fearsome ogre.',
        descriptionFr: 'L\'histoire courageuse du petit Poucet, qui avec son esprit et des bottes magiques sauve ses sept frères d\'un ogre redoutable.',
        descriptionDe: 'Die tapfere Geschichte des kleinen Däumlings, der mit seinem Witz und magischen Stiefeln seine sieben Brüder vor einem furchterregenden Menschenfresser rettet.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleFr: 'Hansel et Gretel',
        titleDe: 'Hänsel und Gretel',
        author: 'Hermanos Grimm',
        ...
        descriptionEn: 'Two siblings lost in the woods discover a house made of sweets, but soon face a danger greater than they ever imagined.',
        descriptionFr: 'Deux frères et sœurs perdus dans la forêt découvrent une maison faite de bonbons, mais font bientôt face à un danger plus grand qu\'ils ne l\'avaient jamais imaginé.',
        descriptionDe: 'Zwei im Wald verlorene Geschwister entdecken ein Haus aus Süßigkeiten, stehen aber bald einer Gefahr gegenüber, die größer ist, als sie es sich je vorgestellt haben.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/hansel-gretel-bruja.jpg',
    ...
    },
    {
        ...
        titleFr: 'La Petite Sirène',
        titleDe: 'Die kleine Meerjungfrau',
        author: 'Hans Christian Andersen',
        ...
        descriptionEn: 'Hans Christian Andersen\'s original story about a little mermaid who gives up her voice for love and the search for an immortal soul.',
        descriptionFr: 'L\'histoire originale de Hans Christian Andersen sur une petite sirène qui donne sa voix par amour et la recherche d\'une âme immortelle.',
        descriptionDe: 'Die Originalgeschichte von Hans Christian Andersen über eine kleine Meerjungfrau, die ihre Stimme für die Liebe und die Suche nach einer unsterblichen Seele aufgibt.',
        level: 'Medio',
        age: '7+',
    ...
    },
    {
        ...
        titleFr: 'Le Petit Soldat de Plomb',
        titleDe: 'Der standhafte Zinnsoldat',
        author: 'Hans Christian Andersen',
        ...
        descriptionEn: 'The heroic and melancholic story of a one-legged soldier who faces storms, sewers and abysses for the love of a paper ballerina.',
        descriptionFr: 'L\'histoire héroïque et mélancolique d\'un petit soldat unijambiste qui affronte tempêtes, égouts et abîmes pour l\'amour d\'une ballerine en papier.',
        descriptionDe: 'Die heldenhafte und melancholische Geschichte eines einbeinigen Soldaten, der Stürme, Abwasserkanäle und Abgründe aus Liebe zu einer Papierballerina meistert.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        descriptionEn: 'A timeless tale about redemption through love, where true beauty is found inside the heart.',
        descriptionFr: 'Un conte intemporel sur la rédemption par l\'amour, où la vraie beauté se trouve à l\'intérieur du cœur.',
        descriptionDe: 'Ein zeitloses Märchen über Erlösung durch Liebe, wo wahre Schönheit im Inneren des Herzens gefunden wird.',
        level: 'Difícil',
        age: '7+',
    ...
    },
    {
        ...
        descriptionEn: 'The story of the young woman with long golden hair locked in a tower, and how love conquers even the most powerful sorcery.',
        descriptionFr: 'L\'histoire de la jeune femme aux longs cheveux dorés enfermée dans une tour, et comment l\'amour vainc même la sorcellerie la plus puissante.',
        descriptionDe: 'Die Geschichte der jungen Frau mit dem langen goldenen Haar, die in einem Turm eingesperrt ist, und wie die Liebe selbst die mächtigste Zauberei besiegt.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleFr: 'Jack et le Haricot Magique',
        titleDe: 'Hans und die Bohnenstange',
        author: 'Tradicional',
        description: 'La aventura de un niño que, impulsado por unas semillas mágicas, escala hasta el cielo para cambiar su destino.',
        descriptionEn: 'The adventure of a boy who, driven by magic seeds, climbs to the sky to change his destiny.',
        descriptionFr: 'L\'aventure d\'un garçon qui, poussé par des graines magiques, grimpe jusqu\'au ciel pour changer son destin.',
        descriptionDe: 'Das Abenteuer eines Jungen, der, angetrieben von magischen Samen, in den Himmel klettert, um sein Schicksal zu ändern.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        titleFr: 'Le Joueur de Flûte de Hamelin',
        titleDe: 'Der Rattenfänger von Hameln',
        author: 'Hermanos Grimm',
        ...
        descriptionEn: 'The legend of a broken promise and an enchanted melody that taught a whole town the value of honesty.',
        descriptionFr: 'La légende d\'une promesse rompue et d\'une mélodie enchantée qui a enseigné à toute une ville la valeur de l\'honnêteté.',
        descriptionDe: 'Die Legende eines gebrochenen Versprechens und einer verzauberten Melodie, die einer ganzen Stadt den Wert der Ehrlichkeit lehrte.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        descriptionEn: 'The unforgettable odyssey of a mischievous puppet who must learn about truth, conscience and sacrifice to become a real boy.',
        descriptionFr: 'L\'odyssée inoubliable d\'une marionnette espiègle qui doit apprendre la vérité, la conscience et le sacrifice pour devenir un vrai petit garçon.',
        descriptionDe: 'Die unvergessliche Odyssee einer schelmischen Marionette, die Wahrheit, Gewissen und Opferbereitschaft lernen muss, um ein echter Junge zu werden.',
        level: 'Difícil',
        age: '7+',
    ...
    },
    {
        ...
        titleFr: 'Le Géant Égoïste',
        titleDe: 'Der selbstsüchtige Riese',
        author: 'Oscar Wilde',
        description: 'Un conmovedor relato sobre cómo la inocencia de los niños puede derretir incluso el corazón más helado.',
        descriptionEn: 'A touching tale about how the innocence of children can melt even the iciest heart.',
        descriptionFr: 'Un conte émouvant sur la façon dont l\'innocence des enfants peut faire fondre même le cœur le plus glacé.',
        descriptionDe: 'Eine berührende Geschichte darüber, wie die Unschuld von Kindern selbst das eisigste Herz zum Schmelzen bringen kann.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleEn: 'Aladdin and the Wonderful Lamp',
        titleFr: 'Aladin et la Lampe Merveilleuse',
        titleDe: 'Aladin und die Wunderlampe',
        ...
        descriptionEn: 'The magical adventure of a young man who, with the help of a genie, discovers that his true worth lies not in wealth, but in his heart.',
        descriptionFr: 'L\'aventure magique d\'un jeune homme qui, avec l\'aide d\'un génie, découvre que sa vraie valeur ne réside pas dans la richesse, mais dans son cœur.',
        descriptionDe: 'Das magische Abenteuer eines jungen Mannes, der mit Hilfe eines Dschinns entdeckt, dass sein wahrer Wert nicht im Reichtum liegt, sondern in seinem Herzen.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleFr: 'La Belle au Bois Dormant',
        titleDe: 'Dornröschen',
        ...
        descriptionEn: 'The legend of a princess condemned to sleep for a hundred years and of true love that defies time and thorns.',
        descriptionFr: 'La légende d\'une princesse condamnée à dormir cent ans et du véritable amour qui défie le temps et les épines.',
        descriptionDe: 'Die Legende einer Prinzessin, die dazu verdammt ist, hundert Jahre zu schlafen, und von wahrer Liebe, die Zeit und Dornen trotzt.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        titleEn: 'Cinderella',
        titleFr: 'Cendrillon',
        titleDe: 'Aschenputtel',
        author: 'Hermanos Grimm / Perrault',
        description: 'La clásica historia de bondad, magia y zapatos de cristal que demuestra que los sueños se hacen realidad.',
        descriptionEn: 'The classic story of kindness, magic and glass slippers that proves dreams come true.',
        descriptionFr: 'L\'histoire classique de gentillesse, de magie et de pantoufles de verre qui prouve que les rêves deviennent réalité.',
        descriptionDe: 'Die klassische Geschichte von Freundlichkeit, Magie und gläsernen Schuhen, die beweist, dass Träume wahr werden.',
        level: 'Medio',
        age: '4+',
    ...
    },
    {
        ...
        titleEn: 'The Town Musicians of Bremen',
        titleFr: 'Les Musiciens de Brême',
        titleDe: 'Die Bremer Stadtmusikanten',
        author: 'Hermanos Grimm',
        description: 'La divertida aventura de cuatro animales que demuestran que nunca es tarde para encontrar un nuevo hogar.',
        descriptionEn: 'The fun adventure of four animals who prove it\'s never too late to find a new home.',
        descriptionFr: 'L\'aventure amusante de quatre animaux qui prouvent qu\'il n\'est jamais trop tard pour trouver un nouveau foyer.',
        descriptionDe: 'Das lustige Abenteuer von vier Tieren, die beweisen, dass es nie zu spät ist, ein neues Zuhause zu finden.',
        level: 'Fácil',
        age: '4+',
    ...
    },
    {
        ...
        title: 'Blancanieves',
        titleEn: 'Snow White',
        titleFr: 'Blanche-Neige',
        titleDe: 'Schneewittchen',
        author: 'Hermanos Grimm',
        ...
        descriptionEn: 'The story of a princess with skin white as snow who, fleeing from an evil stepmother, finds refuge and friendship in the house of seven little dwarfs.',
        descriptionFr: 'L\'histoire d\'une princesse à la peau blanche comme la neige qui, fuyant une méchante belle-mère, trouve refuge et amitié dans la maison de sept petits nains.',
        descriptionDe: 'Die Geschichte einer Prinzessin mit schneeweißer Haut, die auf der Flucht vor einer bösen Stiefmutter im Haus von sieben kleinen Zwergen Zuflucht und Freundschaft findet.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        titleEn: 'The Brave Little Tailor',
        titleFr: 'Le Vaillant Petit Tailleur',
        titleDe: 'Das tapfere Schneiderlein',
        author: 'Hermanos Grimm',
        ...
        descriptionEn: 'A tale that celebrates cunning over brute strength and reminds us that self-confidence is the most powerful tool.',
        descriptionFr: 'Un conte qui célèbre la ruse par rapport à la force brute et nous rappelle que la confiance en soi est l\'outil le plus puissant.',
        descriptionDe: 'Eine Geschichte, die List über rohe Gewalt feiert und uns daran erinnert, dass Selbstvertrauen das mächtigste Werkzeug ist.',
        level: 'Medio',
        age: '5+',
    ...
    },
    {
        ...
        titleFr: 'Nain Tracassin',
        titleDe: 'Rumpelstilzchen',
        author: 'Hermanos Grimm',
        ...
        descriptionEn: 'A tale that warns of the dangers of vanity and the strange power that lies in knowing the true name of things.',
        descriptionFr: 'Un conte qui met en garde contre les dangers de la vanité et l\'étrange pouvoir qui réside dans la connaissance du vrai nom des choses.',
        descriptionDe: 'Eine Geschichte, die vor den Gefahren der Eitelkeit warnt und der seltsamen Macht, die darin liegt, den wahren Namen der Dinge zu kennen.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleEn: 'Ali Baba and the Forty Thieves',
        titleFr: 'Ali Baba et les Quarante Voleurs',
        titleDe: 'Ali Baba und die vierzig Räuber',
        author: 'Las Mil y Una Noches',
        ...
        descriptionEn: 'A chronicle from the Arabian Nights about fortune, fratricidal envy, and the cunning of a woman who saved a whole family.',
        descriptionFr: 'Une chronique des Mille et Une Nuits sur la fortune, l\'envie fratricide et la ruse d\'une femme qui sauva toute une famille.',
        descriptionDe: 'Eine Chronik aus Tausendundeiner Nacht über Glück, brudermörderischen Neid und die List einer Frau, die eine ganze Familie rettete.',
        level: 'Difícil',
        age: '7+',
    ...
    },
    {
        ...
        titleFr: 'Les Trois Petits Cochons',
        titleDe: 'Die drei kleinen Schweinchen',
        ...
        descriptionEn: 'The story of three brothers who learn that effort and foresight are the best defense against life\'s difficulties.',
        descriptionFr: 'L\'histoire de trois frères qui apprennent que l\'effort et la prévoyance sont la meilleure défense contre les difficultés de la vie.',
        descriptionDe: 'Die Geschichte von drei Brüdern, die lernen, dass Anstrengung und Voraussicht die beste Verteidigung gegen die Schwierigkeiten des Lebens sind.',
        level: 'Fácil',
        age: '3+',
    ...
    },
    {
        ...
        titleEn: 'The Wolf and the Seven Young Kids',
        titleFr: 'Le Loup et les Sept Chevreaux',
        titleDe: 'Der Wolf und die sieben Geißlein',
        author: 'Hermanos Grimm',
        description: 'Un cuento clásico sobre la precaución, el engaño y el valor de una madre para proteger a sus hijos.',
        descriptionEn: 'A classic tale about caution, deception, and a mother\'s courage to protect her children.',
        descriptionFr: 'Un conte classique sur la prudence, la tromperie et le courage d\'une mère pour protéger ses enfants.',
        descriptionDe: 'Ein klassisches Märchen über Vorsicht, Täuschung und den Mut einer Mutter, ihre Kinder zu beschützen.',
        level: 'Medio',
        age: '4+',
    ...
    },
    {
        ...
        titleFr: 'Alice au Pays des Merveilles',
        titleDe: 'Alice im Wunderland',
        ...
        descriptionEn: 'Alice\'s fantastic journey through a world of absurdities, strange creatures, and nonsensical riddles.',
        descriptionFr: 'Le voyage fantastique d\'Alice à travers un monde d\'absurdités, de créatures étranges et d\'énigmes absurdes.',
        descriptionDe: 'Alices fantastische Reise durch eine Welt voller Absurditäten, seltsamer Kreaturen und unsinniger Rätsel.',
        level: 'Difícil',
        age: '8+',
    ...
    },
    {
        id: 'mago-oz',
        title: 'El Mago de Oz',
        titleEn: 'The Wizard of Oz',
        titleFr: 'Le Magicien d\'Oz',
        titleDe: 'Der Zauberer von Oz',
        author: 'L. Frank Baum',
        ...
        descriptionEn: 'Dorothy and her dog Toto are swept away by a cyclone to the land of Oz, where they embark on a fantastic journey to find their way home.',
        descriptionFr: 'Dorothy et son chien Toto sont emportés par un cyclone au pays d\'Oz, où ils entreprennent un voyage fantastique pour retrouver le chemin de la maison.',
        descriptionDe: 'Dorothy und ihr Hund Toto werden von einem Wirbelsturm in das Land Oz gerissen, wo sie sich auf eine fantastische Reise begeben, um den Weg nach Hause zu finden.',
        level: 'Medio',
        age: '6+',
    ...
    },
    {
        ...
        titleDe: 'Peter Pan',
        author: 'J.M. Barrie',
        description: 'Acompaña a Peter Pan, Wendy y Campanilla en un viaje mágico al País de Nunca Jamás, donde los niños nunca crecen y la aventura nunca termina.',
        descriptionEn: 'Join Peter Pan, Wendy, and Tinker Bell on a magical journey to Neverland, where children never grow up and the adventure never ends.',
        descriptionFr: 'Rejoignez Peter Pan, Wendy et la Fée Clochette pour un voyage magique au Pays Imaginaire, où les enfants ne grandissent jamais et l\'aventure ne finit jamais.',
        descriptionDe: 'Begleiten Sie Peter Pan, Wendy und Tinker Bell auf einer magischen Reise ins Nimmerland, wo Kinder niemals erwachsen werden und das Abenteuer niemals endet.',
        level: 'Medio',
        age: '5+',
        coverImage: '/images/storyteller/peter-pan-cover.jpg',
        chipImage: '/images/storyteller/character-peter-pan.png',
        genre: 'Aventura/Fantasía',
        themeColor: 'from-amber-600 to-green-800',
        rating: 4.9,
        content: [
            { text: "En una acogedora casa de Londres, Wendy, John y Michael Darling dormían plácidamente en su guardería. Lo que no sabían era que esa noche recibirían una visita extraordinaria. Peter Pan, el niño que nunca crece, había entrado volando por la ventana buscando algo muy importante. Estaba acompañado por Campanilla, una pequeña y brillante hada que revoloteaba por toda la habitación dejando un rastro de polvo mágico tras de sí." },
            { text: "Peter buscaba su sombra, que había perdido en una visita anterior. Wendy se despertó y, con mucha maña, cosió la sombra de Peter a sus pies. Agradecido, Peter invitó a los hermanos Darling a viajar con él al País de Nunca Jamás. '¡Solo necesitáis pensar en cosas felices y un poco de polvo de hadas!', exclamó Peter. De repente, los tres niños se elevaron por los aires y salieron volando por la ventana hacia la segunda estrella a la derecha." },
            { text: "El viaje fue maravilloso. Volaron sobre las nubes y cruzaron el océano hasta que divisaron el País de Nunca Jamás. Era una isla mágica llena de selvas profundas, lagunas de sirenas y montañas misteriosas. Al aterrizar, fueron recibidos por los Niños Perdidos, un grupo de valientes pequeños que vivían en una casa subterránea oculta bajo las raíces de un árbol gigante. Wendy aceptó encantada convertirse en la 'madre' de todos ellos, contándoles cuentos cada noche." },
            { text: "Pero el País de Nunca Jamás también era peligroso. El malvado Capitán Garfio y su tripulación de piratas patrullaban las costas en el barco 'Jolly Roger'. Garfio odiaba a Peter Pan desde que este le cortó la mano en una batalla y se la dio de comer a un cocodrilo. Desde entonces, el cocodrilo perseguía a Garfio a todas partes. Por suerte, el cocodrilo se había tragado un reloj y su 'tictac' avisaba siempre de su presencia, aterrorizando al malvado capitán." },
            { text: "Un día, los piratas capturaron a la princesa india Tigrilla y la llevaron a la Laguna de las Sirenas. Peter Pan, demostrando su gran valentía, se enfrentó a Garfio en un emocionante duelo de espadas sobre las rocas. Con astucia y agilidad, Peter logró rescatar a Tigrilla y devolverla con su tribu. La Laguna, con sus aguas cristalinas y sirenas de cabellos largos, fue testigo de la heroica hazaña del niño que no quería crecer." },
            { text: "Mientras tanto, Campanilla se sentía un poco celosa de la atención que Peter le prestaba a Wendy. En un momento de debilidad, la pequeña hada fue engañada por el Capitán Garfio para que revelara el escondite secreto de los Niños Perdidos. Sin embargo, al darse cuenta de su error, Campanilla voló desesperadamente para avisar a Peter del peligro, arriesgando su propia luz para salvar a sus amigos de la trampa pirata." },
            { text: "Aprovechando la ausencia de Peter, los piratas capturaron a Wendy, a sus hermanos y a todos los Niños Perdidos. Los llevaron encadenados al barco pirata, donde Garfio les obligaría a 'caminar por el tablón' hacia el mar. Wendy intentó mantener la calma y dar ánimos a los demás niños, recordándoles que Peter Pan nunca los abandonaría y que siempre había esperanza mientras se tuviera un pensamiento feliz." },
            { text: "Peter Pan, al enterarse de la captura de sus amigos, voló hacia el barco pirata en silencio. Imitó el 'tictac' del cocodrilo para asustar a los piratas y sembrar el caos en la cubierta. Mientras los piratas temblaban de miedo pensando que el cocodrilo estaba a bordo, Peter liberó discretamente a los niños. ¡De repente, comenzó la gran batalla final! El sonido del acero y los gritos de aventura llenaron la noche estrellada sobre el mar." },
            { text: "El duelo entre Peter Pan y el Capitán Garfio fue legendario. Saltaron entre los mástiles y las velas del Jolly Roger. '¡Ríndete, Garfio!', gritaba Peter con una sonrisa pícara. Finalmente, el capitán perdió el equilibrio y cayó por la borda, justo donde el enorme cocodrilo lo estaba esperando con la boca abierta. Los piratas, aterrados al ver caer a su líder, huyeron rápidamente del lugar, dejando el barco en manos de Peter y sus amigos." },
            { text: "Con el Jolly Roger ahora cubierto de polvo de hadas, Peter usó el barco para llevar a Wendy, John y Michael de vuelta a Londres. Wendy le pidió a Peter que se quedara con ellos y creciera en una familia de verdad, pero Peter negó con la cabeza. 'Yo quiero ser siempre un niño y divertirme', respondió. Prometió, sin embargo, regresar cada año para escuchar los cuentos de Wendy y seguir siendo su mejor amigo." },
            { text: "El barco pirata volador aterrizó suavemente frente a la ventana de la guardería de los Darling. Los padres de Wendy, que habían estado muy tristes, corrieron a abrazar a sus hijos con lágrimas de alegría. Los Niños Perdidos también fueron adoptados por la familia Darling, encontrando por fin el hogar que siempre habían deseado. Esa noche, todos durmieron bajo el cálido techo de su casa, soñando con las maravillas del País de Nunca Jamás." },
            { text: "Desde su ventana, Wendy vio cómo el Jolly Roger se alejaba volando hacia la segunda estrella a la derecha. Peter Pan y Campanilla saludaban desde lo alto antes de desaparecer en el cielo nocturno. Aunque Wendy creció y se convirtió en madre, nunca olvidó el polvo de hadas ni la magia de la infancia. Sabía que mientras hubiera niños alegres e inocentes, Peter Pan seguiría volando libre, protegiendo los sueños de todos." }
        ],
        contentEn: [
            { text: "In a cozy London house, Wendy, John, and Michael Darling slept peacefully in their nursery. What they didn't know was that they would receive an extraordinary visitor that night. Peter Pan, the boy who never grows up, had flown in through the window looking for something very important. He was accompanied by Tinker Bell, a tiny, bright fairy who fluttered all over the room, leaving a trail of magic dust behind her." },
            { text: "Peter was looking for his shadow, which he had lost on a previous visit. Wendy woke up and, with great skill, sewed Peter's shadow to his feet. Grateful, Peter invited the Darling siblings to travel with him to Neverland. 'All you need is faith and trust, and a little bit of pixie dust!', Peter exclaimed. Suddenly, the three children rose into the air and flew out the window toward the second star to the right." },
            { text: "The journey was wonderful. They flew over the clouds and crossed the ocean until they spotted Neverland. It was a magical island full of deep jungles, mermaid lagoons, and mysterious mountains. Upon landing, they were greeted by the Lost Boys, a group of brave little ones who lived in a secret underground home hidden beneath the roots of a giant tree. Wendy happily agreed to become the 'mother' to all of them, telling them stories every night." },
            { text: "But Neverland was also dangerous. The wicked Captain Hook and his pirate crew patrolled the coasts in the ship 'Jolly Roger'. Hook had hated Peter Pan ever since Peter cut off his hand in a battle and fed it to a crocodile. Since then, the crocodile had pursued Hook everywhere. Luckily, the crocodile had swallowed a watch, and its 'tick-tock' always warned of its presence, terrifying the evil captain." },
            { text: "One day, the pirates captured the Indian princess Tiger Lily and took her to Mermaid Lagoon. Peter Pan, demonstrating his great courage, faced Hook in a thrilling sword duel on the rocks. With cunning and agility, Peter managed to rescue Tiger Lily and return her to her tribe. The lagoon, with its crystal-clear waters and long-haired mermaids, witnessed the heroic feat of the boy who wouldn't grow up." },
            { text: "Meanwhile, Tinker Bell felt a little jealous of the attention Peter was paying to Wendy. In a moment of weakness, the little fairy was tricked by Captain Hook into revealing the secret hiding place of the Lost Boys. However, realizing her mistake, Tinker Bell flew desperately to warn Peter of the danger, risking her own light to save her friends from the pirate trap." },
            { text: "Taking advantage of Peter's absence, the pirates captured Wendy, her brothers, and all the Lost Boys. They led them in chains to the pirate ship, where Hook would force them to 'walk the plank' into the sea. Wendy tried to stay calm and encourage the other children, reminding them that Peter Pan would never abandon them and that there was always hope as long as one had a happy thought." },
            { text: "Peter Pan, upon hearing of his friends' capture, flew to the pirate ship in silence. He mimicked the 'tick-tock' of the crocodile to frighten the pirates and spread chaos on the deck. While the pirates trembled with fear thinking the crocodile was aboard, Peter discreetly freed the children. Suddenly, the big final battle began! The sound of steel and the shouts of adventure filled the starry night over the sea." },
            { text: "The duel between Peter Pan and Captain Hook was legendary. They leapt between the masts and sails of the Jolly Roger. 'Give up, Hook!', Peter shouted with a mischievous grin. Finally, the captain lost his balance and fell overboard, right where the huge crocodile was waiting with its mouth open. The pirates, terrified to see their leader fall, quickly fled the scene, leaving the ship in the hands of Peter and his friends." },
            { text: "With the Jolly Roger now covered in pixie dust, Peter used the ship to take Wendy, John, and Michael back to London. Wendy asked Peter to stay with them and grow up in a real family, but Peter shook his head. 'I want always to be a little boy and to have fun,' he replied. He promised, however, to return every year to hear Wendy's stories and remain her best friend." },
            { text: "The flying pirate ship landed softly in front of the Darlings' nursery window. Wendy's parents, who had been very sad, ran to hug their children with tears of joy. The Lost Boys were also adopted by the Darling family, finally finding the home they had always desired. That night, everyone slept under the warm roof of their house, dreaming of the wonders of Neverland." },
            { text: "From her window, Wendy watched the Jolly Roger fly away toward the second star to the right. Peter Pan and Tinker Bell waved from above before disappearing into the night sky. Although Wendy grew up and became a mother, she never forgot the pixie dust or the magic of childhood. She knew that as long as there were happy and innocent children, Peter Pan would keep flying free, protecting everyone's dreams." }
        ],
        contentFr: [
            { text: "Dans une maison chaleureuse de Londres, Wendy, John et Michael Darling dormaient paisiblement dans leur chambre. Ce qu'ils ne savaient pas, c'est que cette nuit-là, ils recevraient une visite extraordinaire. Peter Pan, le garçon qui ne grandit jamais, était entré par la fenêtre en volant, à la recherche de quelque chose de très important. Il était accompagné de Clochette, une petite fée brillante qui voletait dans toute la pièce en laissant derrière elle une traînée de poussière magique." },
            { text: "Peter cherchait son ombre, qu'il avait perdue lors d'une précédente visite. Wendy se réveilla et, avec beaucoup d'adresse, recousit l'ombre de Peter à ses pieds. Reconnaissant, Peter invita les frères et sœurs Darling à voyager avec lui au Pays Imaginaire. 'Il suffit d'y croire et d'un peu de poussière de fée !', s'exclama Peter. Soudain, les trois enfants s'élevèrent dans les airs et s'envolèrent par la fenêtre vers la deuxième étoile à droite." },
            { text: "Le voyage fut merveilleux. Ils volèrent au-dessus des nuages et traversèrent l'océan jusqu'à apercevoir le Pays Imaginaire. C'était une île magique pleine de jungles profondes, de lagunes de sirènes et de montagnes mystérieuses. À l'atterrissage, ils furent accueillis par les Enfants Perdus, un groupe de courageux petits qui vivaient dans une maison souterraine cachée sous les racines d'un arbre géant. Wendy accepta avec joie de devenir la 'mère' de tous, leur racontant des histoires chaque soir." },
            { text: "Mais le Pays Imaginaire était aussi dangereux. Le maléfique Capitaine Crochet et son équipage de pirates patrouillaient les côtes sur le navire 'Jolly Roger'. Crochet détestait Peter Pan depuis que celui-ci lui avait coupé la main lors d'une bataille et l'avait donnée à manger à un crocodile. Depuis lors, le crocodile poursuivait Crochet partout. Heureusement, le crocodile avait avalé un réveil et son 'tic-tac' signalait toujours sa présence, terrifiant le malfaisant capitaine." },
            { text: "Un jour, les pirates capturèrent la princesse indienne Lily la Tigresse et l'emmenèrent à la Lagune des Sirènes. Peter Pan, faisant preuve d'un grand courage, affronta Crochet dans un duel à l'épée passionnant sur les rochers. Avec ruse et agilité, Peter réussit à sauver Lily la Tigresse et à la ramener dans sa tribu. La Lagune, avec ses eaux cristallines et ses sirènes aux longs cheveux, fut le témoin de l'exploit héroïque du garçon qui ne voulait pas grandir." },
            { text: "Pendant ce temps, Clochette se sentait un peu jalouse de l'attention que Peter portait à Wendy. Dans un moment de faiblesse, la petite fée fut trompée par le Capitaine Crochet pour révéler la cachette secrète des Enfants Perdus. Cependant, se rendant compte de son erreur, Clochette vola désespérément pour avertir Peter du danger, risquant sa propre lumière pour sauver ses amis du piège des pirates." },
            { text: "Profitant de l'absence de Peter, les pirates capturèrent Wendy, ses frères et tous les Enfants Perdus. Ils les emmenèrent enchaînés sur le navire pirate, où Crochet allait les forcer à 'passer sur la planche' vers la mer. Wendy essaya de rester calme et d'encourager les autres enfants, leur rappelant que Peter Pan ne les abandonnerait jamais et qu'il y avait toujours de l'espoir tant qu'on avait une pensée joyeuse." },
            { text: "Peter Pan, en apprenant la capture de ses amis, s'envola vers le navire pirate en silence. Il imita le 'tic-tac' du crocodile pour effrayer les pirates et semer le chaos sur le pont. Alors que les pirates tremblaient de peur en pensant que le crocodile était à bord, Peter libéra discrètement les enfants. Soudain, la grande bataille finale commença ! Le son de l'acier et les cris d'aventure remplirent la nuit étoilée sur la mer." },
            { text: "Le duel entre Peter Pan et le Capitaine Crochet fut légendaire. Ils sautèrent entre les mâts et les voiles du Jolly Roger. 'Rends-toi, Crochet !', criait Peter avec un sourire malicieux. Finalement, le capitaine perdit l'équilibre et tomba par-dessus bord, juste là où l'énorme crocodile l'attendait la gueule ouverte. Les pirates, terrifiés de voir tomber leur chef, s'enfuirent rapidement du lieu, laissant le navire aux mains de Peter et de ses amis." },
            { text: "Avec le Jolly Roger désormais couvert de poussière de fée, Peter utilisa le navire pour ramener Wendy, John et Michael à Londres. Wendy demanda à Peter de rester avec eux et de grandir dans une vraie famille, mais Peter secoua la tête. 'Je veux rester un petit garçon et m'amuser', répondit-il. Il promit cependant de revenir chaque année pour écouter les histoires de Wendy et rester son meilleur ami." },
            { text: "Le navire pirate volant atterrit doucement devant la fenêtre de la chambre des Darling. Les parents de Wendy, qui avaient été très tristes, coururent embrasser leurs enfants avec des larmes de joie. Les Enfants Perdus furent également adoptés par la famille Darling, trouvant enfin le foyer qu'ils avaient toujours désiré. Cette nuit-là, tous dormirent sous le toit chaleureux de leur maison, rêvant des merveilles du Pays Imaginaire." },
            { text: "De sa fenêtre, Wendy vit le Jolly Roger s'éloigner en volant vers la deuxième étoile à droite. Peter Pan et Clochette saluaient d'en haut avant de disparaître dans le ciel nocturne. Bien que Wendy ait grandi et soit devenue mère, elle n'oublia jamais la poussière de fée ni la magie de l'enfance. Elle savait que tant qu'il y aurait des enfants joyeux et innocents, Peter Pan continuer bat de voler librement, protégeant les rêves de tous." }
        ],
        contentDe: [
            { text: "In einem gemütlichen Haus in London schliefen Wendy, John und Michael Darling friedlich in ihrem Kinderzimmer. Was sie nicht wussten, war, dass sie in dieser Nacht einen außergewöhnlichen Besucher erhalten würden. Peter Pan, der Junge, der niemals erwachsen wird, war durch das Fenster hereingeflogen und suchte nach etwas sehr Wichtigem. Er wurde von Tinker Bell begleitet, einer winzigen, leuchtenden Fee, die durch den ganzen Raum flatterte und eine Spur aus Zauberstaub hinterließ." },
            { text: "Peter suchte seinen Schatten, den er bei einem früheren Besuch verloren hatte. Wendy wachte auf und nähte mit viel Geschick Peters Schatten an seine Füße fest. Dankbar lud Peter die Darling-Geschwister ein, mit ihm ins Nimmerland zu reisen. 'Ihr müsst nur an glückliche Dinge denken und ein wenig Zauberstaub haben!', rief Peter aus. Plötzlich erhoben sich die drei Kinder in die Luft und flogen aus dem Fenster in Richtung des zweiten Sterns rechts." },
            { text: "Die Reise war wunderbar. Sie flogen über die Wolken und überquerten den Ozean, bis sie das Nimmerland erblickten. Es war eine magische Insel voller tiefer Dschungel, Meerjungfrauen-Lagunen und geheimnisvoller Berge. Bei der Landung wurden sie von den Verlorenen Jungs begrüßt, einer Gruppe tapferer Kleiner, die in einem geheimen unterirdischen Heim lebten, das unter den Wurzeln eines riesigen Baumes verborgen war. Wendy stimmte freudig zu, die 'Mutter' für sie alle zu werden und ihnen jede Nacht Geschichten zu erzählen." },
            { text: "Aber das Nimmerland war auch gefährlich. Der böse Captain Hook und seine Piratencrew patrouillierten auf dem Schiff 'Jolly Roger' an den Küsten. Hook hasste Peter Pan, seit dieser ihm in einem Kampf die Hand abgeschnitten und sie einem Krokodil zum Fraß vorgeworfen hatte. Seitdem verfolgte das Krokodil Hook überallhin. Glücklicherweise hatte das Krokodil eine Uhr verschluckt, und sein 'Tick-Tack' warnte immer vor seiner Anwesenheit, was den bösen Kapitän in Angst und Schrecken versetzte." },
            { text: "Eines Tages nahmen die Piraten die Indianerprinzessin Tiger Lily gefangen und brachten sie zur Meerjungfrauen-Lagune. Peter Pan bewies seinen großen Mut und stellte sich Hook in einem spannenden Degenduell auf den Felsen. Mit List und Geschick gelang es Peter, Tiger Lily zu retten und sie zu ihrem Stamm zurückzubringen. Die Lagune mit ihrem kristallklaren Wasser und den langhaarigen Meerjungfrauen wurde Zeuge der heroischen Tat des Jungen, der nicht erwachsen werden wollte." },
            { text: "In der Zwischenzeit war Tinker Bell ein wenig eifersüchtig auf die Aufmerksamkeit, die Peter Wendy schenkte. In einem Moment der Schwäche wurde die kleine Fee von Captain Hook getäuscht, das geheime Versteck der Verlorenen Jungs zu verraten. Doch als sie ihren Fehler bemerkte, flog Tinker Bell verzweifelt los, um Peter vor der Gefahr zu warnen, und riskierte ihr eigenes Licht, um ihre Freunde aus der Piratenfalle zu retten." },
            { text: "Captain Hook nutzte Peters Abwesenheit aus und nahm Wendy, ihre Brüder und alle Verlorenen Jungs gefangen. Sie wurden in Ketten auf das Piratenschiff gebracht, wo Hook sie zwingen wollte, 'über die Planke' ins Meer zu gehen. Wendy versuchte, ruhig zu bleiben und den anderen Kindern Mut zuzusprechen, indem sie sie daran erinnerte, dass Peter Pan sie niemals im Stich lassen würde und dass es immer Hoffnung gäbe, solange man einen glücklichen Gedanken habe." },
            { text: "Als Peter Pan von der Gefangennahme seiner Freunde erfuhr, flog er lautlos zum Piratenschiff. Er ahmte das 'Tick-Tack' des Krokodils nach, um die Piraten zu erschrecken und Chaos an Deck zu verbreiten. Während die Piraten vor Angst zitterten, weil sie glaubten, das Krokodil sei an Bord, befreite Peter heimlich die Kinder. Plötzlich begann die große Entscheidungsschlacht! Das Geräusch von Stahl und die Abenteuerschreie erfüllten die sternenklare Nacht über dem Meer." },
            { text: "Das Duell zwischen Peter Pan und Captain Hook war legendär. Sie sprangen zwischen den Masten und Segeln der Jolly Roger hin und her. 'Gib auf, Hook!', rief Peter mit einem schelmischen Grinsen. Schließlich verlor der Kapitän das Gleichgewicht und fiel über Bord, genau dorthin, wo das riesige Krokodil mit offenem Maul wartete. Die Piraten, die entsetzt sahen, wie ihr Anführer fiel, flüchteten schnell vom Ort des Geschehens und überließen das Schiff Peter und seinen Freunden." },
    ...
    },
    {
        ...
        titleFr: 'Sindbad le Marin',
        titleDe: 'Sindbad der Seefahrer',
        author: 'Las Mil y Una Noches',
        description: 'Simbad, un valiente marino de Bagdad, emprende viajes fantásticos llenos de naufragios, monstruos gigantes y tesoros inimaginables.',
        descriptionEn: 'Sinbad, a brave sailor from Baghdad, embarks on fantastic voyages full of shipwrecks, giant monsters, and unimaginable treasures.',
        descriptionFr: 'Sindbad, un brave marin de Bagdad, entreprend des voyages fantastiques remplis de naufrages, de monstres géants et de trésors inimaginables.',
        descriptionDe: 'Sindbad, ein tapferer Seefahrer aus Bagdad, unternimmt fantastische Reisen voller Schiffbrüche, riesiger Monster und unvorstellbarer Schätze.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/simbad-marino-cover.png',
        chipImage: '/images/storyteller/character-simbad-marino.png',
        genre: 'Aventura/Fantasía',
        themeColor: 'from-blue-600 to-indigo-900',
        rating: 4.8,
        content: [
            { text: "En la ciudad de Bagdad vivía un hombre llamado Simbad el Cargador, que era muy pobre. Un día, cansado de cargar fardos pesados bajo el sol, se detuvo a descansar frente a una mansión magnífica. El dueño de la casa, un anciano rico y amable, lo invitó a entrar. Se presentó como Simbad el Marino y le dijo: 'No creas que mi riqueza vino fácil. He sobrevivido a siete viajes llenos de peligros inimaginables. Escucha mi historia'." },
            { text: "En su primer viaje, Simbad zarpó con un grupo de mercaderes. Un día, decidieron desembarcar en lo que parecía ser una pequeña isla verde en medio del océano. Encendieron una fogata para cocinar, pero de repente, ¡la isla empezó a temblar! No era una isla, sino una ballena gigantesca que dormía en la superficie. Todos corrieron hacia el barco, pero Simbad no llegó a tiempo y la ballena se sumergió, dejándolo solo en el mar." },
            { text: "Simbad flotó agarrado a una tabla de madera hasta llegar a una isla desconocida. Allí vio algo extraño en el horizonte: una cúpula blanca, enorme y lisa, que brillaba al sol. Mientras se acercaba, el cielo se oscureció de repente. Al mirar arriba, vio un pájaro tan grande que tapaba el sol: era un Roc. El ave descendió y se posó sobre la cúpula, que resultó ser... ¡su huevo!" },
            { text: "Simbad tuvo una idea arriesgada. Se ató con su turbante a una de las garras del Roc. Cuando el ave levantó el vuelo al amanecer, llevó a Simbad por los aires hasta dejarlo caer en un valle profundo rodeado de montañas imposibles de escalar. El suelo del valle brillaba de forma extraña. Al mirar bien, Simbad se quedó sin aliento: ¡estaba cubierto de diamantes enormes!" },
            { text: "Pero el valle estaba habitado por serpientes gigantes que salían de noche. Aterrorizado, Simbad buscó una cueva para esconderse. Por la mañana, vio caer grandes trozos de carne desde las montañas. Eran los mercaderes de diamantes, que lanzaban la carne para que las joyas se pegaran a ella y luego las águilas se la llevaran a sus nidos. Simbad, rápido como el rayo, se ató un gran trozo de carne a la espalda y esperó." },
            { text: "Un águila bajó, agarró la carne (con Simbad pegado a ella) y lo llevó a su nido en la cima de la montaña. Allí, los mercaderes lo rescataron, asombrados por su valentía. Simbad les ofreció los diamantes que había recogido en el valle y, agradecidos, lo ayudaron a volver a casa. Así terminó su segundo viaje, regresando más rico que nunca, pero su espíritu aventurero no descansaría mucho tiempo." },
            { text: "En su tercer viaje, su barco fue atacado por piratas y naufragó en una isla habitada por un gigante de un solo ojo. El monstruo atrapó a la tripulación en una cueva. Pero Simbad, que nunca perdía la esperanza, ideó un plan. Mientras el gigante dormía, calentaron un hierro al rojo vivo y lo cegaron. A tientas, el gigante abrió la entrada de la cueva gritando de dolor, y Simbad y sus compañeros lograron escapar corriendo hacia la playa." },
            { text: "Construyeron una balsa improvisada y se echaron al mar justo cuando el gigante y sus compañeros lanzaban rocas enormes desde los acantilados. Solo Simbad y dos amigos sobrevivieron. Llegaron a otra isla donde una serpiente gigante se comió a sus compañeros, pero Simbad logró engañarla construyendo una jaula de madera alrededor de su cuerpo para dormir protegido. Finalmente, un barco que pasaba lo rescató." },
            { text: "A pesar de todo, Simbad emprendió más viajes. En uno de ellos, llegó a una ciudad donde los hombres se convertían en pájaros una vez al mes. En otro, fue vendido como esclavo a un rey que le pidió cazar elefantes por sus colmillos. Simbad descubrió el cementerio de los elefantes, un lugar secreto lleno de marfil, y se lo mostró al rey, quien a cambio le dio la libertad y riquezas inimaginables." },
            { text: "En su último viaje, Simbad naufragó de nuevo y fue arrastrado por una corriente subterránea en una balsa a través de una montaña oscura. Al salir al otro lado, encontró una ciudad llena de gente amable que le regaló tantas riquezas como pudo cargar. Allí comprendió que había tenido suficiente aventura para una vida y decidió regresar a Bagdad para siempre." },
            { text: "Simbad el Marino terminó su relato y le dio a Simbad el Cargador una bolsa llena de monedas de oro. 'Toma esto, amigo mío', le dijo. 'Ahora sabes que la fortuna favorece a los valientes, pero también a los que perseveran'. El Cargador agradeció al Marino y se fue a casa, inspirado por las historias, sabiendo que aunque su vida era dura, siempre había esperanza de encontrar su propio tesoro algún día." }
        ],
        contentEn: [
            { text: "In the city of Baghdad lived a man named Sinbad the Porter, who was very poor. One day, tired of carrying heavy burdens under the sun, he stopped to rest in front of a magnificent mansion. The owner of the house, a rich and kind old man, invited him in. He introduced himself as Sinbad the Sailor and said: 'Do not think my wealth came easily. I have survived seven voyages full of unimaginable dangers. Listen to my story'." },
            { text: "On his first voyage, Sinbad set sail with a group of merchants. One day, they decided to land on what looked like a small green island in the middle of the ocean. They lit a fire to cook, but suddenly, the island began to shake! It was not an island, but a gigantic whale sleeping on the surface. Everyone ran to the ship, but Sinbad did not make it in time and the whale dived, leaving him alone in the sea." },
            { text: "Sinbad floated holding onto a wooden plank until he reached an unknown island. There he saw something strange on the horizon: a huge, smooth white dome shining in the sun. As he approached, the sky suddenly darkened. Looking up, he saw a bird so large it blocked out the sun: it was a Roc. The bird descended and landed on the dome, which turned out to be... its egg!" },
            { text: "Sinbad had a risky idea. He tied himself with his turban to one of the Roc's claws. When the bird took flight at dawn, it carried Sinbad through the air until it dropped him in a deep valley surrounded by mountains impossible to climb. The valley floor shone strangely. Looking closely, Sinbad gasped: it was covered with enormous diamonds!" },
            { text: "But the valley was inhabited by giant snakes that came out at night. Terrified, Sinbad looked for a cave to hide. In the morning, he saw large pieces of meat falling from the mountains. It was diamond merchants, throwing the meat so the jewels would stick to it and then eagles would carry it to their nests. Sinbad, quick as lightning, tied a large piece of meat to his back and waited." },
            { text: "An eagle came down, grabbed the meat (with Sinbad attached to it) and carried him to its nest at the top of the mountain. There, the merchants rescued him, amazed by his bravery. Sinbad offered them the diamonds he had collected in the valley and, grateful, they helped him return home. Thus ended his second voyage, returning richer than ever, but his adventurous spirit would not rest for long." },
            { text: "On his third voyage, his ship was attacked by pirates and wrecked on an island inhabited by a one-eyed giant. The monster trapped the crew in a cave. But Sinbad, who never lost hope, devised a plan. While the giant slept, they heated an iron red-hot and blinded him. Groping, the giant opened the cave entrance screaming in pain, and Sinbad and his companions managed to escape running to the beach." },
            { text: "They built a makeshift raft and set out to sea just as the giant and his companions threw huge rocks from the cliffs. Only Sinbad and two friends survived. They arrived at another island where a giant snake ate his companions, but Sinbad managed to trick it by building a wooden cage around his body to sleep protected. Finally, a passing ship rescued him." },
            { text: " despite everything, Sinbad undertook more voyages. In one of them, he arrived at a city where men turned into birds once a month. In another, he was sold as a slave to a king who asked him to hunt elephants for their tusks. Sinbad discovered the elephants' graveyard, a secret place full of ivory, and showed it to the king, who in return gave him freedom and unimaginable riches." },
            { text: "In his last voyage, Sinbad was shipwrecked again and carried by an underground current on a raft through a dark mountain. Coming out the other side, he found a city full of kind people who gave him as many riches as he could carry. There he understood he had had enough adventure for one life and decided to return to Baghdad forever." },
            { text: "Sinbad the Sailor finished his tale and gave Sinbad the Porter a bag full of gold coins. 'Take this, my friend', he said. 'Now you know that fortune favors the brave, but also those who persevere'. The Porter thanked the Sailor and went home, inspired by the stories, knowing that although his life was hard, there was always hope of finding his own treasure someday." }
        ],
        contentFr: [
            { text: "Dans la ville de Bagdad vivait un homme nommé Sindbad le Portefaix, qui était très pauvre. Un jour, fatigué de porter de lourds fardeaux sous le soleil, il s'arrêta pour se reposer devant un magnifique manoir. Le propriétaire de la maison, un vieil homme riche et aimable, l'invita à entrer. Il se présenta comme Sindbad le Marin et dit : 'Ne crois pas que ma richesse est venue facilement. J'ai survécu à sept voyages pleins de dangers inimaginables. Écoute mon histoire'." },
            { text: "Lors de son premier voyage, Sindbad prit la mer avec un groupe de marchands. Un jour, ils décidèrent de débarquer sur ce qui ressemblait à une petite île verte au milieu de l'océan. Ils allumèrent un feu pour cuisiner, mais soudain, l'île commença à trembler ! Ce n'était pas une île, mais une baleine gigantesque qui dormait à la surface. Tout le monde courut vers le navire, mais Sindbad n'arriva pas à temps et la baleine plongea, le laissant seul dans la mer." },
            { text: "Sindbad flotta accroché à une planche de bois jusqu'à atteindre une île inconnue. Là, il vit quelque chose d'étrange à l'horizon : un immense dôme blanc et lisse qui brillait au soleil. En s'approchant, le ciel s'assombrit soudainement. En regardant en haut, il vit un oiseau si grand qu'il cachait le soleil : c'était un Roc. L'oiseau descendit et se posa sur le dôme, qui s'avéra être... son œuf !" },
            { text: "Sindbad eut une idée risquée. Il s'attacha avec son turban à l'une des griffes du Roc. Quand l'oiseau prit son envol à l'aube, il emporta Sindbad dans les airs jusqu'à le laisser tomber dans une vallée profonde entourée de montagnes impossibles à escalader. Le sol de la vallée brillait étrangement. En regardant bien, Sindbad eut le souffle coupé : elle était couverte d'énormes diamants !" },
            { text: "Mais la vallée était habitée par des serpents géants qui sortaient la nuit. Terrifié, Sindbad chercha une grotte pour se cacher. Au matin, il vit tomber de gros morceaux de viande depuis les montagnes. C'étaient des marchands de diamants, qui lançaient la viande pour que les joyaux s'y collent et qu'ensuite les aigles l'emportent dans leurs nids. Sindbad, rapide comme l'éclair, s'attacha un gros morceau de viande sur le dos et attendit." },
            { text: "Un aigle descendit, attrapa la viande (avec Sindbad attaché dessus) et l'emporta dans son nid au sommet de la montagne. Là, les marchands le secoururent, étonnés par sa bravoure. Sindbad leur offrit les diamants qu'il avait ramassés dans la vallée et, reconnaissants, ils l'aidèrent à rentrer chez lui. Ainsi se termina son deuxième voyage, revenant plus riche que jamais, mais son esprit aventureux ne se reposerait pas longtemps." },
            { text: "Lors de son troisième voyage, son navire fut attaqué par des pirates et fit naufrage sur une île habitée par un géant à un seul œil. Le monstre piégea l'équipage dans une grotte. Mais Sindbad, qui ne perdait jamais espoir, conçut un plan. Pendant que le géant dormait, ils chauffèrent un fer au rouge et l'aveuglèrent. À tâtons, le géant ouvrit l'entrée de la grotte en hurlant de douleur, et Sindbad et ses compagnons réussirent à s'échapper en courant vers la plage." },
            { text: "Ils construisirent un radeau improvisé et prirent la mer juste au moment où le géant et ses compagnons lançaient d'énormes rochers depuis les falaises. Seuls Sindbad et deux amis survécurent. Ils arrivèrent sur une autre île où un serpent géant mangea ses compagnons, mais Sindbad réussit à le tromper en construisant une cage en bois autour de son corps pour dormir protégé. Finalement, un navire qui passait le secourut." },
            { text: "Malgré tout, Sindbad entreprit d'autres voyages. Dans l'un d'eux, il arriva dans une ville où les hommes se transformaient en oiseaux une fois par mois. Dans un autre, il fut vendu comme esclave à un roi qui lui demanda de chasser des éléphants pour leurs défenses. Sindbad découvrit le cimetière des éléphants, un lieu secret plein d'ivoire, et le montra au roi, qui en échange lui donna la liberté et des richesses inimaginables." },
            { text: "Lors de son dernier voyage, Sindbad fit de nouveau naufrage et fut emporté par un courant souterrain sur un radeau à travers une montagne sombre. En sortant de l'autre côté, il trouva une ville pleine de gens aimables qui lui offrirent autant de richesses qu'il pouvait en porter. Là, il comprit qu'il avait eu assez d'aventure pour une vie et décida de retourner à Bagdad pour toujours." },
            { text: "Sindbad le Marin termina son récit et donna à Sindbad le Portefaix une bourse pleine de pièces d'or. 'Prends ceci, mon ami', lui dit-il. 'Maintenant tu sais que la fortune favorise les braves, mais aussi ceux qui persévèrent'. Le Portefaix remercia le Marin et rentra chez lui, inspiré par les histoires, sachant que même si sa vie était dure, il y avait toujours de l'espoir de trouver son propre trésor un jour." }
        ],
        contentDe: [
            { text: "In der Stadt Bagdad lebte ein Mann namens Sindbad der Lastträger, der sehr arm war. Eines Tages, müde vom Tragen schwerer Lasten unter der Sonne, hielt er an, um sich vor einem prächtigen Herrenhaus auszuruhen. Der Besitzer des Hauses, ein reicher und freundlicher alter Mann, lud ihn ein einzutreten. Er stellte sich als Sindbad der Seefahrer vor und sagte: 'Glaube nicht, dass mein Reichtum leicht kam. Ich habe sieben Reisen voller unvorstellbarer Gefahren überlebt. Hör dir meine Geschichte an'." },
            { text: "Auf seiner ersten Reise setzte Sindbad mit einer Gruppe von Kaufleuten die Segel. Eines Tages beschlossen sie, auf dem zu landen, was wie eine kleine grüne Insel mitten im Ozean aussah. Sie zündeten ein Feuer an, um zu kochen, aber plötzlich begann die Insel zu beben! Es war keine Insel, sondern ein gigantischer Wal, der an der Oberfläche schlief. Alle rannten zum Schiff, aber Sindbad schaffte es nicht rechtzeitig und der Wal tauchte ab und ließ ihn allein im Meer zurück." },
            { text: "Sindbad trieb auf einer Holzplanke, bis er eine unbekannte Insel erreichte. Dort sah er etwas Seltsames am Horizont: eine riesige, glatte weiße Kuppel, die in der Sonne glänzte. Als er sich näherte, verdunkelte sich plötzlich der Himmel. Als er nach oben schaute, sah er einen Vogel, der so groß war, dass er die Sonne verdeckte: es war ein Roch. Der Vogel stieg herab und landete auf der Kuppel, die sich als... sein Ei herausstellte!" },
            { text: "Sindbad hatte eine gewagte Idee. Er band sich mit seinem Turban an eine der Krallen des Rochs. Als der Vogel im Morgengrauen abhob, trug er Sindbad durch die Lüfte, bis er ihn in ein tiefes Tal fallen ließ, das von Bergen umgeben war, die unmöglich zu erklimmen waren. Der Boden des Tals glänzte seltsam. Bei genauem Hinsehen stockte Sindbad der Atem: Es war mit riesigen Diamanten bedeckt!" },
            { text: "Aber das Tal wurde von Riesenschlangen bewohnt, die nachts herauskamen. Verängstigt suchte Sindbad eine Höhle, um sich zu verstecken. Am Morgen sah er große Fleischstücke von den Bergen fallen. Es waren Diamantenhändler, die das Fleisch warfen, damit die Juwelen daran kleben blieben und dann Adler es zu ihren Nestern trugen. Sindbad, schnell wie der Blitz, band sich ein großes Stück Fleisch auf den Rücken und wartete." },
            { text: "Ein Adler kam herunter, griff das Fleisch (mit Sindbad daran befestigt) und trug ihn zu seinem Nest auf der Spitze des Berges. Dort retteten ihn die Händler, erstaunt über seine Tapferkeit. Sindbad bot ihnen die Diamanten an, die er im Tal gesammelt hatte, und dankbar halfen sie ihm, nach Hause zurückzukehren. So endete seine zweite Reise, er kehrte reicher denn je zurück, aber sein Abenteurergeist würde nicht lange ruhen." },
            { text: "Auf seiner dritten Reise wurde sein Schiff von Piraten angegriffen und erlitt Schiffbruch auf einer Insel, die von einem einäugigen Riesen bewohnt wurde. Das Monster sperrte die Besatzung in eine Höhle. Aber Sindbad, der nie die Hoffnung verlor, schmiedete einen Plan. Während der Riese schlief, erhitzten sie ein Eisen rotglühend und blendeten ihn. Tastend öffnete der Riese den Höhleneingang und schrie vor Schmerz, und Sindbad und seinen Gefährten gelang es, zum Strand zu fliehen." },
            { text: "Sie bauten ein provisorisches Floß und stachen in See, gerade als der Riese und seine Gefährten riesige Felsen von den Klippen warfen. Nur Sindbad und zwei Freunde überlebten. Sie kamen auf einer anderen Insel an, wo eine Riesenschlange seine Gefährten fraß, aber Sindbad gelang es, sie zu überlisten, indem er einen Holzkäfig um seinen Körper baute, um geschützt zu schlafen. Schließlich rettete ihn ein vorbeifahrendes Schiff." },
            { text: "Trotz allem unternahm Sindbad weitere Reisen. Auf einer von ihnen kam er in eine Stadt, in der sich die Männer einmal im Monat in Vögel verwandelten. Auf einer anderen wurde er als Sklave an einen König verkauft, der ihn bat, Elefanten wegen ihrer Stoßzähne zu jagen. Sindbad entdeckte den Friedhof der Elefanten, einen geheimen Ort voller Elfenbein, und zeigte ihn dem König, der ihm im Gegenzug die Freiheit und unvorstellbare Reichtümer gab." },
            { text: "Auf seiner letzten Reise erlitt Sindbad erneut Schiffbruch und wurde von einer unterirdischen Strömung auf einem Floß durch einen dunklen Berg getrieben. Als er auf der anderen Seite herauskam, fand er eine Stadt voller freundlicher Menschen, die ihm so viele Reichtümer schenkten, wie er tragen konnte. Dort begriff er, dass er genug Abenteuer für ein Leben gehabt hatte und beschloss, für immer nach Bagdad zurückzukehren." },
            { text: "Sindbad der Seefahrer beendete seine Erzählung und gab Sindbad dem Lastträger einen Beutel voller Goldmünzen. 'Nimm das, mein Freund', sagte er. 'Jetzt weißt du, dass das Glück den Tapferen begünstigt, aber auch denen, die durchhalten'. Der Lastträger dankte dem Seefahrer und ging nach Hause, inspiriert von den Geschichten, wissend, dass es, obwohl sein Leben hart war, immer Hoffnung gab, eines Tages seinen eigenen Schatz zu finden." }
        ]
    },
    {
        id: 'robin-hood',
        title: 'Robin Hood',
        titleEn: 'Robin Hood',
        titleFr: 'Robin des Bois',
        titleDe: 'Robin Hood',
        author: 'Leyenda Popular',
        description: 'Las aventuras del legendario arquero que robaba a los ricos para dárselo a los pobres en el bosque de Sherwood.',
        descriptionEn: 'The adventures of the legendary archer who robbed the rich to give to the poor in Sherwood Forest.',
        descriptionFr: 'Les aventures de l\'archer légendaire qui volait aux riches pour donner aux pauvres dans la forêt de Sherwood.',
        descriptionDe: 'Die Abenteuer des legendären Bogenschützen, der die Reichen bestahl, um es den Armen im Sherwood Forest zu geben.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/robin-hood-cover.png',
        chipImage: '/images/storyteller/character-robin-hood.png',
        genre: 'Aventura/Leyenda',
        themeColor: 'from-green-600 to-emerald-900',
        rating: 4.9,
        content: [
            { text: "En los tiempos antiguos, cuando el rey Ricardo Corazón de León estaba lejos luchando en las Cruzadas, Inglaterra era gobernada por su malvado hermano, el Príncipe Juan. El pueblo sufría bajo impuestos injustos y leyes crueles. Pero en el profundo bosque de Sherwood, un hombre se levantó contra la tiranía: Robin Hood, el mejor arquero que jamás hubiera existido." },
            { text: "Robin no estaba solo. Se había refugiado en el bosque con un grupo de hombres leales y valientes conocidos como sus 'Alegres Compañeros'. Allí estaba el Pequeño Juan, un gigante de gran corazón que manejaba el bastón como nadie; Fray Tuck, un monje jovial que amaba la buena comida tanto como la justicia; y Will Scarlet, el más rápido con la espada." },
            { text: "Su mayor enemigo era el Sheriff de Nottingham, un hombre codicioso que cumplía las órdenes del Príncipe Juan y robaba hasta la última moneda de los campesinos. Robin Hood y sus hombres idearon un plan: asaltarían los carruajes de los nobles y ricos que cruzaban el bosque, tomarían su oro y lo devolverían a las familias pobres a las que se lo habían arrebatado." },
            { text: "Un día, Robin se enteró de una competencia de tiro con arco organizada por el Sheriff. El premio era una flecha de oro macizo. 'Es una trampa', advirtió el Pequeño Juan. 'El Sheriff sabe que no podrás resistirte a probar que eres el mejor'. Robin sonrió. 'Tienes razón, amigo mío. Es una trampa, pero vamos a ir de todos modos'." },
            { text: "El día del torneo, Nottingham estaba lleno de gente. El Sheriff observaba con atención, buscando a Robin Hood entre la multitud, pero no lo veía por ninguna parte. Solo había un viejo mendigo con una capa raída que cojeaba hacia la línea de tiro. Los mejores arqueros del reino dispararon, pero ninguno pudo superar al misterioso mendigo, cuyas flechas daban siempre en el centro exacto de la diana." },
            { text: "El Sheriff, furioso por no encontrar a Robin pero obligado a entregar el premio, le dio la flecha de oro al mendigo. Cuando el anciano se alejó, se quitó la capa y reveló su traje verde. ¡Era Robin Hood! Antes de que los guardias pudieran reaccionar, Robin disparó una flecha que clavó el sombrero del Sheriff en su propia silla y escapó riendo hacia el bosque." },
            { text: "La fama de Robin creció y con ella la esperanza del pueblo. Una tarde, mientras cruzaba un río sobre un tronco caído, se encontró con un hombre alto y fuerte que le bloqueaba el paso. '¡Abre paso!', gritó Robin. '¡Ábrelo tú!', respondió el extraño. Lucharon con bastones en medio del río hasta que Robin cayó al agua. En lugar de enfadarse, Robin se rió y admiró la fuerza del extraño, que resultó ser el Pequeño Juan, quien desde ese día se convirtió en su segundo al mando." },
            { text: "El amor también llegó al bosque. Lady Marian, una noble de buen corazón que conocía a Robin desde la infancia, lo ayudaba en secreto informándole de los planes del Príncipe Juan. Aunque vivía en el castillo, su corazón pertenecía al bosque y al valiente proscrito que luchaba por la justicia. Finalmente, Marian escapó del castillo y se unió a Robin y sus hombres en Sherwood." },
            { text: "El Príncipe Juan, harto de las burlas de Robin, envió un ejército entero al bosque. Pero Sherwood era el hogar de los Alegres Compañeros; conocían cada árbol y cada cueva. Prepararon trampas, se escondieron en las ramas y confundieron a los soldados hasta hacerlos huir. El bosque protegía a quienes lo respetaban." },
            { text: "Finalmente, el rey Ricardo regresó de las Cruzadas. Disfrazado de monje, fue al bosque para ver con sus propios ojos si las historias sobre Robin eran ciertas. Al ver la bondad y lealtad de Robin hacia el verdadero rey y hacia el pueblo, Ricardo se reveló. '¡He vuelto!', proclamó. Robin y sus hombres se arrodillaron. El Rey perdonó a Robin y a sus compañeros, devolviéndoles sus tierras y su honor. Y así, la justicia volvió a Inglaterra gracias al arquero de Sherwood." }
        ],
        contentEn: [
            { text: "In ancient times, when King Richard the Lionheart was away fighting in the Crusades, England was ruled by his evil brother, Prince John. The people suffered under unjust taxes and cruel laws. But deep in Sherwood Forest, a man rose against tyranny: Robin Hood, the finest archer who ever lived." },
            { text: "Robin was not alone. He had taken refuge in the forest with a group of loyal and brave men known as his 'Merry Men'. There was Little John, a giant with a big heart who handled the staff like no one else; Friar Tuck, a jovial monk who loved good food as much as justice; and Will Scarlet, the fastest with a sword." },
            { text: "His greatest enemy was the Sheriff of Nottingham, a greedy man who carried out Prince John's orders and stole every last coin from the peasants. Robin Hood and his men devised a plan: they would raid the carriages of the rich nobles crossing the forest, take their gold, and return it to the poor families from whom it had been taken." },
            { text: "One day, Robin heard of an archery contest organized by the Sheriff. The prize was a solid gold arrow. 'It's a trap', warned Little John. 'The Sheriff knows you won't be able to resist proving you're the best'. Robin smiled. 'You are right, my friend. It is a trap, but we are going anyway'." },
            { text: "On the day of the tournament, Nottingham was crowded. The Sheriff watched closely, looking for Robin Hood in the crowd, but saw him nowhere. There was only an old beggar in a tattered cloak limping towards the shooting line. The kingdom's best archers shot, but none could beat the mysterious beggar, whose arrows always hit the exact center of the target." },
            { text: "The Sheriff, furious at not finding Robin but forced to award the prize, gave the golden arrow to the beggar. As the old man walked away, he threw off his cloak revealing his green suit. It was Robin Hood! Before the guards could react, Robin shot an arrow that pinned the Sheriff's hat to his own chair and escaped laughing into the forest." },
            { text: "Robin's fame grew and with it the people's hope. One afternoon, while crossing a river on a fallen log, he met a tall, strong man blocking his way. 'Make way!', shouted Robin. 'You make way!', replied the stranger. They fought with staffs in the middle of the river until Robin fell into the water. Instead of getting angry, Robin laughed and admired the stranger's strength, who turned out to be Little John, becoming his second-in-command from that day on." },
            { text: "Love also came to the forest. Maid Marian, a kind-hearted noblewoman who had known Robin since childhood, helped him in secret by informing him of Prince John's plans. Although she lived in the castle, her heart belonged to the forest and the brave outlaw fighting for justice. Eventually, Marian escaped the castle and joined Robin and his men in Sherwood." },
            { text: "Prince John, tired of Robin's mockery, sent an entire army into the forest. But Sherwood was the home of the Merry Men; they knew every tree and every cave. They set traps, hid in the branches, and confused the soldiers until they fled. The forest protected those who respected it." },
            { text: "Finally, King Richard returned from the Crusades. Disguised as a monk, he went into the forest to see with his own eyes if the stories about Robin were true. Seeing Robin's kindness and loyalty to the true king and the people, Richard revealed himself. 'I have returned!', he proclaimed. Robin and his men knelt. The King pardoned Robin and his companions, restoring their lands and honor. And so, justice returned to England thanks to the archer of Sherwood." }
        ],
        contentFr: [
            { text: "Dans les temps anciens, lorsque le roi Richard Cœur de Lion était loin à combattre lors des Croisades, l'Angleterre était gouvernée par son mauvais frère, le Prince Jean. Le peuple souffrait sous des impôts injustes et des lois cruelles. Mais au plus profond de la forêt de Sherwood, un homme se leva contre la tyrannie : Robin des Bois, le meilleur archer ayant jamais existé." },
            { text: "Robin n'était pas seul. Il s'était réfugié dans la forêt avec un groupe d'hommes loyaux et courageux connus sous le nom de ses 'Joyeux Compagnons'. Il y avait Petit Jean, un géant au grand cœur qui maniait le bâton comme personne ; Frère Tuck, un moine jovial qui aimait la bonne chère autant que la justice ; et Will Écarlate, le plus rapide à l'épée." },
            { text: "Son plus grand ennemi était le Shérif de Nottingham, un homme avide qui exécutait les ordres du Prince Jean et volait jusqu'au dernier sou des paysans. Robin des Bois et ses hommes conçurent un plan : ils attaqueraient les carrosses des riches nobles traversant la forêt, prendraient leur or et le rendraient aux familles pauvres à qui il avait été pris." },
            { text: "Un jour, Robin entendit parler d'un concours de tir à l'arc organisé par le Shérif. Le prix était une flèche en or massif. 'C'est un piège', avertit Petit Jean. 'Le Shérif sait que tu ne pourras pas résister à prouver que tu es le meilleur'. Robin sourit. 'Tu as raison, mon ami. C'est un piège, mais nous irons quand même'." },
            { text: "Le jour du tournoi, Nottingham était bondée. Le Shérif observait attentivement, cherchant Robin des Bois dans la foule, mais ne le voyait nulle part. Il n'y avait qu'un vieux mendiant avec une cape élimée qui boitait vers la ligne de tir. Les meilleurs archers du royaume tirèrent, mais aucun ne put battre le mystérieux mendiant, dont les flèches atteignaient toujours le centre exact de la cible." },
            { text: "Le Shérif, furieux de ne pas trouver Robin mais obligé de remettre le prix, donna la flèche d'or au mendiant. Alors que le vieil homme s'éloignait, il jeta sa cape révélant son costume vert. C'était Robin des Bois ! Avant que les gardes ne puissent réagir, Robin tira une flèche qui cloua le chapeau du Shérif à sa propre chaise et s'échappa en riant dans la forêt." },
            { text: "La renommée de Robin grandit et avec elle l'espoir du peuple. Un après-midi, alors qu'il traversait une rivière sur un tronc tombé, il rencontra un homme grand et fort qui lui bloquait le passage. 'Fais place !', cria Robin. 'Fais place toi-même !', répondit l'inconnu. Ils se battirent avec des bâtons au milieu de la rivière jusqu'à ce que Robin tombe à l'eau. Au lieu de se mettre en colère, Robin rit et admira la force de l'inconnu, qui s'avéra être Petit Jean, devenant son second à partir de ce jour." },
            { text: "L'amour arriva aussi dans la forêt. Belle Marianne, une noble au grand cœur qui connaissait Robin depuis l'enfance, l'aidait en secret en l'informant des plans du Prince Jean. Bien qu'elle vivât au château, son cœur appartenait à la forêt et au brave hors-la-loi qui se battait pour la justice. Finalement, Marianne s'échappa du château et rejoignit Robin et ses hommes à Sherwood." },
            { text: "Le Prince Jean, fatigué des moqueries de Robin, envoya une armée entière dans la forêt. Mais Sherwood était la maison des Joyeux Compagnons ; ils connaissaient chaque arbre et chaque grotte. Ils posèrent des pièges, se cachèrent dans les branches et déroutèrent les soldats jusqu'à ce qu'ils s'enfuient. La forêt protégeait ceux qui la respectaient." },
            { text: "Finalement, le roi Richard revint des Croisades. Déguisé en moine, il alla dans la forêt pour voir de ses propres yeux si les histoires sur Robin étaient vraies. Voyant la bonté et la loyauté de Robin envers le vrai roi et le peuple, Richard se révéla. 'Je suis de retour !', proclama-t-il. Robin et ses hommes s'agenouillèrent. Le Roi pardonna à Robin et à ses compagnons, leur rendant leurs terres et leur honneur. Et ainsi, la justice revint en Angleterre grâce à l'archer de Sherwood." }
        ],
        contentDe: [
            { text: "In alten Zeiten, als König Richard Löwenherz fern in den Kreuzzügen kämpfte, wurde England von seinem bösen Bruder, Prinz John, regiert. Das Volk litt unter ungerechten Steuern und grausamen Gesetzen. Doch tief im Sherwood Forest erhob sich ein Mann gegen die Tyrannei: Robin Hood, der beste Bogenschütze, der je gelebt hat." },
            { text: "Robin war nicht allein. Er hatte Zuflucht im Wald gesucht mit einer Gruppe treuer und tapferer Männer, bekannt als seine 'Merry Men'. Da war Little John, ein Riese mit großem Herzen, der den Stab wie kein anderer führte; Bruder Tuck, ein fröhlicher Mönch, der gutes Essen genauso liebte wie Gerechtigkeit; und Will Scarlet, der Schnellste mit dem Schwert." },
            { text: "Sein größter Feind war der Sheriff von Nottingham, ein gieriger Mann, der Prinz Johns Befehle ausführte und den Bauern auch noch die letzte Münze stahl. Robin Hood und seine Männer schmiedeten einen Plan: Sie würden die Kutschen der reichen Adligen überfallen, die den Wald durchquerten, ihr Gold nehmen und es den armen Familien zurückgeben, denen es genommen worden war." },
            { text: "Eines Tages hörte Robin von einem Bogenschießwettbewerb, den der Sheriff organisierte. Der Preis war ein Pfeil aus massivem Gold. 'Es ist eine Falle', warnte Little John. 'Der Sheriff weiß, dass du nicht widerstehen kannst zu beweisen, dass du der Beste bist'. Robin lächelte. 'Du hast recht, mein Freund. Es ist eine Falle, aber wir gehen trotzdem hin'." },
            { text: "Am Tag des Turniers war Nottingham überfüllt. Der Sheriff beobachtete genau und suchte nach Robin Hood in der Menge, sah ihn aber nirgends. Nur ein alter Bettler in einem zerlumpten Umhang humpelte zur Schießlinie. Die besten Bogenschützen des Königreichs schossen, aber keiner konnte den geheimnisvollen Bettler schlagen, dessen Pfeile immer genau die Mitte der Zielscheibe trafen." },
            { text: "Der Sheriff, wütend, Robin nicht gefunden zu haben, aber gezwungen, den Preis zu verleihen, gab dem Bettler den goldenen Pfeil. Als der alte Mann wegging, warf er seinen Umhang ab und enthüllte seinen grünen Anzug. Es war Robin Hood! Bevor die Wachen reagieren konnten, schoss Robin einen Pfeil, der den Hut des Sheriffs an seinen eigenen Stuhl heftete, und entkam lachend in den Wald." },
            { text: "Robins Ruhm wuchs und mit ihm die Hoffnung des Volkes. Eines Nachmittags, als er einen Fluss auf einem umgestürzten Baumstamm überquerte, traf er einen großen, starken Mann, der ihm den Weg versperrte. 'Mach Platz!', rief Robin. 'Mach du Platz!', antwortete der Fremde. Sie kämpften mit Stäben mitten im Fluss, bis Robin ins Wasser fiel. Anstatt wütend zu werden, lachte Robin und bewunderte die Stärke des Fremden, der sich als Little John herausstellte und von diesem Tag an sein Stellvertreter wurde." },
            { text: "Die Liebe kam auch in den Wald. Maid Marian, eine gutherzige Adlige, die Robin seit ihrer Kindheit kannte, half ihm heimlich, indem sie ihn über Prinz Johns Pläne informierte. Obwohl sie im Schloss lebte, gehörte ihr Herz dem Wald und dem tapferen Geächteten, der für Gerechtigkeit kämpfte. Schließlich entkam Marian aus dem Schloss und schloss sich Robin und seinen Männern im Sherwood an." },
            { text: "Prinz John, müde von Robins Spott, schickte eine ganze Armee in den Wald. Aber Sherwood war das Zuhause der Merry Men; sie kannten jeden Baum und jede Höhle. Sie stellten Fallen, versteckten sich in den Ästen und verwirrten die Soldaten, bis sie flohen. Der Wald beschützte diejenigen, die ihn respektierten." },
            { text: "Schließlich kehrte König Richard von den Kreuzzügen zurück. Als Mönch verkleidet ging er in den Wald, um mit eigenen Augen zu sehen, ob die Geschichten über Robin wahr waren. Als er Robins Güte und Loyalität gegenüber dem wahren König und dem Volk sah, gab sich Richard zu erkennen. 'Ich bin zurückgekehrt!', verkündete er. Robin und seine Männer knieten nieder. Der König begnadigte Robin und seine Gefährten und gab ihnen ihr Land und ihre Ehre zurück. Und so kehrte dank des Bogenschützen von Sherwood die Gerechtigkeit nach England zurück." }
        ]
    },
    {
        id: 'libro-selva',
        ...
        titleFr: 'Le Livre de la Jungle',
        titleDe: 'Das Dschungelbuch',
        author: 'Rudyard Kipling',
        description: 'La historia de Mowgli, el niño criado por lobos en la selva de la India, y sus aventuras con Baloo y Bagheera.',
        descriptionEn: 'The story of Mowgli, the boy raised by wolves in the Indian jungle, and his adventures with Baloo and Bagheera.',
        descriptionFr: 'L\'histoire de Mowgli, le garçon élevé par des loups dans la jungle indienne, et ses aventures avec Baloo et Bagheera.',
        descriptionDe: 'Die Geschichte von Mowgli, dem Jungen, der von Wölfen im indischen Dschungel aufgezogen wurde, und seine Abenteuer mit Baloo und Baghira.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/libro-selva-cover.png',
        chipImage: '/images/storyteller/character-mowgli.png',
        genre: 'Aventura/Fábula',
        themeColor: 'from-emerald-700 to-green-900',
        rating: 4.8,
        content: [
            { text: "En lo profundo de la selva de la India, una manada de lobos encontró algo inusual: un pequeño bebé humano abandonado y solo. Raksha, Madre Loba, se apiadó de él y decidió criarlo como uno de sus propios cachorros. Lo llamó Mowgli, que significa 'rana', porque no tenía pelo. El Consejo de la Roca aceptó al niño en la manada gracias a la intervención de Baloo, el oso sabio, y Bagheera, la pantera negra, quienes prometieron enseñarle la Ley de la Selva." },
            { text: "Mowgli creció feliz entre los lobos, aprendiendo a moverse en silencio y a entender el lenguaje de los animales. Baloo, su maestro estricto pero bondadoso, le enseñó las palabras maestras de cada especie: cómo pedir permiso a las abejas, cómo saludar a las serpientes y cómo respetar a todos los habitantes del bosque. Bagheera, por su parte, le enseñó a ser ágil y fuerte, protegiéndolo siempre desde las sombras con su mirada verde esmeralda." },
            { text: "Pero no todos en la selva eran amigos. Shere Khan, el temible tigre cojo que odiaba a los hombres, había jurado cazar a Mowgli desde el día en que lo perdió cuando era un bebé. 'El cachorro de hombre es mío', rugía Shere Khan. 'Tarde o temprano, vendrá a mis garras'. Akela, el líder de los lobos, protegió a Mowgli durante años, pero a medida que el líder envejecía, la influencia del tigre sobre los lobos más jóvenes crecía." },
            { text: "Un día, mientras Mowgli descansaba en una rama alta, fue secuestrado por los Bandar-log, el pueblo de los monos sin ley. Gritando y chillando, lo llevaron a través de las copas de los árboles hasta las Cold Lairs, una antigua ciudad humana en ruinas perdida en la selva. Baloo y Bagheera, desesperados, pidieron ayuda a la única criatura a la que los monos temían: Kaa, la enorme pitón de roca." },
            { text: "Kaa, Baloo y Bagheera llegaron a las ruinas al anochecer. Se desató una feroz batalla bajo la luz de la luna. Los monos eran cientos y atacaron sin piedad. Justo cuando Baloo y Bagheera estaban a punto de ser vencidos, Kaa comenzó su danza del hambre, hipnotizando a los monos con sus movimientos sinuosos. Aterrorizados, los Bandar-log se quedaron inmóviles, y Mowgli fue rescatado." },
            { text: "A medida que Mowgli se hacía mayor, la amenaza de Shere Khan se volvía más inminente. Bagheera le dijo a Mowgli que debía ir a la aldea de los hombres para conseguir la 'Flor Roja' (el fuego), lo único a lo que el tigre temía. Mowgli, aunque triste por tener que dejar su hogar, obedeció. Se coló en la aldea y robó una olla con brasas ardientes, sintiendo por primera vez el poder que los hombres tenían sobre la naturaleza." },
            { text: "Mowgli regresó a la Roca del Consejo justo cuando Shere Khan intentaba tomar el control de la manada y expulsar a Akela. El tigre exigió que le entregaran al niño. Pero Mowgli, de pie sobre la roca, lanzó la olla al suelo y las llamas brotaron. '¡Tú eres el que tiene miedo ahora, gato chamuscado!', gritó Mowgli, agitando una rama ardiendo. Shere Khan, aterrorizado por el fuego, huyó con el rabo entre las piernas, prometiendo volver." },
            { text: "Mowgli sabía que la selva ya no era segura para él ni para sus amigos mientras Shere Khan viviera. Ideó un plan astuto. Con la ayuda de sus hermanos lobos y una manada de búfalos, atraparon al tigre en un barranco estrecho. La estampida fue imparable, y el cruel reinado de Shere Khan llegó a su fin. Mowgli había cumplido su promesa y había librado a la selva de su tirano." },
            { text: "Con Shere Khan derrotado, Mowgli intentó regresar a la manada, pero se dio cuenta de que ya no era un lobo ni tampoco un hombre completo. Su corazón estaba dividido entre dos mundos. 'La selva es tuya, Hermanito', le dijo Bagheera suavemente, 'pero tu lugar está finalmente con tu propia gente'. Baloo, con lágrimas en los ojos, le dio un último abrazo de oso. 'Nunca olvides la Ley', le susurró." },
            { text: "Mowgli bajó hacia la aldea de los hombres, donde una mujer que había perdido a su hijo años atrás lo reconoció y lo acogió. Aunque aprendió a hablar como los hombres y a usar ropa, Mowgli a menudo se sentaba al borde del bosque al atardecer, escuchando los aullidos de sus hermanos lobos, sabiendo que, pasara lo que pasara, la selva siempre sería su verdadero hogar y Baloo y Bagheera sus verdaderos amigos." }
        ],
        contentEn: [
            { text: "Deep in the jungle of India, a wolf pack found something unusual: a small human baby abandoned and alone. Raksha, Mother Wolf, took pity on him and decided to raise him as one of her own cubs. She named him Mowgli, which means 'frog', because he had no fur. The Council of Rock accepted the boy into the pack thanks to the intervention of Baloo, the wise bear, and Bagheera, the black panther, who promised to teach him the Law of the Jungle." },
            { text: "Mowgli grew up happy among the wolves, learning to move silently and understand the language of animals. Baloo, his strict but kind teacher, taught him the master words of each species: how to ask permission from the bees, how to greet the snakes, and how to respect all forest dwellers. Bagheera, for his part, taught him to be agile and strong, always protecting him from the shadows with his emerald green gaze." },
            { text: "But not everyone in the jungle was a friend. Shere Khan, the fearsome lame tiger who hated men, had sworn to hunt Mowgli since the day he lost him as a baby. 'The man-cub is mine', roared Shere Khan. 'Sooner or later, he will come to my claws'. Akela, the leader of the wolves, protected Mowgli for years, but as the leader grew older, the tiger's influence over the younger wolves grew." },
            { text: "One day, while Mowgli was resting on a high branch, he was kidnapped by the Bandar-log, the lawless monkey people. Screaming and shrieking, they carried him through the treetops to the Cold Lairs, an ancient ruined human city lost in the jungle. Baloo and Bagheera, desperate, asked for help from the only creature the monkeys feared: Kaa, the huge rock python." },
            { text: "Kaa, Baloo, and Bagheera reached the ruins at dusk. A fierce battle broke out under the moonlight. The monkeys were hundreds and attacked without mercy. Just when Baloo and Bagheera were about to be defeated, Kaa began his hunger dance, hypnotizing the monkeys with his sinuous movements. Terrified, the Bandar-log stood motionless, and Mowgli was rescued." },
            { text: "As Mowgli grew older, the threat of Shere Khan became more imminent. Bagheera told Mowgli he must go to the man-village to get the 'Red Flower' (fire), the only thing the tiger feared. Mowgli, though sad to leave his home, obeyed. He sneaked into the village and stole a pot of burning coals, feeling for the first time the power men had over nature." },
            { text: "Mowgli returned to the Council Rock just as Shere Khan was trying to take control of the pack and oust Akela. The tiger demanded the boy be handed over. But Mowgli, standing on the rock, threw the pot to the ground and flames sprang up. 'You are the one who is afraid now, singed cat!', shouted Mowgli, waving a burning branch. Shere Khan, terrified of the fire, fled with his tail between his legs, promising to return." },
            { text: "Mowgli knew the jungle was no longer safe for him or his friends as long as Shere Khan lived. He devised a cunning plan. With the help of his wolf brothers and a herd of buffalo, they trapped the tiger in a narrow ravine. The stampede was unstoppable, and Shere Khan's cruel reign came to an end. Mowgli had kept his promise and rid the jungle of its tyrant." },
            { text: "With Shere Khan defeated, Mowgli tried to return to the pack, but realized he was no longer a wolf nor fully a man. His heart was divided between two worlds. 'The jungle is yours, Little Brother', Bagheera told him softly, 'but your place is finally with your own people'. Baloo, with tears in his eyes, gave him one last bear hug. 'Never forget the Law', he whispered." },
            { text: "Mowgli went down to the man-village, where a woman who had lost her son years ago recognized him and took him in. Although he learned to speak like men and wear clothes, Mowgli often sat at the edge of the forest at sunset, listening to the howls of his wolf brothers, knowing that, whatever happened, the jungle would always be his true home and Baloo and Bagheera his true friends." }
        ],
        contentFr: [
            { text: "Au plus profond de la jungle indienne, une meute de loups trouva quelque chose d'inhabituel : un petit bébé humain abandonné et seul. Raksha, Mère Louve, eut pitié de lui et décida de l'élever comme l'un de ses propres petits. Elle le nomma Mowgli, ce qui signifie 'grenouille', car il n'avait pas de fourrure. Le Conseil du Rocher accepta l'enfant dans la meute grâce à l'intervention de Baloo, l'ours sage, et de Bagheera, la panthère noire, qui promirent de lui enseigner la Loi de la Jungle." },
            { text: "Mowgli grandit heureux parmi les loups, apprenant à se déplacer en silence et à comprendre le langage des animaux. Baloo, son maître strict mais bienveillant, lui enseigna les mots maîtres de chaque espèce : comment demander la permission aux abeilles, comment saluer les serpents et comment respecter tous les habitants de la forêt. Bagheera, de son côté, lui apprit à être agile et fort, le protégeant toujours depuis l'ombre avec son regard vert émeraude." },
            { text: "Mais tout le monde dans la jungle n'était pas un ami. Shere Khan, le redoutable tigre boiteux qui haïssait les hommes, avait juré de chasser Mowgli depuis le jour où il l'avait perdu bébé. 'Le petit d'homme est à moi', rugissait Shere Khan. 'Tôt ou tard, il viendra dans mes griffes'. Akela, le chef des loups, protégea Mowgli pendant des années, mais à mesure que le chef vieillissait, l'influence du tigre sur les jeunes loups grandissait." },
            { text: "Un jour, alors que Mowgli se reposait sur une haute branche, il fut enlevé par les Bandar-log, le peuple des singes sans loi. Criant et hurlant, ils l'emmenèrent à travers la cime des arbres jusqu'aux Froides Tanières, une ancienne ville humaine en ruines perdue dans la jungle. Baloo et Bagheera, désespérés, demandèrent de l'aide à la seule créature que les singes craignaient : Kaa, l'énorme python de roche." },
            { text: "Kaa, Baloo et Bagheera atteignirent les ruines au crépuscule. Une bataille féroce éclata sous le clair de lune. Les singes étaient des centaines et attaquaient sans pitié. Juste au moment où Baloo et Bagheera étaient sur le point d'être vaincus, Kaa commença sa danse de la faim, hypnotisant les singes avec ses mouvements sinueux. Terrifiés, les Bandar-log restèrent immobiles et Mowgli fut sauvé." },
            { text: "À mesure que Mowgli grandissait, la menace de Shere Khan devenait plus imminente. Bagheera dit à Mowgli qu'il devait aller au village des hommes pour chercher la 'Fleur Rouge' (le feu), la seule chose que le tigre craignait. Mowgli, bien que triste de quitter sa maison, obéit. Il se faufila dans le village et vola un pot de braises ardentes, sentant pour la première fois le pouvoir que les hommes avaient sur la nature." },
            { text: "Mowgli retourna au Rocher du Conseil juste au moment où Shere Khan essayait de prendre le contrôle de la meute et de chasser Akela. Le tigre exigea qu'on lui livre le garçon. Mais Mowgli, debout sur le rocher, jeta le pot au sol et des flammes jaillirent. 'C'est toi qui as peur maintenant, chat roussi !', cria Mowgli en agitant une branche enflammée. Shere Khan, terrifié par le feu, s'enfuit la queue entre les jambes, promettant de revenir." },
            { text: "Mowgli savait que la jungle n'était plus sûre pour lui ni pour ses amis tant que Shere Khan vivait. Il conçut un plan astucieux. Avec l'aide de ses frères loups et d'un troupeau de buffles, ils piégèrent le tigre dans un ravin étroit. La charge fut imparable et le règne cruel de Shere Khan prit fin. Mowgli avait tenu sa promesse et débarrassé la jungle de son tyran." },
            { text: "Avec Shere Khan vaincu, Mowgli essaya de retourner à la meute, mais réalisa qu'il n'était plus un loup ni tout à fait un homme. Son cœur était partagé entre deux mondes. 'La jungle est à toi, Petit Frère', lui dit doucement Bagheera, 'mais ta place est finalement avec ton propre peuple'. Baloo, les larmes aux yeux, lui donna une dernière étreinte d'ours. 'N'oublie jamais la Loi', murmura-t-il." },
            { text: "Mowgli descendit vers le village des hommes, où une femme qui avait perdu son fils des années auparavant le reconnut et l'accueillit. Bien qu'il apprît à parler comme les hommes et à porter des vêtements, Mowgli s'asseyait souvent à l'orée de la forêt au coucher du soleil, écoutant les hurlements de ses frères loups, sachant que, quoi qu'il arrive, la jungle serait toujours sa vraie maison et Baloo et Bagheera ses vrais amis." }
        ],
        contentDe: [
            { text: "Tief im Dschungel Indiens fand ein Wolfsrudel etwas Ungewöhnliches: ein kleines menschliches Baby, verlassen und allein. Raksha, Mutter Wolf, hatte Mitleid mit ihm und beschloss, es als eines ihrer eigenen Jungen aufzuziehen. Sie nannte ihn Mogli, was 'Frosch' bedeutet, weil er kein Fell hatte. Der Rat vom Felsen nahm den Jungen dank der Fürsprache von Balu, dem weisen Bären, und Baghira, dem schwarzen Panther, die versprachen, ihn das Gesetz des Dschungels zu lehren, in das Rudel auf." },
            { text: "Mogli wuchs glücklich unter den Wölfen auf, lernte, sich lautlos zu bewegen und die Sprache der Tiere zu verstehen. Balu, sein strenger, aber gütiger Lehrer, lehrte ihn die Meisterworte jeder Art: wie man die Bienen um Erlaubnis bittet, wie man die Schlangen grüßt und wie man alle Waldbewohner respektiert. Baghira seinerseits brachte ihm bei, flink und stark zu sein, und beschützte ihn immer aus dem Schatten mit seinem smaragdgrünen Blick." },
            { text: "Aber nicht jeder im Dschungel war ein Freund. Shir Khan, der furchterregende lahme Tiger, der Menschen hasste, hatte geschworen, Mogli zu jagen, seit er ihn als Baby verloren hatte. 'Das Menschenjunge gehört mir', brüllte Shir Khan. 'Früher oder später wird er in meine Krallen kommen'. Akela, der Anführer der Wölfe, beschützte Mogli jahrelang, aber als der Anführer älter wurde, wuchs der Einfluss des Tigers auf die jüngeren Wölfe." },
            { text: "Eines Tages, als Mogli auf einem hohen Ast ruhte, wurde er von den Bandar-log, dem gesetzlosen Affenvolk, entführt. Kreischend und schreiend trugen sie ihn durch die Baumwipfel zu den Kalten Lagerstätten, einer alten, verfallenen Menschenstadt, die im Dschungel verloren war. Balu und Baghira baten verzweifelt um Hilfe bei der einzigen Kreatur, die die Affen fürchteten: Kaa, die riesige Felsenpython." },
            { text: "Kaa, Balu und Baghira erreichten die Ruinen in der Abenddämmerung. Ein heftiger Kampf brach unter dem Mondlicht aus. Die Affen waren Hunderte und griffen gnadenlos an. Gerade als Balu und Baghira besiegt zu werden drohten, begann Kaa seinen Hungertanz und hypnotisierte die Affen mit seinen schlängelnden Bewegungen. Verängstigt standen die Bandar-log regungslos da, und Mogli wurde gerettet." },
            { text: "Als Mogli älter wurde, wurde die Bedrohung durch Shir Khan unmittelbarer. Baghira sagte Mogli, er müsse ins Menschendorf gehen, um die 'Rote Blume' (das Feuer) zu holen, das Einzige, was der Tiger fürchtete. Mogli, obwohl traurig, sein Zuhause verlassen zu müssen, gehorchte. Er schlich sich ins Dorf und stahl einen Topf mit glühenden Kohlen, und spürte zum ersten Mal die Macht, die die Menschen über die Natur hatten." },
            { text: "Mogli kehrte zum Ratsfelsen zurück, genau als Shir Khan versuchte, die Kontrolle über das Rudel zu übernehmen und Akela zu vertreiben. Der Tiger forderte die Auslieferung des Jungen. Aber Mogli, der auf dem Felsen stand, warf den Topf auf den Boden und Flammen sprangen auf. 'Du bist derjenige, der jetzt Angst hat, versengte Katze!', rief Mogli und schwenkte einen brennenden Ast. Shir Khan, verängstigt durch das Feuer, floh mit eingezogenem Schwanz und versprach zurückzukehren." },
            { text: "Mogli wusste, dass der Dschungel für ihn oder seine Freunde nicht mehr sicher war, solange Shir Khan lebte. Er dachte sich einen schlauen Plan aus. Mit Hilfe seiner Wolfsbrüder und einer Büffelherde lockten sie den Tiger in eine enge Schlucht. Der Ansturm war unaufhaltsam, und Shir Khans grausame Herrschaft nahm ein Ende. Mogli hatte sein Versprechen gehalten und den Dschungel von seinem Tyrannen befreit." },
            { text: "Mit Shir Khan besiegt, versuchte Mogli, zum Rudel zurückzukehren, erkannte aber, dass er kein Wolf mehr war und auch kein ganzer Mensch. Sein Herz war zwischen zwei Welten geteilt. 'Der Dschungel gehört dir, kleiner Bruder', sagte Baghira sanft zu ihm, 'aber dein Platz ist schließlich bei deinem eigenen Volk'. Balu gab ihm mit Tränen in den Augen eine letzte Bärenumarmung. 'Vergiss niemals das Gesetz', flüsterte er." },
            { text: "Mogli ging hinunter zum Menschendorf, wo eine Frau, die ihren Sohn vor Jahren verloren hatte, ihn erkannte und aufnahm. Obwohl er lernte, wie Menschen zu sprechen und Kleidung zu tragen, saß Mogli oft am Waldrand bei Sonnenuntergang, lauschte dem Heulen seiner Wolfsbrüder und wusste, dass der Dschungel, was auch immer passierte, immer sein wahres Zuhause sein würde und Balu und Baghira seine wahren Freunde." }
        ]
    },
    {
        id: 'principe-feliz',
        ...
        titleFr: 'Le Prince Heureux',
        titleDe: 'Der Glückliche Prinz',
        author: 'Oscar Wilde',
        description: 'La conmovedora historia de la amistad entre la estatua de un príncipe que lo tenía todo y una pequeña golondrina que lo dio todo.',
        descriptionEn: 'The touching story of the friendship between the statue of a prince who had everything and a little swallow who gave everything.',
        descriptionFr: 'L\'histoire touchante de l\'amitié entre la statue d\'un prince qui avait tout et une petite hirondelle qui a tout donné.',
        descriptionDe: 'Die rührende Geschichte der Freundschaft zwischen der Statue eines Prinzen, der alles hatte, und einer kleinen Schwalbe, die alles gab.',
        level: 'Medio',
        age: '6+',
        coverImage: '/images/storyteller/principe-feliz-cover.png',
        chipImage: '/images/storyteller/character-principe-feliz.png',
        genre: 'Fábula/Drama',
        themeColor: 'from-sky-700 to-indigo-900',
        rating: 4.9,
        content: [
            { text: "En lo alto de la ciudad, sobre una columna, se alzaba la estatua del Príncipe Feliz. Estaba toda cubierta de finas láminas de oro, tenía por ojos dos zafiros brillantes y un gran rubí rojo centelleaba en el puño de su espada. Todos lo admiraban. 'Es tan hermoso como una veleta', decían." },
            { text: "Una noche, voló sobre la ciudad una pequeña Golondrina. Sus amigas se habían ido a Egipto, pero ella se había quedado atrás. Cansada, se posó entre los pies del Príncipe. 'Tengo una habitación dorada', se dijo. Pero justo cuando iba a dormir, una gran gota de agua le cayó encima. Luego otra, y otra. Miró hacia arriba y vio que los ojos del Príncipe Feliz estaban llenos de lágrimas." },
            { text: "¿Quién eres?', preguntó la Golondrina. 'Soy el Príncipe Feliz'. '¿Y por qué lloras?', preguntó ella. 'Cuando estaba vivo y tenía un corazón humano', respondió la estatua, 'no sabía lo que eran las lágrimas, pues vivía en el Palacio de la Despreocupación. Pero ahora que estoy muerto, me han colocado tan alto que puedo ver toda la fealdad y la miseria de mi ciudad, y aunque mi corazón es de plomo, no puedo evitar llorar'." },
            { text: "'Golondrina, Golondrina', dijo el Príncipe, 'lejos de aquí, en una callejuela, hay una casa pobre. Una mujer está bordando un vestido para la reina, pero su hijo está enfermo y tiene fiebre. No tiene nada para darle más que agua del río. Por favor, saca el rubí de mi espada y llévaselo'. 'Me esperan en Egipto', contestó la Golondrina, pero al ver la tristeza del Príncipe, aceptó quedarse una noche." },
            { text: "La Golondrina arrancó el gran rubí y voló sobre los tejados hasta la casa pobre. Dejó la joya sobre la mesa de la costurera y abanicó con sus alas la frente del niño enfermo. 'Qué fresco siento', dijo el niño, 'debo estar mejorando'. Y cayó en un sueño profundo. La Golondrina volvió con el Príncipe y le contó lo que había hecho. 'Es curioso', dijo, 'siento calor ahora, aunque hace frío'." },
            { text: "A la noche siguiente, el Príncipe le pidió otro favor. 'Lejos, al otro lado de la ciudad, veo a un joven escritor en una buhardilla. Está intentando terminar una obra, pero tiene tanto frío que no puede escribir, y el hambre lo debilita. Sácame uno de mis ojos de zafiro y dáselo'. '¡No puedo sacarte un ojo!', lloró la Golondrina. Pero el Príncipe insistió. Así que ella tomó el zafiro y se lo llevó al estudiante." },
            { text: "Al tercer día, el Príncipe vio a una niña vendedora de cerillas. Se le habían caído las cerillas al arroyo y estaban estropeadas. Su padre le pegaría si no llevaba dinero a casa. 'Sácame el otro ojo y dáselo', dijo el Príncipe. 'Pero entonces te quedarás ciego', dijo la Golondrina. 'No importa', dijo él. La Golondrina obedeció y dejó caer el zafiro en las manos de la niña, que corrió a casa riendo." },
            { text: "'Ahora estás ciego', dijo la Golondrina, 'así que me quedaré contigo para siempre'. 'No, debes ir a Egipto', dijo el pobre Príncipe. 'Me quedaré contigó', repitió ella, y se durmió a sus pies. Durante los días siguientes, voló sobre la ciudad y le contó al Príncipe las historias de los que sufrían. 'Estoy cubierto de oro fino', dijo él, 'despréndelo hoja por hoja y dáselo a mis pobres'." },
            { text: "La Golondrina arrancó el oro hoja por hoja, hasta que el Príncipe quedó gris y deslucido. Pero los rostros de los niños en las calles se tornaron rosados y reían y jugaban. Entonces llegó la nieve, y luego la escarcha. La pobre Golondrina tenía cada vez más frío, pero no quería dejar al Príncipe, lo amaba demasiado." },
            { text: "Finalmente, supo que iba a morir. 'Adiós, amado Príncipe', murmuró, besando sus labios. Y cayó muerta a sus pies. En ese momento, un extraño crujido sonó en el interior de la estatua, como si algo se hubiera roto. El corazón de plomo se había partido en dos. A la mañana siguiente, el alcalde mandó derribar la estatua porque ya no era hermosa. Fundieron el cuerpo, pero el corazón de plomo no se fundía." },
            { text: "'Qué cosa más rara', dijeron los fundidores, y lo tiraron a un montón de basura donde yacía la Golondrina muerta. Y Dios le dijo a uno de sus ángeles: 'Tráeme las dos cosas más preciosas de la ciudad'. Y el ángel le llevó el corazón de plomo y el pájaro muerto. 'Has elegido bien', dijo Dios, 'pues en mi jardín del Paraíso este pajarillo cantará para siempre, y en mi ciudad de oro el Príncipe Feliz me alabará'." }
        ],
        contentEn: [
            { text: "High above the city, on a tall column, stood the statue of the Happy Prince. He was gilded all over with thin leaves of fine gold, for eyes he had two bright sapphires, and a large red ruby glowed on his sword-hilt. Everyone admired him. 'He is as beautiful as a weathercock,' they remarked." },
            { text: "One night there flew over the city a little Swallow. His friends had gone away to Egypt, but he had stayed behind. Tired, he alighted between the feet of the Happy Prince. 'I have a golden bedroom,' he said softly to himself. But just as he was putting his head under his wing a large drop of water fell on him. Then another, and another. He looked up, and saw that the eyes of the Happy Prince were filled with tears." },
            { text: "'Who are you?' he asked. 'I am the Happy Prince.' 'Why are you weeping then?' asked the Swallow. 'When I was alive and had a human heart,' answered the statue, 'I did not know what tears were, for I lived in the Palace of Sans-Souci. But now that I am dead they have set me up here so high that I can see all the ugliness and all the misery of my city, and though my heart is made of lead yet I cannot choose but weep.'" },
            { text: "'Swallow, Swallow, little Swallow,' said the Prince, 'far away in a little street there is a poor house. A woman is embroidering a gown for the Queen, but her little boy is lying ill. He has a fever, and is asking for oranges. His mother has nothing to give him but river water. Will you not bring her the ruby out of my sword-hilt?' 'I am waited for in Egypt,' said the Swallow, but he agreed to stay for one night." },
            { text: "The Swallow picked out the great ruby and flew over the roofs to the poor house. He laid the great ruby on the table beside the woman's thimble, and fanned the boy's forehead with his wings. 'How cool I feel,' said the boy, 'I must be getting better.' And he sank into a delicious slumber. The Swallow returned to the Prince and told him what he had done. 'It is curious,' he remarked, 'but I feel quite warm now, although it is so cold.'" },
            { text: "The next night, the Prince asked for another favor. 'Far away across the city I see a young man in a garret. He is trying to finish a play, but he is too cold to write any more, and hunger has made him faint. Pluck out one of my sapphire eyes and give it to him.' 'I cannot pluck out your eye!' wept the Swallow. But the Prince insisted. So he plucked out the Prince's eye and flew to the student." },
            { text: "On the third day, the Prince saw a little match-girl. She had let her matches fall in the gutter, and they were all spoiled. Her father would beat her if she did not bring home some money. 'Pluck out my other eye and give it to her,' said the Prince. 'But you will be blind then,' said the Swallow. 'It matters not,' said he. So the Swallow plucked out the Prince's other eye, and slipped the jewel into the palm of the little girl's hand." },
            { text: "'You are blind now,' said the Swallow, 'so I will stay with you always.' 'No, little Swallow, you must go to Egypt,' said the poor Prince. 'I will stay with you always,' said the Swallow, and he slept at the Prince's feet. All the next day he sat on the Prince's shoulder, and told him stories of what he had seen in strange lands. 'I am covered with fine gold,' said the Prince, 'you must take it off, leaf by leaf, and give it to my poor.'" },
            { text: "Leaf after leaf of the fine gold the Swallow picked off, till the Happy Prince looked quite dull and grey. But the children's faces grew rosier, and they laughed and played in the street. Then the snow came, and after the snow came the frost. The poor little Swallow grew colder and colder, but he would not leave the Prince, he loved him too well." },
            { text: "At last he knew that he was going to die. 'Goodbye, dear Prince!' he murmured, kissing him on the lips. And he fell down dead at his feet. At that moment a curious crack sounded inside the statue, as if something had broken. The leaden heart had snapped right in two. Early the next morning the Mayor pulled down the statue because it was no longer beautiful. They melted the statue in a furnace, but the broken lead heart would not melt." },
            { text: "'What a strange thing!' said the workmen, and they threw it on a dust-heap where the dead Swallow was also lying. And God told one of His Angels: 'Bring me the two most precious things in the city.' And the Angel brought Him the leaden heart and the dead bird. 'You have rightly chosen,' said God, 'for in my garden of Paradise this little bird shall sing for evermore, and in my city of gold the Happy Prince shall praise me.'" }
        ],
        contentFr: [
            { text: "Haut au-dessus de la ville, sur une colonne élevée, se dressait la statue du Prince Heureux. Il était entièrement doré de fines feuilles d'or pur, il avait pour yeux deux saphirs étincelants, et un gros rubis rouge brillait sur la garde de son épée. Tout le monde l'admirait. 'Il est aussi beau qu'une girouette', disaient-ils." },
            { text: "Une nuit, une petite Hirondelle survola la ville. Ses amies étaient parties pour l'Égypte, mais elle était restée en arrière. Fatiguée, elle se posa entre les pieds du Prince. 'J'ai une chambre à coucher en or', se dit-elle doucement. Mais juste au moment où elle mettait sa tête sous son aile, une grosse goutte d'eau tomba sur elle. Puis une autre, et une autre. Elle leva les yeux et vit que les yeux du Prince Heureux étaient pleins de larmes." },
            { text: "'Qui es-tu ?' demanda-t-elle. 'Je suis le Prince Heureux'. 'Pourquoi pleures-tu alors ?' demanda l'Hirondelle. 'Quand j'étais vivant et que j'avais un cœur humain', répondit la statue, 'je ne savais pas ce qu'étaient les larmes, car je vivais au Palais Sans-Souci. Mais maintenant que je suis mort, ils m'ont placé ici si haut que je peux voir toute la laideur et toute la misère de ma ville, et bien que mon cœur soit de plomb, je ne peux m'empêcher de pleurer'." },
            { text: "'Hirondelle, petite Hirondelle', dit le Prince, 'loin d'ici, dans une ruelle, il y a une pauvre maison. Une femme brode une robe pour la Reine, mais son petit garçon est malade. Il a de la fièvre et demande des oranges. Sa mère n'a rien à lui donner que de l'eau de rivière. Ne veux-tu pas lui apporter le rubis de la garde de mon épée ?' 'On m'attend en Égypte', dit l'Hirondelle, mais elle accepta de rester une nuit." },
            { text: "L'Hirondelle prit le grand rubis et vola par-dessus les toits jusqu'à la pauvre maison. Elle posa le rubis sur la table et éventa le front du garçon avec ses ailes. 'Que je me sens frais', dit le garçon, 'je dois aller mieux'. Et il sombra dans un sommeil délicieux. L'Hirondelle retourna vers le Prince et lui raconta ce qu'elle avait fait. 'C'est curieux', remarqua-t-elle, 'mais je me sens tout à fait chaude maintenant, bien qu'il fasse si froid'." },
            { text: "La nuit suivante, le Prince demanda une autre faveur. 'Loin à travers la ville, je vois un jeune homme dans une mansarde. Il essaie de finir une pièce de théâtre, mais il a trop froid pour écrire, et la faim le fait défaillir. Prends l'un de mes yeux de saphir et donne-le-lui'. 'Je ne peux pas t'arracher l'œil !' pleura l'Hirondelle. Mais le Prince insista. Alors elle prit l'œil du Prince et vola vers l'étudiant." },
            { text: "Le troisième jour, le Prince vit une petite fille aux allumettes. Elle avait laissé tomber ses allumettes dans le ruisseau et elles étaient toutes gâchées. Son père la battrait si elle ne rapportait pas d'argent. 'Arrache mon autre œil et donne-le-lui', dit le Prince. 'Mais tu seras aveugle alors', dit l'Hirondelle. 'Peu importe', dit-il. Alors l'Hirondelle arracha l'autre œil du Prince et glissa le joyau dans la main de la petite fille." },
            { text: "'Tu es aveugle maintenant', dit l'Hirondelle, 'alors je resterai avec toi pour toujours'. 'Non, petite Hirondelle, tu dois aller en Égypte', dit le pauvre Prince. 'Je resterai avec toi pour toujours', dit l'Hirondelle, et elle dormit aux pieds du Prince. Le lendemain, elle s'assit sur l'épaule du Prince et lui raconta des histoires de ce qu'elle avait vu dans des pays étranges. 'Je suis couvert d'or fin', dit le Prince, 'tu dois l'enlever, feuille par feuille, et le donner à mes pauvres'." },
            { text: "Feuille après feuille, l'Hirondelle enleva l'or fin, jusqu'à ce que le Prince Heureux parût tout terne et gris. Mais les visages des enfants devinrent plus roses, et ils riaient et jouaient dans la rue. Puis la neige vint, et après la neige vint le gel. La pauvre petite Hirondelle avait de plus en plus froid, mais elle ne voulait pas quitter le Prince, elle l'aimait trop." },
            { text: "Enfin, elle sut qu'elle allait mourir. 'Adieu, cher Prince !' murmura-t-elle en l'embrassant sur les lèvres. Et elle tomba morte à ses pieds. À ce moment, un craquement curieux résonna à l'intérieur de la statue, comme si quelque chose s'était brisé. Le cœur de plomb s'était cassé net en deux. Le lendemain matin, le Maire fit abattre la statue car elle n'était plus belle. Ils fondirent la statue dans un fourneau, mais le cœur de plomb brisé ne voulut pas fondre." },
            { text: "'Quelle chose étrange !' dirent les ouvriers, et ils le jetèrent sur un tas d'ordures où gisait aussi l'Hirondelle morte. Et Dieu dit à l'un de ses Anges : 'Apporte-moi les deux choses les plus précieuses de la ville'. Et l'Ange lui apporta le cœur de plomb et l'oiseau mort. 'Tu as bien choisi', dit Dieu, 'car dans mon jardin du Paradis, ce petit oiseau chantera pour toujours, et dans ma ville d'or, le Prince Heureux me louera'." }
        ],
        contentDe: [
            { text: "Hoch über der Stadt, auf einer hohen Säule, stand die Statue des Glücklichen Prinzen. Er war über und über mit feinen Blattgoldblättern vergoldet, als Augen hatte er zwei helle Saphire, und ein großer roter Rubin leuchtete an seinem Schwertgriff. Alle bewunderten ihn. 'Er ist so schön wie ein Wetterhahn', bemerkten sie." },
            { text: "Eines Nachts flog eine kleine Schwalbe über die Stadt. Ihre Freunde waren nach Ägypten gezogen, aber sie war zurückgeblieben. Müde ließ sie sich zwischen den Füßen des Prinzen nieder. 'Ich habe ein goldenes Schlafzimmer', sagte sie leise zu sich selbst. Aber gerade als sie ihren Kopf unter ihren Flügel stecken wollte, fiel ein großer Wassertropfen auf sie. Dann noch einer und noch einer. Sie blickte auf und sah, dass die Augen des Glücklichen Prinzen voller Tränen waren." },
            { text: "'Wer bist du?', fragte sie. 'Ich bin der Glückliche Prinz.' 'Warum weinst du dann?', fragte die Schwalbe. 'Als ich noch lebte und ein menschliches Herz hatte', antwortete die Statue, 'wusste ich nicht, was Tränen sind, denn ich lebte im Schloss Sans-Souci. Aber jetzt, wo ich tot bin, haben sie mich hier so hoch aufgestellt, dass ich all die Hässlichkeit und all das Elend meiner Stadt sehen kann, und obwohl mein Herz aus Blei ist, kann ich nicht anders als weinen'." },
            { text: "'Schwalbe, Schwalbe, kleine Schwalbe', sagte der Prinz, 'weit weg in einer kleinen Straße steht ein armes Haus. Eine Frau stickt ein Kleid für die Königin, aber ihr kleiner Junge liegt krank darnieder. Er hat Fieber und bittet um Orangen. Seine Mutter hat nichts, was sie ihm geben könnte, außer Flusswasser. Willst du ihr nicht den Rubin aus meinem Schwertgriff bringen?' 'Ich werde in Ägypten erwartet', sagte die Schwalbe, aber sie willigte ein, eine Nacht zu bleiben." },
            { text: "Die Schwalbe pickte den großen Rubin heraus und flog über die Dächer zu dem armen Haus. Sie legte den großen Rubin auf den Tisch neben den Fingerhut der Frau und fächelte dem Jungen mit ihren Flügeln die Stirn. 'Wie kühl ich mich fühle', sagte der Junge, 'es muss mir besser gehen.' Und er sank in einen köstlichen Schlummer. Die Schwalbe kehrte zum Prinzen zurück und erzählte ihm, was sie getan hatte. 'Es ist seltsam', bemerkte sie, 'aber mir ist jetzt ganz warm, obwohl es so kalt ist'." },
            { text: "In der nächsten Nacht bat der Prinz um einen weiteren Gefallen. 'Weit weg am anderen Ende der Stadt sehe ich einen jungen Mann in einer Dachkammer. Er versucht, ein Theaterstück zu beenden, aber ihm ist zu kalt, um weiterzuschreiben, und der Hunger hat ihn schwach gemacht. Nimm eines meiner Saphiraugen und gib es ihm.' 'Ich kann dir nicht das Auge ausreißen!' weinte die Schwalbe. Aber der Prinz bestand darauf. Also nahm sie das Auge des Prinzen und flog zu dem Studenten." },
            { text: "Am dritten Tag sah der Prinz ein kleines Schwefelholzmädchen. Sie hatte ihre Streichhölzer in den Rinnstein fallen lassen, und sie waren alle verdorben. Ihr Vater würde sie schlagen, wenn sie kein Geld nach Hause brachte. 'Reiß mein anderes Auge aus und gib es ihr', sagte der Prinz. 'Aber dann wirst du blind sein', sagte die Schwalbe. 'Das macht nichts', sagte er. Also riss die Schwalbe das andere Auge des Prinzen aus und ließ den Edelstein in die Hand des kleinen Mädchens gleiten." },
            { text: "'Du bist jetzt blind', sagte die Schwalbe, 'also werde ich für immer bei dir bleiben.' 'Nein, kleine Schwalbe, du musst nach Ägypten gehen', sagte der arme Prinz. 'Ich werde für immer bei dir bleiben', sagte die Schwalbe und schlief zu Füßen des Prinzen. Den ganzen nächsten Tag saß sie auf der Schulter des Prinzen und erzählte ihm Geschichten von dem, was sie in fremden Ländern gesehen hatte. 'Ich bin mit feinem Gold bedeckt', sagte der Prinz, 'du musst es abnehmen, Blatt für Blatt, und es meinen Armen geben'." },
            { text: "Blatt für Blatt des feinen Goldes nahm die Schwalbe ab, bis der Glückliche Prinz ganz stumpf und grau aussah. Aber die Gesichter der Kinder wurden rosiger, und sie lachten und spielten auf der Straße. Dann kam der Schnee, und nach dem Schnee kam der Frost. Der armen kleinen Schwalbe wurde kälter und kälter, aber sie wollte den Prinzen nicht verlassen, sie liebte ihn zu sehr." },
            { text: "Schließlich wusste sie, dass sie sterben würde. 'Leb wohl, lieber Prinz!', murmelte sie und küsste ihn auf die Lippen. Und sie fiel tot zu seinen Füßen nieder. In diesem Moment ertönte ein seltsames Knacken im Inneren der Statue, als wäre etwas zerbrochen. Das bleierne Herz war genau entzwei gebrochen. Früh am nächsten Morgen ließ der Bürgermeister die Statue abreißen, weil sie nicht mehr schön war. Sie schmolzen die Statue in einem Ofen ein, aber das zerbrochene bleierne Herz wollte nicht schmelzen." },
            { text: "'Was für eine seltsame Sache!', sagten die Arbeiter und warfen es auf einen Müllhaufen, auf dem auch die tote Schwalbe lag. Und Gott sprach zu einem seiner Engel: 'Bring mir die zwei kostbarsten Dinge der Stadt.' Und der Engel brachte Ihm das bleierne Herz und den toten Vogel. 'Du hast richtig gewählt', sprach Gott, 'denn in meinem Paradiesgarten soll dieser kleine Vogel für immer singen, und in meiner goldenen Stadt soll der Glückliche Prinz mich preisen'." }
        ]
    },
    {
        id: 'ricitos-oro',
        ...
        titleFr: 'Boucle d\'Or et les Trois Ours',
        titleDe: 'Goldlöckchen und die drei Bären',
        author: 'Robert Southey',
        description: 'Una niña curiosa entra en la casa de tres osos y aprende una lección sobre el respeto a la propiedad ajena.',
        descriptionEn: 'A curious girl enters the home of three bears and learns a lesson about respect for others\' property.',
        descriptionFr: 'Une fille curieuse entre dans la maison de trois ours et apprend une leçon sur le respect de la propriété d\'autrui.',
        descriptionDe: 'Ein neugieriges Mädchen betritt das Haus von drei Bären und lernt eine Lektion über den Respekt vor fremdem Eigentum.',
        level: 'Fácil',
        age: '3+',
        coverImage: '/images/storyteller/ricitos-cover.png',
        chipImage: '/images/storyteller/character-ricitos.png',
        genre: 'Fábula',
        themeColor: 'from-yellow-500 to-amber-600',
        rating: 4.6,
        content: [
            { text: "Había una vez tres osos que vivían en una casita en el bosque. Había un Papá Oso, grandote y con una voz ronca; una Mamá Osa, de tamaño mediano y voz suave; y un Bebé Oso, pequeñito y con una voz chillona. Una mañana prepararon una rica sopa de avena para desayunar, pero como estaba muy caliente para comerla, decidieron ir a dar un paseo por el bosque mientras se enfriaba." },
            { text: "Mientras estaban fuera, llegó una niña llamada Ricitos de Oro. Era muy curiosa y, al ver la puerta entreabierta, no pudo resistir la tentación de entrar. Vio los tres platos de sopa en la mesa. Probó el del Papá Oso: '¡Uy! ¡Está muy caliente!', exclamó. Probó el de la Mamá Osa: '¡Uy! ¡Está muy fría!', dijo frunciendo el ceño." },
            { text: "Finalmente probó el plato del Bebé Oso. '¡Mmm! Esta no está ni muy caliente ni muy fría, ¡está perfecta!', dijo Ricitos de Oro, y se la comió toda hasta no dejar ni rastro. Después de comer, se sintió cansada y buscó dónde sentarse. Vio tres sillas en la sala. Se sentó en la silla grande del Papá Oso, pero era muy dura." },
            { text: "Luego se sentó en la silla mediana de la Mamá Osa, pero era muy blanda. Al fin, se sentó en la sillita del Bebé Oso: '¡Esta es perfecta!', pensó feliz. Pero Ricitos de Oro era ya muy grande para esa sillita, y de repente... ¡Cras! La silla se rompió en mil pedazos y la niña cayó al suelo." },
            { text: "Ricitos de Oro decidió subir al dormitorio. Allí encontró tres camas. Se acostó en la cama grande, pero la almohada era demasiado alta. Probó la cama mediana, pero la encontró demasiado baja a los pies. Por último, se acostó en la camita del Bebé Oso. Era tan cómoda y calentita que enseguida se quedó profundamente dormida." },
            { text: "Al poco rato, los tres osos regresaron de su paseo con mucho apetito. Papá Oso miró su plato y rugió con su voz ronca: '¡Alguien ha probado mi sopa!'. Mamá Osa miró su plato y dijo con voz suave: '¡Alguien ha probado mi sopa también!'. Y el Bebé Oso miró su plato vacío y lloró con su voz chillona: '¡Alguien ha probado mi sopa y se la ha comido toda!'." },
            { text: "Luego miraron las sillas. '¡Alguien se ha sentado en mi silla!', gruñó Papá Oso. '¡Alguien se ha sentado en mi silla también!', dijo Mamá Osa. '¡Alguien se ha sentado en mi silla y la ha roto!', sollozó el Bebé Oso al ver los trozos de madera en el suelo. Los osos, sospechando que el intruso seguía allí, subieron las escaleras hacia el dormitorio." },
            { text: "Papá Oso miró su cama y dijo: '¡Alguien se ha acostado en mi cama!'. Mamá Osa exclamó: '¡Alguien se ha acostado en mi cama también!'. Y el Bebé Oso gritó sorprendido: '¡Alguien se ha acostado en mi cama... y todavía está ahí!'. Ricitos de Oro se despertó con las voces. Al ver a los tres osos mirándola, se asustó tanto que saltó de la cama." },
            { text: "Salió corriendo de la habitación, bajó las escaleras de un salto y huyó por el bosque tan rápido como le permitieron sus piernas. Nunca más volvió a acercarse a la casita de los tres osos. Y así aprendió que no se debe entrar en casa ajena sin permiso, ni tocar las cosas que no son suyas." }
        ],
        contentEn: [
            { text: "Once upon a time there were three bears who lived in a little house in the forest. There was a Papa Bear, huge and with a gruff voice; a Mama Bear, medium-sized and with a soft voice; and a Baby Bear, tiny and with a squeaky voice. One morning they made delicious oatmeal for breakfast, but since it was too hot to eat, they decided to go for a walk in the forest while it cooled down." },
            { text: "While they were out, a girl named Goldilocks arrived. She was very curious and, seeing the door ajar, could not resist the temptation to enter. She saw the three bowls of porridge on the table. She tasted Papa Bear's: 'Ouch! It's too hot!', she exclaimed. She tasted Mama Bear's: 'Ouch! It's too cold!', she said frowning." },
            { text: "Finally she tasted Baby Bear's bowl. 'Yum! This one is neither too hot nor too cold, it's just right!', said Goldilocks, and she ate it all until there was nothing left. After eating, she felt tired and looked for somewhere to sit. She saw three chairs in the living room. She sat in Papa Bear's big chair, but it was too hard." },
            { text: "Then she sat in Mama Bear's medium chair, but it was too soft. Finally, she sat in Baby Bear's little chair: 'This one is just right!', she thought happily. But Goldilocks was already too big for that little chair, and suddenly... Crash! The chair broke into a thousand pieces and the girl fell to the floor." },
            { text: "Goldilocks decided to go up to the bedroom. There she found three beds. She lay down on the big bed, but the pillow was too high. She tried the medium bed, but found it too low at the foot. Finally, she lay down on Baby Bear's little bed. It was so comfortable and warm that she immediately fell fast asleep." },
            { text: "Shortly after, the three bears returned from their walk with a big appetite. Papa Bear looked at his bowl and roared with his gruff voice: 'Someone has been tasting my porridge!'. Mama Bear looked at her bowl and said with a soft voice: 'Someone has been tasting my porridge too!'. And Baby Bear looked at his empty bowl and cried with his squeaky voice: 'Someone has been tasting my porridge and has eaten it all up!'." },
            { text: "Then they looked at the chairs. 'Someone has been sitting in my chair!', growled Papa Bear. 'Someone has been sitting in my chair too!', said Mama Bear. 'Someone has been sitting in my chair and has broken it!', sobbed Baby Bear seeing the pieces of wood on the floor. The bears, suspecting the intruder was still there, went up the stairs to the bedroom." },
            { text: "Papa Bear looked at his bed and said: 'Someone has been sleeping in my bed!'. Mama Bear exclaimed: 'Someone has been sleeping in my bed too!'. And Baby Bear shouted surprised: 'Someone has been sleeping in my bed... and she is still there!'. Goldilocks woke up with the voices. Seeing the three bears watching her, she was so scared that she jumped out of bed." },
            { text: "She ran out of the room, jumped down the stairs and fled through the forest as fast as her legs would carry her. She never went near the three bears' little house again. And so she learned that one should not enter another's house without permission, nor touch things that are not theirs." }
        ],
        contentFr: [
            { text: "Il était une fois trois ours qui vivaient dans une petite maison dans la forêt. Il y avait un Papa Ours, énorme et à la voix rauque ; une Maman Ours, de taille moyenne et à la voix douce ; et un Bébé Ours, tout petit et à la voix aiguë. Un matin, ils préparèrent une délicieuse bouillie d'avoine pour le petit-déjeuner, mais comme c'était trop chaud pour manger, ils décidèrent d'aller se promener dans la forêt pendant qu'elle refroidissait." },
            { text: "Pendant qu'ils étaient sortis, une fille nommée Boucle d'Or arriva. Elle était très curieuse et, voyant la porte entrouverte, ne put résister à la tentation d'entrer. Elle vit les trois bols de soupe sur la table. Elle goûta celui de Papa Ours : 'Aïe ! C'est trop chaud !', s'exclama-t-elle. Elle goûta celui de Maman Ours : 'Aïe ! C'est trop froid !', dit-elle en fronçant les sourcils." },
            { text: "Enfin, elle goûta le bol de Bébé Ours. 'Miam ! Celle-ci n'est ni trop chaude ni trop froide, elle est parfaite !', dit Boucle d'Or, et elle mangea tout jusqu'à ce qu'il ne reste plus rien. Après avoir mangé, elle se sentit fatiguée et chercha où s'asseoir. Elle vit trois chaises dans le salon. Elle s'assit dans la grande chaise de Papa Ours, mais elle était trop dure." },
            { text: "Ensuite, elle s'assit dans la chaise moyenne de Maman Ours, mais elle était trop molle. Enfin, elle s'assit dans la petite chaise de Bébé Ours : 'Celle-ci est parfaite !', pensa-t-elle joyeusement. Mais Boucle d'Or était déjà trop grande pour cette petite chaise, et soudain... Crac ! La chaise se brisa en mille morceaux et la fille tomba par terre." },
            { text: "Boucle d'Or décida de monter dans la chambre. Là, elle trouva trois lits. Elle se coucha dans le grand lit, mais l'oreiller était trop haut. Elle essaya le lit moyen, mais le trouva trop bas aux pieds. Enfin, elle se coucha dans le petit lit de Bébé Ours. Il était si confortable et chaud qu'elle s'endormit immédiatement profondément." },
            { text: "Peu après, les trois ours revinrent de leur promenade avec un grand appétit. Papa Ours regarda son bol et rugit de sa voix rauque : 'Quelqu'un a goûté à ma soupe !'. Maman Ours regarda son bol et dit d'une voix douce : 'Quelqu'un a goûté à ma soupe aussi !'. Et Bébé Ours regarda son bol vide et pleura de sa voix aiguë : 'Quelqu'un a goûté à ma soupe et l'a toute mangée !'." },
            { text: "Ensuite, ils regardèrent les chaises. 'Quelqu'un s'est assis sur ma chaise !', grogna Papa Ours. 'Quelqu'un s'est assis sur ma chaise aussi !', dit Maman Ours. 'Quelqu'un s'est assis sur ma chaise et l'a cassée !', sanglota Bébé Ours en voyant les morceaux de bois par terre. Les ours, soupçonnant que l'intrus était toujours là, montèrent l'escalier vers la chambre." },
            { text: "Papa Ours regarda son lit et dit : 'Quelqu'un a dormi dans mon lit !'. Maman Ours s'exclama : 'Quelqu'un a dormi dans mon lit aussi !'. Et Bébé Ours cria surpris : 'Quelqu'un a dormi dans mon lit... et elle est encore là !'. Boucle d'Or se réveilla avec les voix. En voyant les trois ours la regarder, elle eut si peur qu'elle sauta du lit." },
            { text: "Elle sortit de la chambre en courant, dévala l'escalier et s'enfuit à travers la forêt aussi vite que ses jambes le lui permettaient. Elle ne s'approcha plus jamais de la petite maison des trois ours. Et ainsi elle apprit qu'il ne faut pas entrer chez les autres sans permission, ni toucher aux choses qui ne sont pas à soi." }
        ],
        contentDe: [
            { text: "Es war einmal drei Bären, die in einem kleinen Haus im Wald lebten. Es gab einen Papa Bär, riesig und mit einer rauen Stimme; eine Mama Bär, mittelgroß und mit einer sanften Stimme; und einen Baby Bär, winzig und mit einer piepsigen Stimme. Eines Morgens machten sie leckeren Haferbrei zum Frühstück, aber da er zu heiß zum Essen war, beschlossen sie, einen Spaziergang im Wald zu machen, während er abkühlte." },
            { text: "Während sie weg waren, kam ein Mädchen namens Goldlöckchen an. Sie war sehr neugierig und konnte, als sie die Tür angelehnt sah, der Versuchung nicht widerstehen, einzutreten. Sie sah die drei Schüsseln Suppe auf dem Tisch. Sie probierte die von Papa Bär: 'Autsch! Die ist zu heiß!', rief sie. Sie probierte die von Mama Bär: 'Igitt! Die ist zu kalt!', sagte sie stirnrunzelnd." },
            { text: "Schließlich probierte sie die Schüssel von Baby Bär. 'Mmm! Diese ist weder zu heiß noch zu kalt, sie ist genau richtig!', sagte Goldlöckchen, und sie aß alles auf, bis nichts mehr übrig war. Nach dem Essen fühlte sie sich müde und suchte einen Platz zum Sitzen. Sie sah drei Stühle im Wohnzimmer. Sie setzte sich auf den großen Stuhl von Papa Bär, aber er war zu hart." },
            { text: "Dann setzte sie sich auf den mittleren Stuhl von Mama Bär, aber er war zu weich. Schließlich setzte sie sich auf den kleinen Stuhl von Baby Bär: 'Dieser ist genau richtig!', dachte sie glücklich. Aber Goldlöckchen war schon zu schwer für diesen kleinen Stuhl, und plötzlich... Krach! Der Stuhl zerbrach in tausend Stücke und das Mädchen fiel auf den Boden." },
            { text: "Goldlöckchen beschloss, ins Schlafzimmer zu gehen. Dort fand sie drei Betten. Sie legte sich in das große Bett, aber das Kissen war zu hoch. Sie probierte das mittlere Bett, fand es aber am Fußende zu niedrig. Schließlich legte sie sich in das kleine Bett von Baby Bär. Es war so bequem und warm, dass sie sofort tief einschlief." },
            { text: "Kurz darauf kamen die drei Bären mit großem Appetit von ihrem Spaziergang zurück. Papa Bär sah seine Schüssel an und brüllte mit seiner rauen Stimme: 'Jemand hat von meiner Suppe probiert!'. Mama Bär sah ihre Schüssel an und sagte mit sanfter Stimme: 'Jemand hat von meiner Suppe auch probiert!'. Und Baby Bär sah seine leere Schüssel an und weinte mit seiner piepsigen Stimme: 'Jemand hat von meiner Suppe probiert und hat sie ganz aufgegessen!'." },
            { text: "Dann sahen sie sich die Stühle an. 'Jemand hat auf meinem Stuhl gesessen!', knurrte Papa Bär. 'Jemand hat auf meinem Stuhl auch gesessen!', sagte Mama Bär. 'Jemand hat auf meinem Stuhl gesessen und hat ihn kaputt gemacht!', schluchzte Baby Bär, als er die Holzstücke auf dem Boden sah. Die Bären, die vermuteten, dass der Eindringling noch da war, gingen die Treppe zum Schlafzimmer hinauf." },
            { text: "Papa Bär sah sein Bett an und sagte: 'Jemand hat in meinem Bett geschlafen!'. Mama Bär rief: 'Jemand hat in meinem Bett auch geschlafen!'. Und Baby Bär schrie überrascht: 'Jemand hat in meinem Bett geschlafen... und sie ist immer noch da!'. Goldlöckchen wachte von den Stimmen auf. Als sie die drei Bären sah, die sie anstarrten, erschrak sie so sehr, dass sie aus dem Bett sprang." },
            { text: "Sie rannte aus dem Zimmer, sprang die Treppe hinunter und floh durch den Wald, so schnell ihre Beine sie tragen konnten. Sie näherte sich nie wieder dem kleinen Haus der drei Bären. Und so lernte sie, dass man nicht ohne Erlaubnis in das Haus anderer Leute gehen darf und auch keine Dinge anfassen darf, die einem nicht gehören." }
        ]
    },
    {
        ...
        titleFr: 'Les Habits Neufs de l\'Empereur',
        titleDe: 'Des Kaisers neue Kleider',
        author: 'Hans Christian Andersen',
        description: 'Un emperador vanidoso es engañado por dos estafadores que prometen un traje invisible para los tontos, hasta que un niño dice la verdad.',
        descriptionEn: 'A vain emperor is tricked by two swindlers who promise a suit invisible to fools, until a child tells the truth.',
        descriptionFr: 'Un empereur vaniteux est trompé par deux escrocs qui promettent un costume invisible pour les sots, jusqu\'à ce qu\'un enfant dise la vérité.',
        descriptionDe: 'Ein eitler Kaiser wird von zwei Betrügern getäuscht, die einen für Narren unsichtbaren Anzug versprechen, bis ein Kind die Wahrheit sagt.',
        level: 'Medio',
        age: '5+',
        coverImage: '/images/storyteller/traje-nuevo-cover.png',
        chipImage: '/images/storyteller/character-traje-nuevo.png',
        genre: 'Sátira',
        themeColor: 'from-purple-600 to-fuchsia-500',
        rating: 4.7,
        content: [
            { text: "Hace muchos años vivía un Emperador que amaba tanto la ropa nueva y elegante que gastaba todo su dinero en ella. No le importaban sus soldados, ni el teatro, ni pasear por el bosque, a menos que fuera para lucir sus trajes nuevos. Tenía un abrigo distinto para cada hora del día y, en lugar de decirse de él 'está en el consejo', siempre se decía: 'El Emperador está en el vestidor'." },
            { text: "Un día llegaron a la ciudad dos estafadores. Se hicieron pasar por tejedores y dijeron que sabían tejer la tela más maravillosa que se pudiera imaginar. No solo los colores y los dibujos eran de una belleza excepcional, sino que la ropa confeccionada con aquella tela poseía la milagrosa virtud de ser invisible para todos aquellos que fueran tontos o que no fueran aptos para su cargo." },
            { text: "'¡Sería un traje magnífico!', pensó el Emperador. 'Si lo tuviera, podría descubrir qué ministros de mi reino no sirven para su puesto y distinguir a los listos de los tontos'. Así que pagó una gran suma de dinero a los estafadores para que empezaran a trabajar de inmediato. Ellos montaron dos telares y simularon trabajar, aunque no tenían nada en absoluto en las máquinas." },
            { text: "Pasaron los días y el Emperador quería saber cómo iba la tela. Pero recordaba que los tontos no podían verla, así que envió a su viejo y honesto ministro. El ministro entró en la sala, miró los telares vacíos y pensó aterrado: '¡Dios mío! ¡No veo nada! ¿Seré tonto?'. Pero no se atrevió a decirlo. Elogió el estampado y los colores que no veía, y le dijo al Emperador que era una tela preciosa." },
            { text: "Más tarde, el Emperador envió a otro funcionario. Le ocurrió lo mismo: miró y miró, pero como no había nada, no vio nada. '¿Seré incompetente?', pensó. 'Es terrible, pero no debo dejar que nadie lo note'. Así que también alabó la tela inexistente. Toda la ciudad hablaba ya de la tela maravillosa y sus poderes mágicos." },
            { text: "Finalmente, el propio Emperador quiso verla. Fue con su séquito. '¿No es magnífica?', dijeron los ministros. El Emperador pensó: '¡Horror! ¡No veo nada! ¿Soy tonto? ¿No sirvo para Emperador?'. Pero en voz alta dijo: '¡Oh, es bellísima!'. Y condecora a los estafadores. Esa noche los bribones fingieron coser y cortar el aire con grandes tijeras hasta terminar el traje." },
            { text: "Llegó el día del gran desfile. Los estafadores hicieron el gesto de vestir al Emperador prenda por prenda. '¡Qué bien le sienta! ¡Qué regio!', exclamaban todos los cortesanos, fingiendo ver la ropa. El Emperador, vestido solo con su ropa interior (o menos, según se mire), salió a la calle bajo un hermoso palio. La gente en la calle y en las ventanas gritaba: '¡Qué traje tan espléndido!', pues nadie quería parecer tonto." },
            { text: "Pero de repente, un niño pequeño que miraba el desfile dijo con inocencia: '¡Pero si no lleva nada puesto!'. Su padre intentó callarlo, pero el murmullo se extendió. '¡Un niño dice que no lleva nada!'. Al final, todo el pueblo gritó: '¡No lleva nada puesto!'. El Emperador se estremeció, pues sospechaba que tenían razón, pero pensó: 'Debo aguantar hasta el final'. Y siguió caminando más erguido que nunca." },
            { text: "Los chambelanes continuaron sosteniendo la cola invisible que no existía, y el desfile siguió su curso. Y así, la vanidad del Emperador y el miedo de la gente a decir la verdad quedaron al descubierto gracias a la sinceridad de un niño." }
        ],
        contentEn: [
            { text: "Many years ago there lived an Emperor who loved new and fancy clothes so much that he spent all his money on them. He did not care about his soldiers, nor the theater, nor walking in the forest, unless it was to show off his new suits. He had a different coat for every hour of the day and, instead of saying of him 'he is in council', it was always said: 'The Emperor is in the dressing room'." },
            { text: "One day two swindlers arrived in the city. They posed as weavers and claimed they could weave the most wonderful cloth imaginable. Not only were the colors and patterns of exceptional beauty, but the clothes made from that cloth possessed the miraculous virtue of being invisible to anyone who was foolish or unfit for their office." },
            { text: "'That would be a magnificent suit!', thought the Emperor. 'If I had it, I could discover which ministers in my kingdom are unfit for their posts and distinguish the smart from the stupid'. So he paid a large sum of money to the swindlers to start working immediately. They set up two looms and pretended to work, although they had nothing at all on the machines." },
            { text: "Days passed and the Emperor wanted to know how the cloth was coming along. But remembering that fools could not see it, he sent his honest old minister. The minister entered the room, looked at the empty looms and thought terrified: 'Oh my God! I don't see anything! Am I stupid?'. But he didn't dare say it. He praised the pattern and colors he didn't see, and told the Emperor it was a beautiful cloth." },
            { text: "Later, the Emperor sent another official. The same thing happened to him: he looked and looked, but since there was nothing, he saw nothing. 'Am I incompetent?', he thought. 'It is terrible, but I must not let anyone notice'. So he also praised the non-existent cloth. The whole city was already talking about the wonderful cloth and its magical powers." },
            { text: "Finally, the Emperor himself wanted to see it. He went with his entourage. 'Isn't it magnificent?', said the ministers. The Emperor thought: 'Horror! I don't see anything! Am I stupid? Am I not fit to be Emperor?'. But aloud he said: 'Oh, it is beautiful!'. And he decorated the swindlers. That night the rogues pretended to sew and cut the air with large scissors until they finished the suit." },
            { text: "The day of the great parade arrived. The swindlers made the gesture of dressing the Emperor piece by piece. 'How well it fits! How regal!', exclaimed all the courtiers, pretending to see the clothes. The Emperor, dressed only in his underwear (or less, depending on how you look at it), went out into the street under a beautiful canopy. People in the street and at the windows shouted: 'What a splendid suit!', for no one wanted to appear foolish." },
            { text: "But suddenly, a little child watching the parade said innocently: 'But he isn't wearing anything!'. His father tried to hush him, but the whisper spread. 'A child says he isn't wearing anything!'. In the end, the whole town shouted: 'He isn't wearing anything!'. The Emperor shuddered, for he suspected they were right, but he thought: 'I must go through with it to the end'. And he walked even more proudly than ever." },
            { text: "The chamberlains continued to hold the invisible train that did not exist, and the parade went on. And so, the Emperor's vanity and the people's fear of telling the truth were exposed thanks to the sincerity of a child." }
        ],
        contentFr: [
            { text: "Il y a de nombreuses années vivait un Empereur qui aimait tant les habits neufs et élégants qu'il dépensait tout son argent pour eux. Il ne se souciait ni de ses soldats, ni du théâtre, ni de se promener dans la forêt, sauf si c'était pour montrer ses nouveaux costumes. Il avait un manteau différent pour chaque heure de la journée et, au lieu de dire de lui 'il est au conseil', on disait toujours : 'L'Empereur est dans sa garde-robe'." },
            { text: "Un jour, deux escrocs arrivèrent en ville. Ils se firent passer pour des tisserands et prétendirent savoir tisser l'étoffe la plus merveilleuse qu'on pût imaginer. Non seulement les couleurs et les dessins étaient d'une beauté exceptionnelle, mais les vêtements confectionnés avec cette étoffe possédaient la vertu miraculeuse d'être invisibles pour tous ceux qui étaient sots ou incapables dans leur fonction." },
            { text: "'Ce serait un costume magnifique !', pensa l'Empereur. 'Si je l'avais, je pourrais découvrir quels ministres de mon royaume ne sont pas à leur place et distinguer les intelligents des sots'. Il paya donc une grosse somme d'argent aux escrocs pour qu'ils commencent à travailler immédiatement. Ils installèrent deux métiers à tisser et firent semblant de travailler, bien qu'ils n'eussent rien du tout sur les machines." },
            { text: "Les jours passèrent et l'Empereur voulait savoir où en était l'étoffe. Mais se rappelant que les sots ne pouvaient pas la voir, il envoya son vieux et honnête ministre. Le ministre entra dans la salle, regarda les métiers vides et pensa terrifié : 'Mon Dieu ! Je ne vois rien ! Suis-je sot ?'. Mais il n'osa pas le dire. Il loua le motif et les couleurs qu'il ne voyait pas, et dit à l'Empereur que c'était une étoffe magnifique." },
            { text: "Plus tard, l'Empereur envoya un autre fonctionnaire. Il lui arriva la même chose : il regarda et regarda, mais comme il n'y avait rien, il ne vit rien. 'Suis-je incompétent ?', pensa-t-il. 'C'est terrible, mais je ne dois laisser personne s'en apercevoir'. Il loua donc aussi l'étoffe inexistante. Toute la ville parlait déjà de l'étoffe merveilleuse et de ses pouvoirs magiques." },
            { text: "Finalement, l'Empereur voulut la voir lui-même. Il y alla avec sa suite. 'N'est-ce pas magnifique ?', dirent les ministres. L'Empereur pensa : 'Horreur ! Je ne vois rien ! Suis-je sot ? Ne suis-je pas fait pour être Empereur ?'. Mais tout haut, il dit : 'Oh, c'est très beau !'. Et il décora les escrocs. Cette nuit-là, les fripouilles firent semblant de coudre et de couper l'air avec de grands ciseaux jusqu'à finir le costume." },
            { text: "Le jour du grand défilé arriva. Les escrocs firent le geste d'habiller l'Empereur pièce par pièce. 'Comme cela lui va bien ! Quel style !', s'exclamaient tous les courtisans, feignant de voir les vêtements. L'Empereur, vêtu seulement de ses sous-vêtements (ou moins, selon le point de vue), sortit dans la rue sous un beau dais. Les gens dans la rue et aux fenêtres criaient : 'Quel costume splendide !', car personne ne voulait paraître sot." },
            { text: "Mais soudain, un petit enfant qui regardait le défilé dit innocemment : 'Mais il ne porte rien !'. Son père essaya de le faire taire, mais le murmure se répandit. 'Un enfant dit qu'il ne porte rien !'. À la fin, tout le peuple cria : 'Il ne porte rien !'. L'Empereur frissonna, car il soupçonnait qu'ils avaient raison, mais il pensa : 'Je dois tenir jusqu'au bout'. Et il continua de marcher plus fièrement que jamais." },
            { text: "Les chambellans continuèrent de porter la traîne invisible qui n'existait pas, et le défilé suivit son cours. Et ainsi, la vanité de l'Empereur et la peur des gens de dire la vérité furent exposées grâce à la sincérité d'un enfant." }
        ],
        contentDe: [
            { text: "Vor vielen Jahren lebte ein Kaiser, der neue und schicke Kleider so sehr liebte, dass er sein ganzes Geld dafür ausgab. Er kümmerte sich nicht um seine Soldaten, noch um das Theater, noch um Spaziergänge im Wald, es sei denn, um seine neuen Anzüge zu zeigen. Er hatte für jede Stunde des Tages einen anderen Rock, und statt von ihm zu sagen 'er ist im Rat', hieß es immer: 'Der Kaiser ist in der Garderobe'." },
            { text: "Eines Tages kamen zwei Betrüger in die Stadt. Sie gaben sich als Weber aus und behaupteten, sie könnten den wunderbarsten Stoff weben, den man sich vorstellen kann. Nicht nur die Farben und Muster waren von außergewöhnlicher Schönheit, sondern die Kleider aus diesem Stoff besaßen die wunderbare Eigenschaft, für jeden unsichtbar zu sein, der dumm war oder für sein Amt untauglich." },
            { text: "'Das wäre ein prächtiger Anzug!', dachte der Kaiser. 'Wenn ich ihn hätte, könnte ich herausfinden, welche Minister in meinem Königreich für ihre Posten ungeeignet sind, und die Klugen von den Dummen unterscheiden'. Also zahlte er den Betrügern eine große Summe Geld, damit sie sofort mit der Arbeit begannen. Sie stellten zwei Webstühle auf und taten so, als ob sie arbeiteten, obwohl sie überhaupt nichts auf den Maschinen hatten." },
            { text: "Tage vergingen und der Kaiser wollte wissen, wie es mit dem Stoff voranging. Aber da er sich erinnerte, dass Dumme ihn nicht sehen konnten, schickte er seinen alten, ehrlichen Minister. Der Minister betrat den Raum, sah auf die leeren Webstühle und dachte erschrocken: 'Oh mein Gott! Ich sehe nichts! Bin ich dumm?'. Aber er wagte es nicht zu sagen. Er lobte das Muster und die Farben, die er nicht sah, und sagte dem Kaiser, es sei ein wunderschöner Stoff." },
            { text: "Später schickte der Kaiser einen anderen Beamten. Ihm erging es genauso: Er schaute und schaute, aber da nichts da war, sah er nichts. 'Bin ich inkompetent?', dachte er. 'Es ist schrecklich, aber ich darf es niemanden merken lassen'. Also lobte er auch den nicht existierenden Stoff. Die ganze Stadt sprach schon von dem wunderbaren Stoff und seinen magischen Kräften." },
            { text: "Schließlich wollte der Kaiser ihn selbst sehen. Er ging mit seinem Gefolge hin. 'Ist es nicht prächtig?', sagten die Minister. Der Kaiser dachte: 'Entsetzen! Ich sehe nichts! Bin ich dumm? Tauge ich nicht zum Kaiser?'. Aber laut sagte er: 'Oh, es ist wunderschön!'. Und er zeichnete die Betrüger aus. In dieser Nacht taten die Gauner so, als würden sie nähen und mit großen Scheren die Luft schneiden, bis sie den Anzug fertig hatten." },
            { text: "Der Tag des großen Umzugs kam. Die Betrüger machten die Geste, den Kaiser Stück für Stück anzukleiden. 'Wie gut es sitzt! Wie königlich!', riefen alle Höflinge und taten so, als sähen sie die Kleider. Der Kaiser, nur mit seiner Unterwäsche bekleidet (oder weniger, je nach Betrachtungsweise), ging unter einem schönen Baldachin auf die Straße hinaus. Die Leute auf der Straße und an den Fenstern riefen: 'Welch ein prächtiger Anzug!', denn niemand wollte dumm erscheinen." },
            { text: "Aber plötzlich sagte ein kleines Kind, das den Umzug beobachtete, unschuldig: 'Aber er hat ja gar nichts an!'. Sein Vater versuchte, es zum Schweigen zu bringen, aber das Geflüster breitete sich aus. 'Ein Kind sagt, er hat nichts an!'. Am Ende rief das ganze Volk: 'Er hat ja gar nichts an!'. Der Kaiser schauderte, denn er ahnte, dass sie recht hatten, aber er dachte: 'Ich muss es bis zum Ende durchhalten'. Und er ging stolzer als je zuvor weiter." },
            { text: "Die Kammerherren trugen weiterhin die unsichtbare Schleppe, die nicht existierte, und der Umzug nahm seinen Lauf. Und so wurden die Eitelkeit des Kaisers und die Angst der Menschen, die Wahrheit zu sagen, dank der Aufrichtigkeit eines Kindes bloßgestellt." }
        ]
    },
    {
        id: 'cigarra-y-hormiga',
        title: 'La Cigarra y la Hormiga',
        titleEn: 'The Ant and the Grasshopper',
        titleFr: 'La Cigale et la Fourmi',
        titleDe: 'Die Ameise und die Heuschrecke',
        author: 'Esopo / La Fontaine',
        description: 'Una fábula atemporal sobre el valor del trabajo duro y la previsión frente a la despreocupación.',
        descriptionEn: 'A timeless fable about the value of hard work and foresight versus carelessness.',
        descriptionFr: 'Une fable intemporelle sur la valeur du travail acharné et de la prévoyance face à l\'insouciance.',
        descriptionDe: 'Eine zeitlose Fabel über den Wert harter Arbeit und Voraussicht gegenüber Sorglosigkeit.',
        level: 'Fácil',
        age: '4+',
        coverImage: '/images/storyteller/cigarra-hormiga-cover.png',
        chipImage: '/images/storyteller/character-cigarra-hormiga.png',
        genre: 'Fábula',
        themeColor: 'from-green-500 to-lime-600',
        rating: 4.5,
        content: [
            { text: "Durante un verano caluroso y resplandeciente, el campo estaba lleno de vida. Mientras todos los animales buscaban sombra, una Cigarra cantaba felizmente posada en la rama de un árbol. No tenía otra preocupación que disfrutar del sol y de su propia música. '¡Qué hermosa es la vida!', cantaba la Cigarra, '¡Tra-la-la, tra-la-la!'." },
            { text: "Debajo del árbol, una fila de Hormigas marchaba laboriosamente. Llevaban pesadas semillas y granos de trigo hacia su hormiguero. Iban y venían sin descanso, bajo el sol abrasador. La Cigarra las miró con burla y le dijo a una de ellas: '¡Eh, pequeña amiga! ¿Por qué trabajas tanto con este calor? ¡Deja eso y ven a cantar conmigo!'." },
            { text: "La Hormiga se detuvo un momento, se secó el sudor de la frente y respondió: 'Estoy guardando comida para el invierno. Cuando llegue el frío y la nieve, no habrá nada que comer en el campo. Te aconsejo que hagas lo mismo'. La Cigarra soltó una carcajada: '¿Invierno? ¡Falta mucho para el invierno! Ahora hay comida de sobra por todas partes. Yo prefiero disfrutar el momento'." },
            { text: "Y así pasó el verano. La Hormiga siguió trabajando día tras día, llenando su despensa, mientras la Cigarra seguía cantando y durmiendo, burlándose del esfuerzo de su vecina. Luego llegó el otoño, las hojas cayeron y el viento se volvió fresco. La Cigarra sintió un poco de frío, pero siguió sin preocuparse, pensando que siempre encontraría algo." },
            { text: "Pero finalmente, el invierno llegó con toda su dureza. La nieve cubrió los campos con un manto blanco y espeso. El sol ya no calentaba y no quedaba ni una hoja verde, ni una sola semilla a la vista. La Cigarra, temblando de frío y con el estómago vacío, vagaba por el campo buscando desesperadamente algo que comer, pero no hallaba nada." },
            { text: "Entonces se acordó de la Hormiga y se dirigió a su hormiguero. Llamó a la puerta con sus patas heladas. La Hormiga abrió, calentita y bien alimentada desde dentro de su hogar confortable. '¿Qué quieres, vecina?', preguntó la Hormiga. 'Tengo frío y hambre', gimió la Cigarra, 'por favor, dame algo de comer, te lo devolveré cuando llegue el verano'." },
            { text: "La Hormiga la miró con severidad y preguntó: '¿Y qué hiciste tú durante todo el verano cuando yo trabajaba sin parar?'. 'Yo... yo cantaba', respondió la Cigarra bajando la cabeza. 'Cantaba para alegrar al mundo'. '¿Cantabas?', repuso la Hormiga. 'Pues si cantaste en verano, ¡ahora baila durante el invierno!'." },
            { text: "Y cerró la puerta. La Cigarra comprendió entonces su error. Había despreciado el trabajo y la previsión, y ahora pagaba las consecuencias. Aunque dicen que la Hormiga, en el fondo no tan cruel, volvió a abrir un poco la puerta para darle unos pocos granos, los suficientes para sobrevivir, pero con la lección bien aprendida: hay un tiempo para trabajar y un tiempo para divertirse, y quien no siembra, no cosecha." }
        ],
        contentEn: [
            { text: "During a hot and resplendent summer, the countryside was full of life. While all the animals sought shade, a Grasshopper sang happily perched on a tree branch. He had no other worry than enjoying the sun and his own music. 'How beautiful life is!', sang the Grasshopper, 'Tra-la-la, tra-la-la!'." },
            { text: "Under the tree, a line of Ants marched laboriously. They carried heavy seeds and grains of wheat towards their anthill. They went back and forth tirelessly, under the scorching sun. The Grasshopper looked at them mockingly and said to one of them: 'Hey, little friend! Why do you work so hard in this heat? Leave that and come sing with me!'." },
            { text: "The Ant stopped for a moment, wiped the sweat from its forehead and replied: 'I am storing food for the winter. When the cold and snow arrive, there will be nothing to eat in the fields. I advise you to do the same'. The Grasshopper laughed out loud: 'Winter? Winter is a long way off! Now there is plenty of food everywhere. I prefer to enjoy the moment'." },
            { text: "And so the summer passed. The Ant continued working day after day, filling its pantry, while the Grasshopper continued singing and sleeping, mocking its neighbor's effort. Then autumn came, the leaves fell and the wind turned cool. The Grasshopper felt a little cold, but still didn't worry, thinking he would always find something." },
            { text: "But finally, winter arrived with all its harshness. The snow covered the fields with a thick white blanket. The sun no longer warmed and there was not a green leaf, nor a single seed in sight. The Grasshopper, trembling with cold and with an empty stomach, wandered through the fields desperately looking for something to eat, but found nothing." },
            { text: "Then he remembered the Ant and went to its anthill. He knocked on the door with his frozen legs. The Ant opened, warm and well-fed from inside its comfortable home. 'What do you want, neighbor?', asked the Ant. 'I am cold and hungry', moaned the Grasshopper, 'please, give me something to eat, I will pay you back when summer comes'." },
            { text: "The Ant looked at him sternly and asked: 'And what did you do all summer when I was working non-stop?'. 'I... I sang', replied the Grasshopper lowering his head. 'I sang to cheer up the world'. 'You sang?', replied the Ant. 'Well, if you sang in the summer, now dance during the winter!'." },
            { text: "And it closed the door. The Grasshopper then understood his mistake. He had despised work and foresight, and now he was paying the consequences. Although they say that the Ant, deep down not so cruel, opened the door a little again to give him a few grains, enough to survive, but with the lesson well learned: there is a time to work and a time to have fun, and he who does not sow, does not reap." }
        ],
        contentFr: [
            { text: "Durant un été chaud et resplendissant, la campagne était pleine de vie. Alors que tous les animaux cherchaient l'ombre, une Cigale chantait joyeusement perchée sur la branche d'un arbre. Elle n'avait d'autre souci que de profiter du soleil et de sa propre musique. 'Que la vie est belle !', chantait la Cigale, 'Tra-la-la, tra-la-la !'." },
            { text: "Sous l'arbre, une file de Fourmis marchait laborieusement. Elles portaient de lourdes graines et des grains de blé vers leur fourmilière. Elles allaient et venaient sans relâche, sous le soleil brûlant. La Cigale les regarda avec moquerie et dit à l'une d'elles : 'Hé, petite amie ! Pourquoi travailles-tu tant avec cette chaleur ? Laisse ça et viens chanter avec moi !'." },
            { text: "La Fourmi s'arrêta un instant, essuya la sueur de son front et répondit : 'Je garde de la nourriture pour l'hiver. Quand le froid et la neige arriveront, il n'y aura plus rien à manger dans les champs. Je te conseille de faire de même'. La Cigale éclata de rire : 'L'hiver ? L'hiver est encore loin ! Maintenant, il y a de la nourriture à profusion partout. Je préfère profiter du moment'." },
            { text: "Et ainsi passa l'été. La Fourmi continua de travailler jour après jour, remplissant son garde-manger, tandis que la Cigale continuait de chanter et de dormir, se moquant de l'effort de sa voisine. Puis l'automne arriva, les feuilles tombèrent et le vent devint frais. La Cigale eut un peu froid, mais ne s'inquiéta toujours pas, pensant qu'elle trouverait toujours quelque chose." },
            { text: "Mais finalement, l'hiver arriva avec toute sa rudesse. La neige couvrit les champs d'un épais manteau blanc. Le soleil ne chauffait plus et il n'y avait plus une feuille verte, ni une seule graine en vue. La Cigale, tremblant de froid et l'estomac vide, erra dans les champs cherchant désespérément quelque chose à manger, mais ne trouva rien." },
            { text: "Alors elle se souvint de la Fourmi et se dirigea vers sa fourmilière. Elle frappa à la porte avec ses pattes gelées. La Fourmi ouvrit, bien au chaud et bien nourrie de l'intérieur de sa maison confortable. 'Que veux-tu, voisine ?', demanda la Fourmi. 'J'ai froid et faim', gémit la Cigale, 's'il te plaît, donne-moi quelque chose à manger, je te le rendrai quand l'été viendra'." },
            { text: "La Fourmi la regarda sévèrement et demanda : 'Et qu'as-tu fait pendant tout l'été quand je travaillais sans arrêt ?'. 'Je... je chantais', répondit la Cigale en baissant la tête. 'Je chantais pour égayer le monde'. 'Tu chantais ?', répliqua la Fourmi. 'Eh bien, si tu chantais en été, maintenant danse pendant l'hiver !'." },
            { text: "Et elle ferma la porte. La Cigale comprit alors son erreur. Elle avait méprisé le travail et la prévoyance, et maintenant elle en payait les conséquences. Bien qu'on dise que la Fourmi, au fond pas si cruelle, rouvrit un peu la porte pour lui donner quelques grains, assez pour survivre, mais avec la leçon bien apprise : il y a un temps pour travailler et un temps pour s'amuser, et qui ne sème pas, ne récolte pas." }
        ],
        contentDe: [
            { text: "Während eines heißen und strahlenden Sommers war das Land voller Leben. Während alle Tiere Schatten suchten, sang eine Grille fröhlich auf dem Ast eines Baumes. Sie hatte keine andere Sorge, als die Sonne und ihre eigene Musik zu genießen. 'Wie schön das Leben ist!', sang die Grille, 'Tra-la-la, tra-la-la!'." },
            { text: "Unter dem Baum marschierte mühsam eine Reihe von Ameisen. Sie trugen schwere Samen und Weizenkörner zu ihrem Ameisenhügel. Sie gingen unermüdlich hin und her, unter der brennenden Sonne. Die Grille sah sie spöttisch an und sagte zu einer von ihnen: 'Hey, kleine Freundin! Warum arbeitest du so hart bei dieser Hitze? Lass das und komm sing mit mir!'." },
            { text: "Die Ameise hielt einen Moment inne, wischte sich den Schweiß von der Stirn und antwortete: 'Ich lagere Nahrung für den Winter. Wenn die Kälte und der Schnee kommen, wird es auf den Feldern nichts mehr zu essen geben. Ich rate dir, dasselbe zu tun'. Die Grille lachte laut: 'Winter? Bis zum Winter ist es noch lange hin! Jetzt gibt es überall Nahrung im Überfluss. Ich ziehe es vor, den Moment zu genießen'." },
            { text: "Und so verging der Sommer. Die Ameise arbeitete Tag für Tag weiter und füllte ihre Vorratskammer, während die Grille weiter sang und schlief und sich über die Mühe ihrer Nachbarin lustig machte. Dann kam der Herbst, die Blätter fielen und der Wind wurde kühl. Der Grille wurde etwas kalt, aber sie machte sich immer noch keine Sorgen, da sie dachte, sie würde immer etwas finden." },
            { text: "Aber schließlich kam der Winter mit aller Härte. Der Schnee bedeckte die Felder mit einer dicken weißen Decke. Die Sonne wärmte nicht mehr und es war kein grünes Blatt und kein einziger Samen in Sicht. Die Grille, zitternd vor Kälte und mit leerem Magen, irrte durch die Felder und suchte verzweifelt nach etwas zu essen, fand aber nichts." },
            { text: "Da erinnerte sie sich an die Ameise und ging zu ihrem Ameisenhügel. Sie klopfte mit ihren gefrorenen Beinen an die Tür. Die Ameise öffnete, warm und gut genährt aus dem Inneren ihres gemütlichen Heims. 'Was willst du, Nachbarin?', fragte die Ameise. 'Ich friere und habe Hunger', stöhnte die Grille, 'bitte, gib mir etwas zu essen, ich werde es dir zurückzahlen, wenn der Sommer kommt'." },
    ...
    },
    {
        ...
        contentEn: [
            ...
            { text: "His mother, the old Queen, always told him: 'My son, you must marry a real princess. Not a duchess, nor a countess, but a princess of royal blood, as delicate as a flower'." },
            { text: "The prince, determined to find his beloved, set out on a long journey through the entire known world. He visited kingdoms in the north, south, east, and west." },
            { text: "In every place he found beautiful, intelligent, and charming princesses. But the prince was very demanding and observant, and he always found some detail that made him doubt." },
            { text: "One laughed too loudly, another ate with strange manners, and another didn't seem to know how to behave at court. 'Are they real princesses?', he always wondered sadly." },
            { text: "After a whole year of fruitless searching, he returned to his castle crestfallen. 'There are plenty of princesses', he told his father the King, 'but none seem to be a real princess'." },
            { text: "One night, while the royal family was dining, a frightful storm broke out. The thunder roared like angry lions and the lightning illuminated the dark sky." },
            { text: "The rain poured down in buckets, beating mercilessly against the castle windows. It was a night to be safe by the fire, and no one in their right mind would go outside." },
            { text: "Suddenly, weak knocks were heard on the great castle gate. The old King, puzzled, rose from his throne, took a candelabra, and went to open it himself." },
            { text: "There, under the torrential rain, stood a young girl. But good heavens, what a sight the poor thing was! She was completely soaked and shivering with cold." },
            { text: "Water streamed down her messy hair and ruined silk dress. It ran in at the points of her broken shoes and out at the heels. She looked like a vagabond." },
            { text: "'I am a princess', said the young woman with a firm voice despite her chattering teeth. 'A real princess who has got lost in the storm, please give me shelter'." },
            { text: "'We shall see', thought the old Queen, who had arrived behind the King. She said nothing aloud, but smiled cunningly and ordered the servants to prepare a room." },
            { text: "The Queen went to the guest bedroom, took all the bedding off the bedstead, and placed a small, hard green pea right in the center of the wooden slats." },
            { text: "Then, she ordered twenty thick wool mattresses to be brought and piled them one on top of the other, on top of the pea. And on top of the mattresses, she put twenty eider-down feather beds, soft and fluffy." },
            { text: "That was a very high bed, it almost reached the ceiling. 'Here our guest will sleep tonight', said the Queen. The young princess had to use a ladder to climb to the very top." },
            { text: "The next morning, during breakfast, the royal family politely asked her how she had spent the night. The young woman had dark circles under her eyes and looked very tired." },
            { text: "'Oh, terribly bad!', exclaimed the princess truthfully. 'I have scarcely been able to close my eyes all night. Heaven knows what was in that bed!'." },
            { text: "'I have been lying on something so hard and annoying that I am black and blue all over my body. It is the most uncomfortable bed I have ever slept in!', she complained." },
            { text: "The King, the Queen, and the Prince looked at each other in amazement. Only a real princess could have skin so delicate and sensitive as to feel a pea through twenty mattresses and twenty eider-down beds!" },
            { text: "The Prince then knew he had found what he was looking for. They married with a great party and lived happily. And the pea was taken to the Royal Museum, where it may still be seen, unless someone has taken it." }
        ],
        contentFr: [
            { text: "Il était une fois un jeune prince qui vivait dans un royaume lointain et splendide. Comme tous les princes des contes de fées, son plus grand souhait était de se marier, mais pas avec n'importe qui." },
            { text: "Sa mère, la vieille Reine, lui disait toujours : 'Mon fils, tu dois épouser une vraie princesse. Pas une duchesse, ni une comtesse, mais une princesse de sang royal, aussi délicate qu'une fleur'." },
            { text: "Le prince, décidé à trouver sa bien-aimée, entreprit un long voyage à travers tout le monde connu. Il visita des royaumes au nord, au sud, à l'est et à l'ouest." },
            { text: "Partout il trouvait des princesses belles, intelligentes et charmantes. Mais le prince était très exigeant et observateur, et il trouvait toujours un détail qui le faisait douter." },
            { text: "L'une riait trop fort, une autre mangeait avec des manières étranges, et une autre ne semblait pas savoir se comporter à la cour. 'Sont-elles de vraies princesses ?', se demandait-il toujours avec tristesse." },
            { text: "Après une année entière de recherche infructueuse, il retourna à son château l'air penaud. 'Il y a beaucoup de princesses', dit-il à son père le Roi, 'mais aucune ne semble être une vraie princesse'." },
            { text: "Une nuit, alors que la famille royale dînait, un orage effroyable éclata. Le tonnerre grondait comme des lions furieux et les éclairs illuminaient le ciel sombre." },
            { text: "La pluie tombait à verse, frappant sans pitié les fenêtres du château. C'était une nuit pour être à l'abri près du feu, et personne de sensé ne sortirait dehors." },
            { text: "Soudain, on entendit des coups faibles à la grande porte du château. Le vieux Roi, intrigué, se leva de son trône, prit un chandelier et alla ouvrir lui-même." },
            { text: "Là, sous la pluie torrentielle, se tenait une jeune fille. Mais grand Dieu, de quoi la pauvre avait-elle l'air ! Elle était complètement trempée et tremblait de froid." },
            { text: "L'eau ruisselait de ses cheveux en désordre et de sa robe de soie abîmée. Elle entrait par la pointe de ses chaussures cassées et sortait par les talons. Elle ressemblait à une vagabonde." },
            { text: "'Je suis une princesse', dit la jeune femme d'une voix ferme bien qu'elle claquât des dents. 'Une vraie princesse qui s'est perdue dans la tempête, s'il vous plaît, donnez-moi un abri'." },
            { text: "'C'est ce que nous verrons', pensa la vieille Reine, qui était arrivée derrière le Roi. Elle ne dit rien à voix haute, mais sourit avec ruse et ordonna aux serviteurs de préparer une chambre." },
            { text: "La Reine alla dans la chambre d'amis, retira toute la literie du lit et plaça un petit pois vert et dur juste au centre du sommier en bois." },
            { text: "Ensuite, elle ordonna d'apporter vingt matelas de laine épaisse et les empila les uns sur les autres, par-dessus le petit pois. Et sur les matelas, elle mit vingt édredons de plumes d'eider, doux et moelleux." },
            { text: "C'était un lit très haut, il atteignait presque le plafond. 'C'est ici que notre invitée dormira ce soir', dit la Reine. La jeune princesse dut utiliser une échelle pour grimper tout en haut." },
            { text: "Le lendemain matin, au petit-déjeuner, la famille royale lui demanda poliment comment elle avait passé la nuit. La jeune femme avait des cernes et semblait très fatiguée." },
            { text: "'Oh, terriblement mal !', s'exclama la princesse avec sincérité. 'J'ai à peine pu fermer l'œil de la nuit. Dieu sait ce qu'il y avait dans ce lit !'." },
            { text: "'J'ai été couchée sur quelque chose de si dur et gênant que j'ai des bleus sur tout le corps. C'est le lit le plus inconfortable dans lequel j'ai jamais dormi !', se plaignit-elle." },
            { text: "Le Roi, la Reine et le Prince se regardèrent avec étonnement. Seule une vraie princesse pouvait avoir une peau si délicate et sensible pour sentir un petit pois à travers vingt matelas et vingt édredons !" },
            { text: "Le Prince sut alors qu'il avait trouvé ce qu'il cherchait. Ils se marièrent avec une grande fête et vécurent heureux. Et le petit pois fut porté au Musée Royal, où l'on peut encore le voir, à moins que quelqu'un ne l'ait pris." }
        ],
        contentDe: [
            { text: "Es war einmal ein junger Prinz, der in einem fernen und prächtigen Königreich lebte. Wie alle Prinzen in Märchen war sein größter Wunsch zu heiraten, aber nicht irgendwen." },
            { text: "Seine Mutter, die alte Königin, sagte ihm immer: 'Mein Sohn, du musst eine richtige Prinzessin heiraten. Keine Herzogin, keine Grafin, sondern eine Prinzessin von königlichem Blut, so zart wie eine Blume'." },
            { text: "Der Prinz, entschlossen, seine Geliebte zu finden, begab sich auf eine lange Reise durch die ganze bekannte Welt. Er besuchte Königreiche im Norden, Süden, Osten und Westen." },
            { text: "Überall fand er schöne, kluge und charmante Prinzessinnen. Aber der Prinz war sehr anspruchsvoll und aufmerksam, und er fand immer ein Detail, das ihn zweifeln ließ." },
            { text: "Eine lachte zu laut, eine andere aß mit seltsamen Manieren, und eine andere schien nicht zu wissen, wie man sich bei Hofe verhält. 'Sind sie wirkliche Prinzessinnen?', fragte er sich immer traurig." },
            { text: "Nach einem ganzen Jahr vergeblicher Suche kehrte er niedergeschlagen in sein Schloss zurück. 'Es gibt viele Prinzessinnen', sagte er zu seinem Vater, dem König, 'aber keine scheint eine richtige Prinzessin zu sein'." },
            { text: "Eines Abends, als die königliche Familie zu Abend aß, brach ein schrecklicher Sturm los. Der Donner brüllte wie wütende Löwen und die Blitze erhellten den dunklen Himmel." },
            { text: "Der Regen goss in Strömen und schlug gnadenlos gegen die Schlossfenster. Es war eine Nacht, um sicher am Feuer zu sein, und niemand, der bei Verstand war, würde nach draußen gehen." },
            { text: "Plötzlich hörte man schwaches Klopfen am großen Schlosstor. Der alte König, verwundert, erhob sich von seinem Thron, nahm einen Kerzenleuchter und ging, um selbst zu öffnen." },
            { text: "Dort, im strömenden Regen, stand ein junges Mädchen. Aber Gott, wie sah das arme Ding aus! Sie war völlig durchnässt und zitterte vor Kälte." },
            { text: "Das Wasser lief ihr von den zerzausten Haaren und dem ruinierten Seidenkleid herab. Es lief in die Spitzen ihrer kaputten Schuhe hinein und aus den Fersen wieder heraus. Sie sah aus wie eine Landstreicherin." },
            { text: "'Ich bin eine Prinzessin', sagte die junge Frau mit fester Stimme, obwohl sie mit den Zähnen klapperte. 'Eine wirkliche Prinzessin, die sich im Sturm verirrt hat, bitte gebt mir Unterschlupf'." },
            { text: "'Das werden wir ja sehen', dachte die alte Königin, die hinter dem König angekommen war. Sie sagte nichts laut, lächelte aber listig und befahl den Dienern, ein Zimmer vorzubereiten." },
            { text: "Die Königin ging ins Gästezimmer, nahm alles Bettzeug vom Bettgestell und legte eine kleine, harte grüne Erbse genau in die Mitte des Lattenrosts." },
            { text: "Dann befahl sie, zwanzig dicke Wollmatratzen zu bringen und stapelte sie eine auf die andere, auf die Erbse. Und auf die Matratzen legte sie zwanzig Eideraunendecken, weich und flauschig." },
            { text: "Das war ein sehr hohes Bett, es reichte fast bis zur Decke. 'Hier wird unser Gast heute Nacht schlafen', sagte die Königin. Die junge Prinzessin musste eine Leiter benutzen, um ganz nach oben zu klettern." },
            { text: "Am nächsten Morgen beim Frühstück fragte die königliche Familie sie höflich, wie sie die Nacht verbracht habe. Die junge Frau hatte Augenringe und sah sehr müde aus." },
            { text: "'Oh, entsetzlich schlecht!', rief die Prinzessin wahrheitsgemäß aus. 'Ich habe fast die ganze Nacht kein Auge zutun können. Gott weiß, was in dem Bett war!'." },
            { text: "'Ich habe auf etwas so Hartem und Störendem gelegen, dass ich am ganzen Körper braun und blau bin. Es ist das unbequemste Bett, in dem ich je geschlafen habe!', klagte sie." },
            { text: "Der König, die Königin und der Prinz sahen sich erstaunt an. Nur eine wirkliche Prinzessin konnte eine so zarte und empfindliche Haut haben, um eine Erbse durch zwanzig Matratzen und zwanzig Eideraunendecken zu spüren!" },
            { text: "Da wusste der Prinz, dass er gefunden hatte, was er suchte. Sie heirateten mit einem großen Fest und lebten glücklich. Und die Erbse wurde ins Königliche Museum gebracht, wo sie noch zu sehen ist, wenn sie niemand gestohlen hat." }
        ]
    },
    {
        id: 'tortuga-liebre',
        ...
        rating: 4.7,
        content: [
            { text: "En un bosque verde y frondoso vivía una Liebre que era famosa por dos cosas: sus largas orejas y su increíble velocidad al correr.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Lamentablemente, también era conocida por ser muy presumida. 'Soy el animal más rápido del mundo', repetía a quien quisiera escucharla, 'Nadie puede vencerme'.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Un día, se encontró con la Tortuga, que caminaba despacito con su pesado caparazón. La Liebre soltó una carcajada burlona: '¡Eh, tú! ¡Cuidado no te vayas a marear de tanta velocidad!'.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "La Tortuga, tranquila y paciente, se detuvo, le sonrió y dijo: 'Puede que sea lenta, amiga Liebre, pero quizá llegue a la meta antes que tú si corremos una carrera'.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "La Liebre se tiró al suelo de la risa, pataleando. '¿Tú? ¿Ganarme a mí? ¡Es el chiste más gracioso que he oído! ¡Acepto el reto encantada!'.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "La Zorra, que era muy sabia, fue elegida como jueza. Señaló un camino largo a través del bosque, cruzando el puente, hasta llegar al viejo roble en la colina.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Todos los animales del bosque se reunieron para ver el espectáculo. A la señal de '¡Preparados, listos, YA!', la Liebre salió disparada levantando una nube de polvo.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "En un abrir y cerrar de ojos, la Liebre ya estaba muy lejos. Se detuvo, miró hacia atrás y ni siquiera podía ver a la pequeña Tortuga en la distancia.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "'Esto es demasiado fácil', pensó la Liebre con arrogancia. 'Tengo tiempo de sobra para ganar'. Así que se detuvo a desayunar unos tréboles jugosos en el prado.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Después de comer, sintió un poco de sueño. Vio un árbol con una sombra perfecta y fresca, y decidió echarse una siestecita. 'La Tortuga tardará siglos en llegar hasta aquí', se dijo bostezando.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Mientras la Liebre roncaba ruidosamente, la Tortuga seguía avanzando. Pasito a pasito. Despacio. Sin correr, pero sin detenerse jamás, bajo el calor del sol.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Pasaron las horas. La Tortuga, cansada pero decidida, pasó silenciosamente junto a la Liebre dormida, que soñaba con medallas de oro y aplausos.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Poco a poco, con mucho esfuerzo y constancia, la Tortuga se fue acercando a la línea de meta. Los animales del bosque empezaron a murmurar emocionados al verla llegar.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "De repente, la Liebre se despertó sobresaltada por los murmullos. El sol ya estaba bajando en el cielo. Miró hacia la meta y... ¡vio a la Tortuga a solo unos pasos del final!", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "La Liebre saltó horrorizada y corrió más rápido que nunca en su vida, sus patas volaban sobre la hierba, sus orejas iban hacia atrás por el viento.", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "Pero ya era demasiado tarde. La Tortuga estiró su cuello y cruzó la línea de meta justo un segundo antes de que la Liebre llegara jadeando. ¡La Tortuga había ganado!", image: '/images/storyteller/tortuga-liebre-cover.png' },
            { text: "La Liebre, avergonzada y cabizbaja, aprendió la lección ese día ante todos: No hay que burlarse de los demás, y a veces, despacio pero seguro se llega lejos y se gana la carrera.", image: '/images/storyteller/tortuga-liebre-cover.png' }
        ],
        contentEn: [
            { text: "In a green and lush forest lived a Hare who was famous for two things: his long ears and his incredible running speed." },
            { text: "Unfortunately, he was also known for being very boastful. 'I am the fastest animal in the world,' he repeated to anyone who would listen, 'No one can beat me'." },
            { text: "One day, he met the Tortoise, who was walking slowly with his heavy shell. The Hare let out a mocking laugh: 'Hey, you! Watch out you don't get dizzy from so much speed!'." },
            { text: "The Tortoise, calm and patient, stopped, smiled at him and said: 'I may be slow, friend Hare, but perhaps I will reach the finish line before you if we race'." },
            { text: "The Hare threw himself on the ground laughing, kicking his legs. 'You? Beat me? That's the funniest joke I've ever heard! I accept the challenge with pleasure!'." },
            { text: "The Fox, who was very wise, was chosen as the judge. She pointed out a long path through the forest, crossing the bridge, up to the old oak tree on the hill." },
            { text: "All the animals in the forest gathered to watch the spectacle. At the signal of 'Ready, set, GO!', the Hare shot off raising a cloud of dust." },
            { text: "In the blink of an eye, the Hare was already far away. He stopped, looked back, and couldn't even see the little Tortoise in the distance." },
            { text: "'This is too easy,' thought the Hare arrogantly. 'I have plenty of time to win.' So he stopped to eat some juicy clovers in the meadow." },
            { text: "After eating, he felt a little sleepy. He saw a tree with perfect cool shade and decided to take a little nap. 'The Tortoise will take centuries to get here,' he said yawning." },
            { text: "While the Hare snored loudly, the Tortoise kept moving forward. Step by step. Slowly. Without running, but never stopping, under the heat of the sun." },
            { text: "Hours passed. The Tortoise, tired but determined, passed silently by the sleeping Hare, who was dreaming of gold medals and applause." },
            { text: "Little by little, with great effort and consistency, the Tortoise got closer to the finish line. The forest animals began to murmur excitedly seeing him arrive." },
            { text: "Suddenly, the Hare woke up startled by the murmurs. The sun was already setting in the sky. He looked towards the finish line and... saw the Tortoise just a few steps from the end!" },
            { text: "The Hare jumped up horrified and ran faster than ever in his life, his legs flying over the grass, his ears pinned back by the wind." },
            { text: "But it was too late. The Tortoise stretched his neck and crossed the finish line just a second before the Hare arrived panting. The Tortoise had won!" },
            { text: "The Hare, ashamed and crestfallen, learned the lesson that day in front of everyone: You shouldn't make fun of others, and sometimes, slow and steady goes far and wins the race." }
        ],
        contentFr: [
            { text: "Dans une forêt verte et luxuriante vivait un Lièvre célèbre pour deux choses : ses longues oreilles et son incroyable vitesse de course." },
            { text: "Malheureusement, il était aussi connu pour être très vantard. 'Je suis l'animal le plus rapide du monde', répétait-il à qui voulait l'entendre, 'Personne ne peut me battre'." },
            { text: "Un jour, il rencontra la Tortue, qui marchait tout doucement avec sa lourde carapace. Le Lièvre éclata d'un rire moqueur : 'Hé, toi ! Attention à ne pas avoir le vertige avec tant de vitesse !'." },
            { text: "La Tortue, calme et patiente, s'arrêta, lui sourit et dit : 'Je suis peut-être lente, ami Lièvre, mais peut-être que j'arriverai à l'arrivée avant toi si nous faisons la course'." },
            { text: "Le Lièvre se jeta par terre de rire, donnant des coups de pied. 'Toi ? Me battre ? C'est la blague la plus drôle que j'ai jamais entendue ! J'accepte le défi avec plaisir !'." },
            { text: "Le Renard, qui était très sage, fut choisi comme juge. Il indiqua un long chemin à travers la forêt, traversant le pont, jusqu'au vieux chêne sur la colline." },
            { text: "Tous les animaux de la forêt se rassemblèrent pour voir le spectacle. Au signal 'À vos marques, prêts, PARTEZ !', le Lièvre partit en flèche en soulevant un nuage de poussière." },
            { text: "En un clin d'œil, le Lièvre était déjà loin. Il s'arrêta, regarda en arrière et ne pouvait même pas voir la petite Tortue au loin." },
            { text: "'C'est trop facile', pensa le Lièvre avec arrogance. 'J'ai largement le temps de gagner'. Alors il s'arrêta pour déjeuner quelques trèfles juteux dans le pré." },
            { text: "Après avoir mangé, il eut un peu sommeil. Il vit un arbre avec une ombre parfaite et fraîche, et décida de faire une petite sieste. 'La Tortue mettra des siècles à arriver ici', se dit-il en bâillant." },
            { text: "Pendant que le Lièvre ronflait bruyamment, la Tortue continuait d'avancer. Pas à pas. Doucement. Sans courir, mais sans jamais s'arrêter, sous la chaleur du soleil." },
            { text: "Les heures passèrent. La Tortue, fatiguée mais déterminée, passa silencieusement à côté du Lièvre endormi, qui rêvait de médailles d'or et d'applaudissements." },
            { text: "Peu à peu, avec beaucoup d'effort et de constance, la Tortue se rapprocha de la ligne d'arrivée. Les animaux de la forêt commencèrent à murmurer avec excitation en la voyant arriver." },
            { text: "Soudain, le Lièvre se réveilla en sursaut à cause des murmures. Le soleil se couchait déjà dans le ciel. Il regarda vers l'arrivée et... vit la Tortue à seulement quelques pas de la fin !" },
            { text: "Le Lièvre bondit horrifié et courut plus vite que jamais de sa vie, ses pattes volant sur l'herbe, ses oreilles plaquées en arrière par le vent." },
            { text: "Mais c'était trop tard. La Tortue étira son cou et franchit la ligne d'arrivée juste une seconde avant que le Lièvre n'arrive haletant. La Tortue avait gagné !" },
            { text: "Le Lièvre, honteux et l'air penaud, apprit la leçon ce jour-là devant tout le monde : Il ne faut pas se moquer des autres, et parfois, doucement mais sûrement on va loin et on gagne la course." }
        ],
        contentDe: [
            { text: "In einem grünen und üppigen Wald lebte ein Hase, der für zwei Dinge berühmt war: seine langen Ohren und seine unglaubliche Laufgeschwindigkeit." },
            { text: "Leider war er auch dafür bekannt, sehr prahlerisch zu sein. 'Ich bin das schnellste Tier der Welt', wiederholte er jedem, der es hören wollte, 'Niemand kann mich schlagen'." },
            { text: "Eines Tages traf er die Schildkröte, die ganz langsam mit ihrem schweren Panzer ging. Der Hase lachte spöttisch: 'Hey, du! Pass auf, dass dir bei so viel Geschwindigkeit nicht schwindelig wird!'." },
            { text: "Die Schildkröte, ruhig und geduldig, blieb stehen, lächelte ihn an und sagte: 'Ich mag langsam sein, Freund Hase, aber vielleicht komme ich vor dir ins Ziel, wenn wir ein Rennen laufen'." },
            { text: "Der Hase warf sich lachend auf den Boden und strampelte mit den Beinen. 'Du? Mich schlagen? Das ist der lustigste Witz, den ich je gehört habe! Ich nehme die Herausforderung gerne an!'." },
            { text: "Der Fuchs, der sehr weise war, wurde als Richter ausgewählt. Er zeigte einen langen Weg durch den Wald, über die Brücke, bis zur alten Eiche auf dem Hügel." },
            { text: "Alle Tiere des Waldes versammelten sich, um das Spektakel zu sehen. Auf das Signal 'Auf die Plätze, fertig, LOS!', schoss der Hase davon und wirbelte eine Staubwolke auf." },
            { text: "Im Handumdrehen war der Hase schon weit weg. Er hielt an, schaute zurück und konnte die kleine Schildkröte in der Ferne nicht einmal sehen." },
            { text: "'Das ist zu einfach', dachte der Hase arrogant. 'Ich habe jede Menge Zeit, um zu gewinnen.' Also hielt er an, um ein paar saftige Klee auf der Wiese zu frühstücken." },
            { text: "Nach dem Essen wurde er etwas schläfrig. Er sah einen Baum mit perfektem kühlen Schatten und beschloss, ein kleines Nickerchen zu machen. 'Die Schildkröte wird Jahrhunderte brauchen, um hierher zu kommen', sagte er gähnend." },
            { text: "Während der Hase laut schnarchte, bewegte sich die Schildkröte weiter vorwärts. Schritt für Schritt. Langsam. Ohne zu rennen, aber ohne jemals anzuhalten, unter der Hitze der Sonne." },
            { text: "Stunden vergingen. Die Schildkröte, müde aber entschlossen, ging leise an dem schlafenden Hasen vorbei, der von Goldmedaillen und Applaus träumte." },
            { text: "Nach und nach, mit viel Mühe und Beständigkeit, näherte sich die Schildkröte der Ziellinie. Die Waldtiere begannen aufgeregt zu murmeln, als sie sie kommen sahen." },
            { text: "Plötzlich wachte der Hase durch das Gemurmel aufgeschreckt auf. Die Sonne ging bereits am Himmel unter. Er schaute zum Ziel und... sah die Schildkröte nur wenige Schritte vom Ende entfernt!" },
            { text: "Der Hase sprang entsetzt auf und rannte schneller als je zuvor in seinem Leben, seine Beine flogen über das Gras, seine Ohren wurden vom Wind nach hinten gedrückt." },
            { text: "Aber es war zu spät. Die Schildkröte streckte ihren Hals und überquerte die Ziellinie genau eine Sekunde, bevor der Hase keuchend ankam. Die Schildkröte hatte gewonnen!" },
            { text: "Der Hase, beschämt und niedergeschlagen, lernte an diesem Tag vor allen die Lektion: Man sollte sich nicht über andere lustig machen, und manchmal kommt man langsam aber sicher weit und gewinnt das Rennen." }
        ]
    },
    {
        id: 'cascanueces',
        ...
        rating: 4.8,
        content: [
            { text: "Era la víspera de Navidad y la mansión de la familia Stahlbaum resplandecía de luz y alegría. Fuera, la nieve caía suavemente cubriendo las calles de blanco, pero dentro todo era calidez y risas.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "En el centro del gran salón, el imponente árbol de Navidad llegaba casi hasta el techo, decorado con velas encendidas, manzanas doradas y dulces de mil colores que hacían brillar los ojos de los niños.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "El misterioso padrino Drosselmeyer llegó con su parche en el ojo y su capa oscura. Era un gran relojero y mago, y siempre traía regalos mecánicos asombrosos que se movían por sí solos.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Para Clara, su ahijada favorita, tenía algo especial este año: un Cascanueces de madera tallada con uniforme rojo de soldado y una mandíbula fuerte, aunque su sonrisa era algo triste.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Fritz, el hermano travieso de Clara, quiso probar la fuerza del muñeco y le metió una nuez demasiado dura. ¡Crac! Le rompió un diente al pobre Cascanueces, dejándolo herido.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Clara, con el corazón roto, tomó a su pequeño soldado, le vendó la mandíbula con su propia cinta de seda y lo acunó con ternura hasta dejarlo descansar en una camita bajo el árbol.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "La fiesta terminó y la casa quedó en absoluto silencio. Pero Clara no podía dormir, así que bajó de puntillas en medio de la noche para ver cómo seguía su herido amigo de madera.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "De repente, el reloj del abuelo dio las doce campanadas con un sonido profundo y extraño. Una lechuza dorada se posó sobre él y las sombras de la habitación comenzaron a alargarse.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "¡Entonces ocurrió la magia! El árbol de Navidad comenzó a crecer y crecer, más alto que la casa, convirtiéndose en un bosque gigante, y los juguetes del suelo cobraron vida propia.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "De las grietas del suelo surgieron cientos de ojos rojos y brillantes: ¡El terrible Rey de los Ratones, con sus siete cabezas coronadas, había llegado con su ejército para declarar la guerra!", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "El valiente Cascanueces saltó de su cama, desenvainó su pequeña espada y llamó a los soldados de plomo y a las muñecas para defender a Clara. ¡La batalla había comenzado!", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Los ratones eran demasiados y el Cascanueces estaba rodeado. El Rey Ratón se abalanzó sobre él, listo para acabar con el héroe de madera. ¡Todo parecía perdido!", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Pero Clara, llena de coraje, se quitó su zapatilla y la lanzó con todas sus fuerzas contra el Rey Ratón. El golpe lo derribó, distrayendo a su ejército y salvando al Cascanueces.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "En ese instante, el hechizo se rompió. El muñeco de madera desapareció y en su lugar apareció un apuesto príncipe real, que se inclinó ante Clara agradeciéndole por haberle salvado la vida.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Juntos, de la mano, viajaron a través de un bosque nevado mágico, donde los copos de nieve danzaban como hadas y el frío no se sentía, guiándolos hacia una luz brillante a lo lejos.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Llegaron finalmente al Reino de los Dulces, un lugar hecho de mazapán y caramelo. El Hada de Azúcar les dio la bienvenida y organizó un banquete de maravillas en su honor.", image: '/images/storyteller/cascanueces-cover.png' },
            { text: "Bailaron el Vals de las Flores entre aplausos y colores, y Clara se sintió la niña más feliz del universo. Pero al final, despertó bajo el árbol, con el Cascanueces en sus brazos. ¿Fue todo un sueño?", image: '/images/storyteller/cascanueces-cover.png' }
        ],
        contentEn: [
            { text: "It was Christmas Eve and the Stahlbaum family mansion glowed with light and joy. Outside, the snow fell softly covering the streets in white, but inside everything was warmth and laughter." },
            { text: "In the center of the grand drawing room, the imposing Christmas tree reached almost to the ceiling, decorated with lit candles, golden apples, and sweets of a thousand colors that made the children's eyes sparkle." },
            { text: "The mysterious Godfather Drosselmeyer arrived with his eye patch and dark cape. He was a great clockmaker and magician, and he always brought amazing mechanical gifts that moved on their own." },
            { text: "For Clara, his favorite goddaughter, he had something special this year: a Nutcracker carved from wood with a red soldier's uniform and a strong jaw, although his smile was somewhat sad." },
            { text: "Fritz, Clara's mischievous brother, wanted to test the doll's strength and shoved in a nut that was too hard. Crack! He broke a tooth of the poor Nutcracker, leaving him injured." },
            { text: "Clara, with a broken heart, took her little soldier, bandaged his jaw with her own silk ribbon, and rocked him tenderly until leaving him to rest in a small bed under the tree." },
            { text: "The party ended and the house fell into absolute silence. But Clara couldn't sleep, so she tiptoed down in the middle of the night to see how her injured wooden friend was doing." },
            { text: "Suddenly, the grandfather clock struck midnight with a deep and strange sound. A golden owl perched on top of it and the shadows in the room began to lengthen." },
            { text: "Then magic happened! The Christmas tree began to grow and grow, taller than the house, turning into a giant forest, and the toys on the floor came to life." },
            { text: "From the cracks in the floor emerged hundreds of glowing red eyes: The terrible Mouse King, with his seven crowned heads, had arrived with his army to declare war!" },
            { text: "The brave Nutcracker jumped from his bed, drew his small sword, and called the tin soldiers and dolls to defend Clara. The battle had begun!" },
            { text: "The mice were too many and the Nutcracker was surrounded. The Mouse King lunged at him, ready to finish off the wooden hero. All seemed lost!" },
            { text: "But Clara, full of courage, took off her slipper and threw it with all her might at the Mouse King. The blow knocked him down, distracting his army and saving the Nutcracker." },
            { text: "In that instant, the spell was broken. The wooden doll disappeared and in his place appeared a handsome royal prince, who bowed to Clara thanking her for saving his life." },
            { text: "Together, hand in hand, they traveled through a magical snowy forest, where snowflakes danced like fairies and the cold was not felt, guiding them towards a bright light in the distance." },
            { text: "They finally arrived at the Kingdom of Sweets, a place made of marzipan and candy. The Sugar Plum Fairy welcomed them and organized a banquet of wonders in their honor." },
            { text: "They danced the Waltz of the Flowers amidst applause and colors, and Clara felt like the happiest girl in the universe. But in the end, she woke up under the tree, with the Nutcracker in her arms. Was it all a dream?" }
        ],
        contentFr: [
            { text: "C'était la veille de Noël et le manoir de la famille Stahlbaum rayonnait de lumière et de joie. Dehors, la neige tombait doucement couvrant les rues de blanc, mais à l'intérieur tout était chaleur et rires." },
            { text: "Au centre du grand salon, l'imposant sapin de Noël atteignait presque le plafond, décoré de bougies allumées, de pommes dorées et de bonbons aux mille couleurs qui faisaient briller les yeux des enfants." },
            { text: "Le mystérieux parrain Drosselmeyer arriva avec son bandeau sur l'œil et sa cape sombre. C'était un grand horloger et magicien, et il apportait toujours des cadeaux mécaniques étonnants qui bougeaient tout seuls." },
            { text: "Pour Clara, sa filleule préférée, il avait quelque chose de spécial cette année : un Casse-Noisette sculpté en bois avec un uniforme rouge de soldat et une mâchoire forte, bien que son sourire fût quelque peu triste." },
            { text: "Fritz, le frère espiègle de Clara, voulut tester la force de la poupée et y fourra une noix trop dure. Crac ! Il cassa une dent du pauvre Casse-Noisette, le laissant blessé." },
            { text: "Clara, le cœur brisé, prit son petit soldat, banda sa mâchoire avec son propre ruban de soie et le berça tendrement jusqu'à le laisser reposer dans un petit lit sous le sapin." },
            { text: "La fête se termina et la maison tomba dans un silence absolu. Mais Clara ne pouvait pas dormir, alors elle descendit sur la pointe des pieds au milieu de la nuit pour voir comment allait son ami en bois blessé." },
            { text: "Soudain, l'horloge du grand-père sonna les douze coups de minuit avec un son profond et étrange. Une chouette dorée se percha dessus et les ombres de la pièce commencèrent à s'allonger." },
            { text: "Alors la magie opéra ! Le sapin de Noël commença à grandir et grandir, plus haut que la maison, se transformant en une forêt géante, et les jouets sur le sol prirent vie." },
            { text: "Des fentes du plancher surgirent des centaines d'yeux rouges et brillants : Le terrible Roi des Souris, avec ses sept têtes couronnées, était arrivé avec son armée pour déclarer la guerre !" },
            { text: "Le brave Casse-Noisette sauta de son lit, dégaina sa petite épée et appela les soldats de plomb et les poupées pour défendre Clara. La bataille avait commencé !" },
            { text: "Les souris étaient trop nombreuses et le Casse-Noisette était encerclé. Le Roi des Souris se jeta sur lui, prêt à en finir avec le héros de bois. Tout semblait perdu !" },
            { text: "Mais Clara, pleine de courage, enleva sa pantoufle et la lança de toutes ses forces contre le Roi des Souris. Le coup le renversa, distrayant son armée et sauvant le Casse-Noisette." },
            { text: "À cet instant, le sort fut rompu. La poupée de bois disparut et à sa place apparut un beau prince royal, qui s'inclina devant Clara en la remerciant de lui avoir sauvé la vie." },
            { text: "Ensemble, main dans la main, ils voyagèrent à travers une forêt enneigée magique, où les flocons de neige dansaient comme des fées et le froid ne se faisait pas sentir, les guidant vers une lumière brillante au loin." },
            { text: "Ils arrivèrent enfin au Royaume des Délices, un endroit fait de massepain et de bonbons. La Fée Dragée les accueillit et organisa un banquet de merveilles en leur honneur." },
            { text: "Ils dansèrent la Valse des Fleurs sous les applaudissements et les couleurs, et Clara se sentit la fille la plus heureuse de l'univers. Mais à la fin, elle se réveilla sous le sapin, avec le Casse-Noisette dans ses bras. Était-ce un rêve ?" }
        ],
        contentDe: [
            { text: "Es war Heiligabend und das Herrenhaus der Familie Stahlbaum strahlte vor Licht und Freude. Draußen fiel der Schnee sanft und bedeckte die Straßen mit Weiß, aber drinnen war alles Wärme und Gelächter." },
            { text: "In der Mitte des großen Salons reichte der imposante Weihnachtsbaum fast bis zur Decke, geschmückt mit brennenden Kerzen, goldenen Äpfeln und Süßigkeiten in tausend Farben, die die Augen der Kinder zum Leuchten brachten." },
            { text: "Der mysteriöse Pate Drosselmeyer kam mit seiner Augenklappe und seinem dunklen Umhang an. Er war ein großartiger Uhrmacher und Zauberer, und er brachte immer erstaunliche mechanische Geschenke mit, die sich von selbst bewegten." },
            { text: "Für Clara, sein liebstes Patenkind, hatte er dieses Jahr etwas Besonderes: einen aus Holz geschnitzten Nussknacker in einer roten Soldatenuniform und einem starken Kiefer, obwohl sein Lächeln etwas traurig war." },
            { text: "Fritz, Claras schelmischer Bruder, wollte die Stärke der Puppe testen und steckte eine zu harte Nuss hinein. Knack! Er brach einen Zahn des armen Nussknackers und ließ ihn verletzt zurück." },
            { text: "Clara nahm mit gebrochenem Herzen ihren kleinen Soldaten, verband seinen Kiefer mit ihrem eigenen Seidenband und wiegte ihn zärtlich, bis sie ihn in einem kleinen Bett unter dem Baum ruhen ließ." },
            { text: "Das Fest endete und das Haus fiel in absolute Stille. Aber Clara konnte nicht schlafen, also schlich sie mitten in der Nacht auf Zehenspitzen hinunter, um zu sehen, wie es ihrem verletzten hölzernen Freund ging." },
            { text: "Plötzlich schlug die Großvateruhr mit einem tiefen und seltsamen Klang Zwölf. Eine goldene Eule setzte sich darauf und die Schatten im Raum begannen sich zu verlängern." },
            { text: "Dann geschah die Magie! Der Weihnachtsbaum begann zu wachsen und zu wachsen, höher als das Haus, verwandelte sich in einen riesigen Wald, und die Spielzeuge auf dem Boden erwachten zum Leben." },
            { text: "Aus den Ritzen im Boden tauchten hunderte leuchtende rote Augen auf: Der schreckliche Mäusekönig mit seinen sieben gekrönten Köpfen war mit seiner Armee angekommen, um den Krieg zu erklären!" },
            { text: "Der tapfere Nussknacker sprang aus seinem Bett, zog sein kleines Schwert und rief die Zinnsoldaten und Puppen, um Clara zu verteidigen. Die Schlacht hatte begonnen!" },
            { text: "Die Mäuse waren zu viele und der Nussknacker war umzingelt. Der Mäusekönig stürzte sich auf ihn, bereit, dem hölzernen Helden den Garaus zu machen. Alles schien verloren!" },
            { text: "Aber Clara, voller Mut, zog ihren Pantoffel aus und warf ihn mit aller Kraft auf den Mäusekönig. Der Schlag warf ihn um, lenkte seine Armee ab und rettete den Nussknacker." },
            { text: "In diesem Augenblick war der Zauber gebrochen. Die Holzpuppe verschwand und an ihrer Stelle erschien ein schöner königlicher Prinz, der sich vor Clara verneigte und ihr dankte, dass sie ihm das Leben gerettet hatte." },
    ...
    },
    {
        ...
        chipImage: '/images/storyteller/character-casi-genio-1-color.png',
    ...
    },
    {
        ...
        chipImage: '/images/storyteller/character-casi-genio-2-color.png',
        genre: 'Aventura/Misterio',
        ...
        content: [
            {
                text: "CAPÍTULO 1: LA COMPOSICIÓN DEL DESASTRE\n\nSi hubiera sabido que mi búsqueda de la verdad me llevaría al aula de música del colegio San Bonifacio, probablemente me habría rendido en el Capítulo 1 y me habría dedicado a coleccionar sellos. El aula de música es, sin lugar a dudas, el agujero negro de la esperanza auditiva. Imagina, si tienes el valor necesario, a treinta niños de primaria intentando tocar 'El himno de la alegría' en flautas dulces de plástico a las nueve de la mañana. No es música. Es una declaración de guerra contra los tímpanos, una cacofonía que suena como un centenar de delfines resfriados pidiendo auxilio."
            },
            {
                text: "Pero el destino de un genio incomprendido no entiende de comodidades acústicas. Yo, Daniel 'El Arquitecto' Pérez, tenía una misión. Pepe, el conserje multifunción (y posiblemente agente secreto letal), nos había soltado una pista después de casi aniquilarnos con su escoba láser: las llaves del auténtico sótano, el verdadero núcleo del colegio, estaban escondidas allí. \n\n—Dani —susurró Nico, encogido a mi lado detrás de un xilófono al que le faltaban tres notas—. Si Pepe dijo que las llaves están aquí, tiene que ser una trampa. Podríamos estar comiendo el bocadillo de tortilla de mi abuela en el patio trasero, lejos del peligro. Lejos de... él."
            },
            {
                text: "Hizo un gesto con la cabeza hacia el frente del aula. Allí estaba el Sr. Solfeo. Un hombre cuya postura era tan rígida que sospechaba que tenía una batuta militar incrustada en la columna vertebral. Solfeo cree que el mundo se divide en dos tipos de personas: los que saben leer pentagramas y los salvajes que merecen ser exiliados a una isla desierta sin WiFi. Siempre llevaba una pequeña batuta de caoba asomando por el bolsillo de su americana de tweed, y un diapasón colgado del cuello que usaba para golpear las mesas cuando perdía la paciencia (lo cual ocurría aproximadamente cada catorce segundos)."
            },
            {
                text: "—Tranquilo, Nico —le aseguré, ajustándome mis gafas de montura redonda (sin graduación, pero esenciales para procesar información de alto nivel)—. Tengo un plan. El Sr. Solfeo es una criatura de hábitos. A las 11:15 exactas abandona el aula para buscar su café expreso doble con una gota de leche desnatada. Tarda exactamente siete minutos y cuarenta y dos segundos en volver. Es la ventana de oportunidad matemática perfecta."
            },
            {
                text: "CAPÍTULO 2: EL TIMBRE Y LA HUIDA DE LOS DEMENTORES MUSICALES\n\nEl timbre del recreo sonó. Parecía la campana de liberación de una prisión de máxima seguridad, si en la prisión los reclusos usaran mochilas con ruedas de la Patrulla Canina. Treinta alumnos dejaron caer sus flautas al suelo (añadiendo crujidos de plástico al suplicio auditivo) y salieron en estampida hacia la puerta, empujándose para saborear la libertad y los zumos en brik.\n\nNosotros hicimos exactamente lo opuesto. Ejecutamos la maniobra táctica 'Camuflaje Geométrico Nivel 3'. Básicamente, nos tiramos al suelo y nos arrastramos detrás del viejo armario de los panderos gigantes y los triángulos oxidados. El Sr. Solfeo suspiró, recogió sus partituras, golpeó compulsivamente su diapasón contra el marco de la puerta (¡doink!), verificó su reloj de bolsillo y asintió. \n—Siete minutos, cuarenta y dos segundos —murmuró para sí mismo, confirmando mis cálculos."
            },
            {
                text: "Salió del aula y la puerta se cerró con un clic metálico ominoso.\n\n—¡Ahora, Nico! —grité en un susurro—. Tenemos menos de ocho minutos. Empezaré por el piano de cola. Tú revisa los estuches de los violonchelos al fondo de la clase.\n\nNico dudó. \n—Dani, los estuches de violonchelo me dan mal rollo. Tienen forma de ataúd para personas con hombros muy anchos. ¿Y si hay un vampiro melómano ahí dentro?"
            },
            {
                text: "—La probabilidad de vampiros en San Bonifacio es estadísticamente inferior al 0,02%, Nico. Pero la probabilidad de que suspendamos Matemáticas si no descubrimos el complot de los profesores-robot es del 100%. ¡Muévete!\n\nMe arrastré hacia el inmenso piano de cola negro que dominaba el estrado. El Sr. Solfeo nunca dejaba que nadie lo tocara. Decía que nuestras 'sucias manos de plebeyos devoradores de ganchitos' corromperían el marfil. Me deslicé bajo la pesada tapa de madera y encendí la pequeña linterna de mi llavero del Halcón Milenario."
            },
            {
                text: "CAPÍTULO 3: UN PIANO DEMASIADO INTELIGENTE\n\nEl interior de un piano normal es un bosque ordenado de cuerdas tensas y martillos de fieltro. Pero este no era un piano normal. Al iluminar el mecanismo, noté que las cuerdas no eran de acero brillante. Eran filamentos de un material sintético translúcido que emitían un levísimo pulso de luz azulada, como venas alienígenas bombeando energía. \n—Nico... este piano tiene truco —dije en voz alta.\n—¡Los violonchelos están vacíos! —respondió Nico desde el fondo—. Solo hay pelusas y un sándwich de jamón que creo que tiene... ¡madre mía, está petrificado!\n—¡Olvida la arqueología gastronómica! Toma asiento mental, porque esto es brujería cibernética."
            },
            {
                text: "Por instinto de investigador, o quizás por exceso de confianza, presioné suavemente la cuerda correspondiente al 'Do' central. En un piano normal, el martillo habría golpeado la cuerda y habría sonado una nota clara. Aquí, no hubo sonido. En su lugar, el barniz oscuro del lateral interno del piano se iluminó. Era una pantalla táctil integrada que había estado camuflada.\n\nUn texto verde en formato retro apareció en la madera brillante:\n[SISTEMA DE SEGURIDAD ARMONIZADA INICIADO. INTRODUZCA CONTRASEÑA TONAL].\n\n—¿Contraseña tonal? —susurré para mí mismo. Mente de genio, ¡a trabajar! Esto significa que el acceso se consigue tocando una secuencia específica de notas en las teclas del piano. Pero, ¿cuál? El Sr. Solfeo vive para la música aburrida. Debe ser una composición clásica."
            },
            {
                text: "CAPÍTULO 4: LA PATRULLA DEL RECREO\n\n—¡Dani! —la voz de Nico sonó como si le hubieran apretado el cuello—. ¡Tenemos un código rojo! ¡Un código súper rojo! ¡Es la Patrulla del Recreo!\nAsomé la cabeza por debajo de la tapa del piano. Por la ventana del pasillo, vi las temibles siluetas recortadas contra la luz fluorescente de los pasillos: La Patrulla del Recreo.\n\nEran los alumnos de sexto curso elegidos por el director para mantener el 'orden y la higiene' durante los descansos. Se los reconocía por sus brazaletes de color verde brillante y su actitud de tiranos pre-adolescentes. Su líder indiscutible era Marcos 'El Mastodonte'. Marcos repetía curso muy a menudo, tenía vello facial que desafiaba la pubertad y su hobby principal era confiscar balones y galletas de chocolate."
            },
            {
                text: "Si nos pillaban dentro de un aula en hora de recreo, nos pondrían un parte disciplinario tan grave que nuestros padres nos enviarían a un campamento de verano de matemáticas sin dudarlo.\n—¡Esóndete! —le susurré a Nico, que rodó bajo una mesa llena de xilófonos, abrazando a uno como si fuera su única salvación.\n\nYo me quedé atrapado junto al piano. No había forma de llegar a la puerta trasera a tiempo. Así que hice lo único que un casi-genio acorralado podía hacer: me metí dentro del enorme estuche rígido del contrabajo que el Sr. Solfeo tenía apoyado contra la pared, cerca del piano. Olía a polvo de resina vieja y a tristeza."
            },
            {
                text: "La puerta del aula chirrió al abrirse. \n—Sé que escuché un ruido aquí dentro, chicos —era la voz nasal y prepotente de Marcos—. Si encuentro a alguien comiendo Doritos cerca de mis dominios, le voy a hacer limpiar los baños con su propia camiseta.\nDesde la oscuridad de mi escondite vertical, escuché los gruesos pasos de Marcos y sus dos secuaces. Caminaban arrastrando los pies, golpeando mesas. \n—Aquí no hay nadie, Mastodonte —dijo uno de los esbirros.\n—Pues yo huelo a miedo... y a sudor de niño pequeño —respondió Marcos. Estaba justo al lado de mi estuche. Sentía el latido de mi corazón retumbar en mis oídos."
            },
            {
                text: "En ese preciso instante, ocurrió el desastre. Un estornudo en formación. No el mío, sino el de Nico. Su alergia al polvo (y a las situaciones de tensión) era legendaria. Lo oí tomar aire de forma abrupta desde debajo de la mesa de los xilófonos. Si Nico estornudaba, estábamos perdidos. Recordé que le había prestado mi calcetín de repuesto en el Capítulo 1, ¡pero ahora no tenía otro!\n\nMilagrosamente, Nico contuvo el estornudo y emitió un sonido parecido al gemido de un perrito al que han pisado la cola. Muy bajito, pero Marcos lo oyó.\n—¿Qué ha sido eso? ¿Viene de las mesas? —preguntó Marcos, acercándose."
            },
            {
                text: "CAPÍTULO 5: LA TUBA REBELDE Y LA PISTA DEFINITIVA\n\nEra ahora o nunca. Tenía que crear una distracción masiva. Desde dentro del estuche, palpé la cremallera. Noté que el enorme instrumento de viento de cobre —la Tuba Dinámica del colegio— colgaba de un soporte justo enfrente del estuche. Saqué un lápiz del estuche oculto que llevo cosido en el calcetín (el izquierdo) y, por un pequeño hueco, logré empujar con fuerza la tuba.\n\nLa inmensa mole de cobre cayó al suelo con un estrépito cataclísmico: ¡BRROOOONK-CLAAANG-BOOONG! \nEl sonido retumbó en las paredes insonorizadas, creando una especie de onda expansiva que hizo temblar hasta el borrador de la pizarra. Marcos y sus secuaces soltaron gritos muy poco masculinos."
            },
            {
                text: "—¡Ha sido un fantasma! ¡Esta clase está embrujada! ¡Vámonos! —gritó uno de ellos, y escuché cómo salían corriendo en estampida hacia el pasillo, tropezando entre ellos. Había salvado a Nico de la perdición.\n\nSalí de mi estuche, desempolvándome la camiseta.\n—Dani, te debo mi vida, o al menos, la integridad de mi colección de chapas que Marcos me habría confiscado —dijo Nico, saliendo pálido de debajo de la mesa.\n—No hay tiempo para agradecimientos, nos quedan dos minutos y catorce segundos, Nico. Vamos al piano."
            },
            {
                text: "CAPÍTULO 6: LA SINFONÍA DEL SÓTANO\n\nMe acerqué de nuevo al piano de cola. La pantalla seguía brillando pidiendo la 'Contraseña Tonal'.\n—Dani, no sabemos tocar el piano. ¡Cualquier tecla equivocada podría activar un láser desintegrador o peor: llamar a la Sra. Gruñidos! —advirtió Nico.\nTraté de recordar algo. El Sr. Solfeo era predecible. Y mientras tocaba las notas, siempre, siempre, golpeaba su diapasón.\n—Nico, ¿recuerdas cuando el Sr. Solfeo explicaba las triadas mayores y menores, y siempre ponía el mismo ejemplo aburridísimo?\n—¿Te refieres a cuando tocó las notas Do, Mi y Sol, y dijo que sonaban a 'la perfección matemática y el orden universal'? —preguntó Nico."
            },
            {
                text: "—¡Exacto! Do, Mi, Sol. Es la mayor expresión de orden para él. Y además... —cerré los ojos repasando cada detalle obsesivo del profesor—. Cada mañana, al entrar, toca una melodía de cuatro notas. Siempre la misma. \nExtendí los dedos, sintiendo que sudaban en frío, sobre las teclas de marfil. Si me equivocaba, igual acabábamos convertidos en compost acústico.\n\nRespiré hondo y toqué la secuencia: DO - MI - SOL - y finalmente, un SI BEMOL resonante.\nEl silencio que siguió nos congeló la sangre. Luego, un ruido agudo, como el de un ascensor hidráulico activándose. El piano entero emitió un leve clic, y la parte inferior, debajo del pedalier, se deslizó hacia los lados, revelando un panel oculto metálico."
            },
            {
                text: "CAPÍTULO 7: LA CÁMARA DE LAS LLAVES Y LA FUGA SÓNICA\n\n—¡Lo lograste, Dani! ¡Eres un monstruo! (En el buen sentido) —Nico se acercó corriendo.\nAsomé la cabeza por el hueco. Dentro de ese panel, iluminado por luces LED azules, no había cables. Había una caja fuerte de acero, y sobre un soporte de terciopelo, posaban tres llaves antiguas de bronce, brillantes y pesadas, atadas con una fina cuerda dorada.\n¡Eran las llaves del Sótano Real! El núcleo oculto del colegio, donde el Agente Escoba y los profesores escondían la verdad sobre su espantoso 'Proyecto Educación Programada'."
            },
            {
                text: "Extendí el brazo y cogí las llaves. Se sentían frías y cargadas de secretos.\nPero en el instante en que las levanté del sensor de presión, las luces rojas se encendieron en todo el piano. La pantalla táctil cambió a un ominoso mensaje: [BRECHA DE SEGURIDAD. INICIANDO PROTOCOLO CASCADA ACÚSTICA].\n—Dani... mis oídos se están quejando —dijo Nico, encogiéndose.\nDe repente, los altavoces de toda el aula empezaron a emitir un zumbido de alta frecuencia que iba aumentando."
            },
            {
                text: "Era un sonido incapacitante, diseñado para aturdir a intrusos. Sentí que mis empastes iban a salir volando de mi boca.\n—¡Tápate los oídos! —grité.\nRecordé la mochila de Nico. Él siempre llevaba unos enormes auriculares protectores que le servían en el coche durante los viajes familiares para no escuchar los audiolibros dramáticos de su madre.\n—¡Nico, los auriculares! —se los arranqué y le puse las manos sobre sus orejas mientras me calzaba yo los protectores aislantes. El ruido disminuyó a un murmullo lejano."
            },
            {
                text: "Agarré a Nico por la manga de la chaqueta y lo empujé hacia la puerta justo a tiempo. Al cruzar el umbral y cerrar la puerta acústica tras nosotros, el ruido cesó por completo. Nos dejamos caer contra la pared de las taquillas del pasillo, jadeando y con el corazón a mil por hora.\n\nA nuestro alrededor, los alumnos de sexto volvían del patio. Faltaban unos preciosos instantes para que el Sr. Solfeo regresara de la sala de profesores con su café perfecto.\nNico me miró, pálido y sudoroso, y luego miró mis manos.\nLevanté las llaves de bronce. Brillaban tenuemente bajo la luz de los fluorescentes del pasillo."
            },
            {
                text: "—Las tenemos, Nico —dije, sintiendo que por primera vez íbamos un paso por delante del sistema—. Ahora tenemos acceso a las entrañas de este lugar. Prepárate, porque sea lo que sea que haya debajo de este colegio, va a lamentar haber secuestrado a mi Calamar Cósmico Holográfico.\nNico asintió lentamente, tragando saliva.\n—¿Tú crees que allí abajo habrá máquinas expendedoras? Me ha entrado un hambre terrible de tanto riesgo mortal.\nSonreí. La aventura, y el verdadero Juego de los Genios, estaba a punto de descender al siguiente nivel. Y esta vez, jugaríamos en su propio terreno."
            }
        ]
    },
    {
        id: 'casi-genio-tomo-3',
        title: 'Crónicas de un Casi Genio III: El Laberinto de los Objetos Perdidos',
        author: 'Tu Maestro',
        description: 'Armados con las llaves del Sótano Real, Dani y Nico descienden a las profundidades del patio de recreo. Allí descubren dónde van a parar todos los juguetes confiscados desde 1995.',
        level: 'Difícil',
        age: '10-13',
        coverImage: 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?auto=format&fit=crop&q=80&w=800',
        chipImage: '/images/storyteller/character-casi-genio-3-final.png',
        genre: 'Aventura/Misterio',
        themeColor: 'from-green-100 to-teal-200',
        rating: 4.8,
        category: 'juvenile',
        content: [
            {
                text: "CAPÍTULO 1: LA LOGÍSTICA DEL DESCENSO\n\nNadie te prepara para ser un héroe subterráneo. Los libros de aventuras siempre muestran a los exploradores empacando látigos, brújulas doradas y antorchas. En mi caso, la mochila de exploración constaba de: una linterna con forma de rana cuyas pilas estaban, siendo optimistas, al cinco por ciento de su capacidad; tres paquetes de ganchitos de queso; una cuerda hecha entrelazando cordones de zapatillas de repuesto; y a Nico.\n\nNico era fundamental. Principalmente porque, si había trampas, él funcionaba como un sistema de alarma natural (basado en sus gritos o sus estornudos por alergia al polvo). Estábamos escondidos detrás de los contenedores de reciclaje orgánico, esperando a que el sol bajara lo suficiente para que la temperatura del patio disuadiera a la Patrulla del Recreo de asomar sus temibles brazaletes fosforescentes."
            },
            {
                text: "Frente a nosotros descansaban las tres pesadas llaves de bronce que habíamos 'rescatado' de las entrañas tecnológicas del piano de cola del señor Solfeo en el tomo anterior. Brillaban con una ominosa promesa de secretos, castigos eternos y, con suerte, el paradero de mi ansiado cromo del Calamar Cósmico Holográfico.\n\n—Dani, he estado revisando las estadísticas de supervivencia en sótanos escolares no cartografiados —dijo Nico, mordisqueando nerviosamente el plástico de su envase de zumo—. Estamos en el decil más bajo. Es decir, somos la merienda probable de lo que sea que viva ahí abajo."
            },
            {
                text: "—No hay monstruos en el colegio San Bonifacio, Nico —le corregí, ajustándome mis gafas de genio incomprendido—. Hay algo mucho peor: profesores robotizados y tecnología conspirativa de los años 80. Hoy vamos a encontrar la Sala de Máquinas. O peor aún... El Almacén de lo Confiscado.\n\nEsa frase hizo que Nico dejara de masticar. El Almacén de lo Confiscado era una leyenda urbana. Desde el inicio de los tiempos escolares, incontables Game Boys, colecciones de tazos, cromos legendarios y peonzas habían sido arrebatados por manos adultas con la frase: 'Esto te lo devuelvo en junio'. Nunca volvían. ¿Dónde iban? La física básica dice que la materia no se destruye, solo se acumula en el sótano del director."
            },
            {
                text: "CAPÍTULO 2: LA PUERTA OXIDADA DE LA SALA DE CALDERAS\n\nEl acceso, según el mapa que encontramos en el primer tomo (que seguía oliendo a gimnasia sucia, por cierto), estaba oculto en la Sala de Calderas. Esta zona está terminantemente prohibida a los estudiantes bajo amenaza de exilio permanente a una academia de matemáticas intensivas de verano.\n\nAvanzamos pegados a la pared del pabellón de deportes, usando la Formación Sombras Sigilosas, que básicamente consistía en caminar agachados imitando a un pato con lumbago. Para cuando llegamos a la doble puerta de metal de las calderas, el aire ya sentía denso y olía sospechosamente a coliflor hervida y metal oxidado."
            },
            {
                text: "Empujé la puerta, que sorprendentemente no estaba cerrada. En el interior, enormes cilindros de metal resoplaban vapor espeso como si el edificio entero estuviera respirando. La humedad era agobiante.\n\n—Dani, me están rizando las pestañas con tanta humedad —se quejó Nico, sacando pañuelos de papel—.\nIgnoré las preocupaciones cosméticas de Nico y caminé hacia el fondo de la sala. Según el mapa, detrás de la Caldera Número 4 había una pared falsa. Y efectivamente, allí estaba. Oculta tras un enmarañado bosque de tuberías polvorientas, había una pesada puerta de acero reforzado que parecía la entrada a un silo nuclear."
            },
            {
                text: "La puerta no tenía manija normal. Tenía tres cerraduras grandes distribuidas en forma de triángulo. Las llaves de bronce que sacamos del piano del Sr. Solfeo encajaban perfectamente en el patrón.\n—Nico, es la hora. Haz los honores de la linterna de rana —dije, repartiendo las llaves.\n\nInsertamos las llaves al mismo tiempo. Girarlas requirió toda la fuerza combinada de mis frágiles brazos de pensador y los de Nico (que no eran mucho más robustos). CHANK. CLONC. BRRRM. Una serie de cerrojos internos mecánicos se destrabaron con un sonido que me puso los pelos de punta. Empujé la pesada hoja de acero y, en lugar de un armario de escobas, nos encontramos mirando hacia un abismo de metal oscuro."
            },
            {
                text: "CAPÍTULO 3: EL ASCENSOR HACIA NINGUNA PARTE\n\nNo era una escalera. Era un enorme montacargas industrial. Con suelo de reja metálica y paredes desgastadas.\n—Dani, ese ascensor no ha pasado una inspección técnica desde que inventaron la rueda —dijo Nico, retrocediendo un paso.\n—Es tecnología punta camuflada de ruina, Nico. ¿No has aprendido nada de este colegio? Todo es una fachada.\n\nEntramos al ascensor. Había un solo botón rojo en el panel, sin piso indicado. Lo pulsé, porque los botones rojos están diseñados genéticamente para ser pulsados. Las rejas se cerraron violentamente solas, con un estruendo que me hizo reconsiderar temporalmente la sabiduría de mi acción."
            },
            {
                text: "El ascensor empezó a bajar con brusquedad. Bajó, y bajó, y siguió bajando. Estábamos descendiendo decenas de metros, lo cual era arquitectónicamente imposible sin haber excavado hasta las placas tectónicas del barrio. El estómago se me subió a la garganta mientras el chirrido de las poleas ahogaba incluso los hiperventilados suspiros de Nico.\n\nFinalmente, tras lo que parecieron horas (probablemente cuatro minutos), el ascensor frenó en seco, haciéndonos rebotar contra el techo en cámara lenta y caer de bruces. Las puertas metálicas se abrieron con un chirrido agudo, revelando no oscuridad, sino una tenue y artificial luz de neón púrpura."
            },
            {
                text: "CAPÍTULO 4: EL VALLE DE LOS TAMAGOTCHIS MUERTOS\n\nSalimos del ascensor tosiendo el polvo milenario. Cuando levantamos la vista y encendimos la rana-linterna, la mandíbula se me cayó al suelo. \nEstábamos frente al Laberinto de los Objetos Perdidos.\nEra inmenso. Un pabellón subterráneo del tamaño de dos campos de fútbol. Pero no estaba vacío. Todo el lugar estaba conformado por montañas y murallas construidas enteramente con objetos infantiles confiscados a lo largo de las décadas.\n\nCaminamos cautelosamente entre dos altas torres formadas íntegramente por miles de yoyós entrelazados. Había dunas de cromos repetidos amontonados como arena. Colinas enteras compuestas de spinners resplandecientes. Y, el descubrimiento más macabro de todos, el Pasillo de las Mascotas Virtuales."
            },
            {
                text: "—¡Dios mío, Dani! —susurró Nico, encogido, acercando su pequeña linterna a una de las murallas—. ¡Son tamagotchis! ¡Miles de ellos! Y... y están todos pitando débilmente.\nEra cierto. Miles de pequeños aparatos de plástico en forma de huevo, apilados como ladrillos. Algunos llevaban décadas confiscados. Las pequeñas pantallas grises parpadeaban, llorando cibernéticamente por hambre, atención o limpieza.\nEra un cementerio electrónico monumental.\n\n—Si estuviéramos en una película de terror, los tamagotchis zombies nos devorarían la inteligencia ahora mismo —dije, sintiendo un escalofrío—.\nPero yo sabía a qué había venido. Entre toda esta chatarra robada a la infancia, debía estar lo más valioso: mi Calamar Cósmico Holográfico."
            },
            {
                text: "CAPÍTULO 5: LA PATRULLA DRON DE LIMPIEZA\n\nComenzamos a caminar por los pasillos estrechos entre muros de mochilas rotas y trompos desgastados. El lugar tenía una organización extraña, alfabética y cronológica. Encontramos la sección '1998 - 2005: El Auge de los Discos Voladores' y la sección '2010 - 2015: Puzles Cubo Abandonados por Frustración'.\n\nEstaba tan fascinado mirando un robot de juguete que valía más que el sueldo de mi padre juntos, que casi me pierdo el zumbido ominoso que venía desde arriba.\n—¡Dani! ¡Agáchate! —gritó Nico, empujándome contra un montón suave formado por abrigos de invierno perdidos en 2008.\n\nSobre nosotros, levitando a lenta velocidad y patrullando los pasillos, no había guardias ni conserjes. Había drones. Y no chismecillos manejados con el móvil. Eran orbes flotantes de metal negro reluciente. Se paseaban escaneando con un haz de luz láser de un potente color rojo, el mismo tipo de láser que le vi al Agente Escoba (Pepe el conserje)."
            },
            {
                text: "—Pepe debió reprogramar estas cosas usando la red del colegio para cuidar 'La Colección' —susurré—. Si ese láser nos toca, imagino que nos confiscara, empaquetará, y apilará junto a los Diabolos de la sección 'Ostracismo de Circo'.\n\nPara avanzar, usamos la táctica de infiltración del 'Ganchito Distractor'. Cada vez que un dron se acercaba girando en la esquina de un montón de tirachinas, yo tiraba un ganchito de queso al pasillo contrario. Los microsensores del dron, entrenados para odiar migas de colegio, volaban instantáneamente a carbonizar el ganchito, dándonos cuatro segundos para correr al siguiente montón de juguetes rotos."
            },
            {
                text: "CAPÍTULO 6: EL ENCUENTRO CON LA SEÑORA DE LA CAFETERÍA (CYBORG VERSION)\n\nLlegamos al centro exacto del inmenso almacén. Había una gran plaza de suelo de baldosas ajedrezadas, despejada de basura confiscada. En el centro exacto, sobre un pedestal luminoso digno de una deidad tecnológica, estaba una inmensa cámara bóveda. Y sobre ella flotaba un proyector emitiendo la luz holográfica de: ¡El Calamar Cósmico!\n\nNo era mi cromo físico. ¡Estaban proyectando la imagen de mi cromo como icono de la contraseña maestra del sistema! Mi cromo era la llave para esta bóveda de alta seguridad.\n—¡Lo encontramos! O al menos su forma astral —exclamé, saliendo alegremente del escondite de mochilas."
            },
            {
                text: "—Ejem —sonó una voz profundamente rasposa a nuestras espaldas. Una voz que solo había escuchado gritando: '¡Solo tienes derecho a dos salchichas, niño!'\nNos giramos lentamente. Parada frente a nosotros estaba la Señora de la Cafetería, la encargada de repartir los famosos macarrones gratinados. Siempre pensé que tenía un brazo increíblemente fuerte para remover veinte kilos de puré.\nAhora ya sabíamos por qué. Su brazo derecho terminaba no en una mano o un cazo de servir, sino en una pinza hidráulica brillante. Sus ojos despedían un tenue resplandor LED amarillento de procesamiento de datos."
            },
            {
                text: "—Detectando presencia de consumidores no autorizados en el almacén de purificación lúdica. Código de menú de castigo: brócoli al vapor sin sal.\nAvanzó hacia nosotros, con su pinza mecánica zumbando y girando. Su delantal de cocina, de plástico verde, ahora parecía una especie de armadura de kevlar indestructible.\n\n—Dani, ¡la cocinera es una droide de combate que hace comida radiactiva! —gritaba Nico, retrocediendo y chocando con un castillo ensamblado con piezas enormes de Lego falsificadas."
            },
            {
                text: "CAPÍTULO 7: LA TÁCTICA DEL HAMBRE (Y LA HUIDA POR LOS TUBOS)\n\nTenía diez segundos antes de que la Cyborg Cafetería nos procesara para hacer croquetas. Si mi cerebro es una supercomputadora, este era el momento para overclockearlo. Pensé rápido. Estaba programada como encargada del comedor. Su código primario debe ser limpiar mesas y atender niños hambrientos.\n\nRápidamente, vacié mi mochila volcando lo que quedaba de mis dos bolsas de ganchitos naranjas y dos bolsas de ositos de goma directamente sobre el impecable suelo de baldosas a nuestro alrededor. Hice un círculo de migas masivas y azúcar pegajosa.\n—¡Señora, el comedor 4B requiere limpieza masiva inmediata! Desperdicio de nutrientes procesados detectado —grité, gesticulando hacia la comida basura derramada.\n\nLa Cyborg Cafetería se detuvo a medio paso. Su luz amarilla ocular parpadeó furiosamente a rojo, y luego a violeta. Un cortocircuito lógico. Su directiva de atrapar intrusos luchaba contra la directiva suprema del protocolo de limpieza de comedor."
            },
            {
                text: "—Error de limpieza... Procesando manchas de aceite anaranjado saturado... Niveles de suciedad no admisibles para consumo humano... ¡Activando modo desinfección de tres niveles! —empezó a echar humo de vapor caliente por sus hombros, bajó la pinza y, con una increíble velocidad, empezó a fregar las baldosas a gatas.\n\n—¡Mueve las piernas, Nico! ¡Hacia la caja fuerte del Calamar! —grité."
            },
            {
                text: "Corrimos hacia el pedestal central esquivando el furbis robótico barrendero. Cuando llegamos frente a la bóveda blindada, vi una pequeña ranura de tarjeta bajo el escáner holográfico. Saqué la vieja tarjeta magnética de estudiante de Nico (porque a pesar de mi genialidad, yo siempre olvido renovar la mía) y la deslicé.\n\nLa bóveda chilló con un 'BEEP' agudo. Las compuertas no se abrieron del todo, pero escupieron un pesado maletín gris y, mágicamente, un pequeño sobre brillante sellado herméticamente que cayó al suelo junto con mi tarjeta."
            },
            {
                text: "CAPÍTULO 8: EL ENIGMA DEL CALAMAR Y EL BOTÍN DE GUERRA\n\nLas sirenas comenzaron a aullar, resonando en todo el cavernosos sótano de chatarra. La Cyborg Cafetería se había dado cuenta del truco, sacudiéndose el polvo de los ganchitos y soltando un grito metálico de sirena de fábrica.\n\n—¡Tenemos el botín dorado! ¡Retirada, retirada! —Grité, cogiendo el maletín de metal y el sobre con una mano, mientras con la otra arrastraba a Nico hacia una rejilla de alcantarillado redonda marcada que había al nivel del piso, a la que le faltaba la tapa.\n\nNos dejamos caer por el negro hueco, justo cuando el dron del rayo láser carbonizaba el espacio de aire donde nuestras cabezas habían estado milisegundos atrás. Aterrizamos sobre sacos de harina ablandando el golpe y caímos por una tubería de desecho como de parque acuático en completa oscuridad."
            },
            {
                text: "Quince apestosos y claustrofóbicos minutos después (que juraríamos nos envejecieron varios años), fuimos escupidos literalmente en el contenedor de botellas de cristal vacío del colegio hacia la luz pálida de la calle trasera. El sonido metálico nos aturdió, pero estábamos sucios, golpeados y a salvo.\nNico tosía purpurina confiscada y pelo de muñeca mística de sus vías respiratorias.\n\nCon las manos temblorosas, apoyé el maletín metálico que habíamos robado en el suelo. Y luego abrí el sobre brillante que había salido despedido con el maletín. No era un documento secreto. Era él...\n\n—Mi querido Calamar Cósmico Holográfico —dije con lágrimas en los ojos limpiando el cartón brillante con mi camiseta desgarrada."
            },
            {
                text: "—Todo este casi apocalipsis por un cromo que brilla en la oscuridad —Nico me miró, mitad orgulloso, mitad enfadado.\n—No es solo eso, Nico —dije, apartando la mirada del cromo brillante hacia el maletín de aspecto militar que teníamos enfrente. Estaba cerrado con un candado digital en el que la pantalla no decía 'Introduce pin'. Decía 'Introduce clave genética del Genio Autorizado'.\n\nNuestras andanzas apenas estaban comenzando. Habíamos hackeado el almacén y salvado mi activo comercial más poderoso. Pero habíamos extraído el tesoro que los robots del San Bonifacio estaban resguardando fervientemente en lo más profundo.\nLa pregunta real era, ¿qué monstruosidad y secretos educativos venían empaquetados en un maletín de quince kilos?\nEl Genio, al menos, estaba más preparado que nunca."
            }
        ]
    }
];
